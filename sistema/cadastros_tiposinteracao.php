                          ...
                          <div class="d-flex align-items-center">
                              <nav aria-label="breadcrumb">
                                  <ol class="breadcrumb">
                                      ...
                                      <li class="breadcrumb-item active" aria-current="page">Meios de Interação</li>
                                  </ol>
                              </nav>
                          </div>
                      </div>
              ...
              <div class="container-fluid">
                  ...
                  <div class="row">
                      <div class="col-12">
                          <div class="card">
                              <div class="card-body">
<!--                                  <h4 class="card-title">Meios Interação</h4>-->
																
																<?php if ($vetor_permissao['cadastro'] == 1) {
																}else { ?><a href="cadastrar_tipointeracao.php">
                                    <button type="button" class="btn waves-effect waves-light btn-warning">Novo Meio de
                                        Interação
                                    </button>
                                </a>
                                  ...
                                  <div class="table-responsive">
                                      <table id="lang_opt" class="table table-striped table-bordered display"
                                          ...
                                          <tbody>
																					<?php
																					$sql_atual = mysqli_query($con, "select * from tipo_interacao order by nome ASC");
																					while ($vetor = mysqli_fetch_array($sql_atual)) {
																						?>
                                              <tr>
                                                  <td><?php echo $vetor['nome']; ?></td>
                                                  <td><a class="fancybox fancybox.ajax"
                                                         href="alterartipointeracao.php?id=<?php echo $vetor['id_tipo']; ?>"
                                                         target="_blank">
                                                          <button type="button" class="btn btn-success mesmo-tamanho"
                                                                 ...
                                                                 href="confexcluirtipointeracao.php?id=<?php echo $vetor['id_tipo']; ?>">
