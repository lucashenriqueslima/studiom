                          ...
                          <div class="d-flex align-items-center">
                              <nav aria-label="breadcrumb">
                                  <ol class="breadcrumb">
                                      ...
                                      <li class="breadcrumb-item active" aria-current="page">Gestão de Vendas</li>
                                  </ol>
                              </nav>
                          </div>
                      </div>
              ...
              <div class="container-fluid">
                  ...
                  <div class="row">
                      <div class="col-12">
                          <div class="card">
                              <div class="card-body">
                                  <form action="recebe_buscagestaodevendas.php" method="post" name="cliente"
                                      ...
                                      <div class="row">
                                          ...
                                          <div class="col-lg-12">
                                              <fieldset class="form-group">
                                                  ...
                                                  <select name="tipo" id="turmas" class="form-control">
                                                      <option value="" selected="selected">Selecione...</option>
