...
<!--                                  <h4 class="card-title">Tipos de Produtos</h4>-->
																...
																}else { ?><a href="cadastrotipoproduto.php">
                                    <button type="button" class="btn waves-effect waves-light btn-warning">Novo Tipo de Convite
                                    </button>
                                </a>
                                  ...
                                  <div class="table-responsive">
                                      <table id="lang_opt" class="table table-striped table-bordered display"
                                          ...
                                          <tbody>
																					<?php
																					$sql_atual = mysqli_query($con, "select * from tipos_produtos order by nome ASC");
                                              ...
                                              <tr>
                                                  ...
                                                  <td><a class="fancybox fancybox.ajax"
                                                         href="alterartipoproduto.php?id=<?php echo $vetor['id_tipo']; ?>"
                                                         target="_blank">
                                                          <button type="button" class="btn btn-success mesmo-tamanho"
                                                                 ...
                                                                 href="confexcluirtipoproduto.php?id=<?php echo $vetor['id_tipo']; ?>">
