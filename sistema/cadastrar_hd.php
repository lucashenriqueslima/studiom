                        ...
                        <div class="d-flex align-items-center">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item">HDs</a></li>
                                    <li class="breadcrumb-item active" aria-current="page">Cadastrar Novo HD</li>
                                </ol>
                            </nav>
                        </div>
                    </div>
...
<!--                                <h4 class="card-title">Cadastro de HD</h4>-->
                                ...
                                <form action="recebe_hd.php" method="post" name="cliente" enctype="multipart/form-data"
                                      id="formID">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-6">
                                            <fieldset class="form-group">
                                                ...
                                                <input type="number" name="nhd" class="form-control" id="exampleInput"
                                                       placeholder="Digite o N°" required>
                                            </fieldset>
                                        </div>
                                    </div><!--.row-->
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-4">
                                            <fieldset class="form-group">
                                                ...
                                                <input type="text" name="tamanho" class="form-control" id="exampleInput"
                                                       placeholder="Digite o Tamanho" required>
                                            </fieldset>
                                        </div>
