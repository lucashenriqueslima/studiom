...
if ($_SESSION['id'] == NULL) {
    ...
    $vetor = mysqli_fetch_array(mysqli_query($con, "select * from tipo_opcionais where id_tipo = '$id'"));


    $sql_etapas_produto = mysqli_query($con, "select * from produtos_processos where tipo = '2' and id_produto = '$id'");

    $sql = mysqli_query($con, "select * from produtos_especificacoes where id_tipo_produto = '$id'");
    ...
    <head>
        ...
        <script type="text/javascript">
            function removeImagem(id) {
                $.post('recebe_alterartipoprodutoop.php?id=' + id + '&remover=sim', function () {
            ...
            function removeSpec(id) {
                $.post('recebe_alterartipoprodutoop.php?id_spec=' + id + '&remover=sim', function () {
                    window.location.reload(true);
                });
                        ...
                        <div class="card">
                            <div class="card-body">
                                <div id="origem" hidden>
                                    <div class="row">
                                        <input type="text" name="id_especificacao[]" value="" hidden>
                                        <div class="col-lg-6">
                                            <fieldset class="form-group">
                                                <label class="form-label semibold" for="exampleInput"></label>
                                                <input type="text" class="form-control" name="esquerda[]">
                                            </fieldset>
                                        </div>
                                        <div class="col-lg-6">
                                            <fieldset class="form-group">
                                                <label class="form-label semibold" for="exampleInput"></label>
                                                <input type="text" class="form-control" name="direita[]">
                                            </fieldset>
                                        </div>
                                    </div>
                                </div>
                                <div id="origem2" hidden>
                                    <div class="row">
                                ...
                                <form action="recebe_alterartipoprodutoop.php?id=<?php echo $id; ?>" method="post"
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-4">
                                            <fieldset class="form-group">
                                                <label class="form-label semibold" for="exampleInput">Requer
                                                    Aprovação?</label>
                                                <select name="aprovacao" class="form-control" required="">
                                                    <option value="" selected="">Selecione...</option>
                                                    <option value="1"
                                                            <?php if (strcasecmp($vetor['aprovacao'], '1') == 0) : ?>selected="selected"<?php endif; ?>>
                                                        Não
                                                    </option>
                                                    <option value="2"
                                                            <?php if (strcasecmp($vetor['aprovacao'], '2') == 0) : ?>selected="selected"<?php endif; ?>>
                                                        Sim
                                                    </option>
                                                </select>
                                            </fieldset>
                                    ...
                                    <?php
                                    $lock = 0;
                                    $sql_imagem = mysqli_query($con, "select * from imagens_produtos where chave_imagem = '$vetor[chave_imagem]' and id_produto='$id' order by posicao ASC");
                            ...
                            <br>
                            <br>
                            <input type="button" value="Adicionar" onclick="duplicarCampos2();"
                                   class="btn btn-warning">
                            <input type="button" value="Remover" onclick="removerCampos2(this);"
                            ...
                            <?php while ($info = mysqli_fetch_array($sql)) { ?>
                                <div class="row">
                                    <input type="text" name="id_especificacao[]"
                                           value="<?php echo $info['id_especificacao']; ?>" hidden>
                                    <div class="col-lg-6">
                                        <fieldset class="form-group">
                                            <label class="form-label semibold" for="exampleInput"></label>
                                            <input type="text" class="form-control" name="esquerda[]"
                                                   value="<?php echo $info['esquerda']; ?>">
                                        </fieldset>
                                    </div>
                                    <div class="col-lg-5">
                                        <fieldset class="form-group">
                                            <label class="form-label semibold" for="exampleInput"></label>
                                            <input type="text" class="form-control" name="direita[]"
                                                   value="<?php echo $info['direita']; ?>">
                                        </fieldset>
                                    </div>
                                    <div class="col-lg-1">
                                        <button type="button" class="btn btn-danger"
                                                title="Excluir Cadastro"
                                                onclick="removeSpec(<?php echo $info['id_especificacao']; ?>)"
