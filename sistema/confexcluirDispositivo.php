<?php
    ...
    $sql_atual = mysqli_query($con, "select * from dispositivos where id_dispositivo = '$id'");
	$vetor = mysqli_fetch_array($sql_atual);
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title">Exclusão de Dispositivo</h4>
                                ...
                                <tr style="    background: #FF6600; color: #fff;">
                                  ...
                                  <th width="15%">Ação</th> 
                                         ...
                                         <tr>
                                              <td>STM <?php echo $vetor['id_dispositivo']; ?> - <?php echo $vetor['tipoDispositivo']; ?> - <?php echo $vetor['tamanhoDispositivo']; ?> - <?php echo $vetor['marcaDispositivo']; ?></td>
                                              <td><a href="excluirDispositivo.php?id=<?php echo $id; ?>"><button type="button" class="btn btn-inline btn-danger">Sim</button></a> <a href="cadastro_dispositivo.php"><button type="button" class="btn btn-inline btn-success">Não</button></a></td>
                                          </tr>
