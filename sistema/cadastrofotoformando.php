            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title">Cadastro de Pré-Evento</h4>

                                <form action="recebe_fotoformando.php?id=<?php echo $id; ?>" method="post" name="cliente" enctype="multipart/form-data" onSubmit="return verificarCPF()" id="formID">
                                ...
                                <div class="row">
                                  <div class="col-lg-12">
                                    <fieldset class="form-group">
                                      ...
                                      <select name="tipo" id="tipobusca" class="form-control" required="">
                                        <option value="">Selecione...</option>
                                        <option value="1">Pré-Evento</option>
                                ...
                                <div id="palco1">
                                  ...
                                  <div id="2">
                                    ...
                                    <div class="row">
                                      ...
                                      <div class="form-group">
                                      <label>Evento</label>
                                      <select name="titulo1" class="form-control">
                                        <option value="" selected="">Selecione...</option>
                                        
                                        <?php

                                        $sql_eventos = mysqli_query($con, "select * from categoriaevento a, eventos_turma_lista b where a.id_categoria = b.id_evento and b.id_turma = '$vetor_formando[turma]' order by b.id_evento_turma ASC");

                                        while($vetor_evento = mysqli_fetch_array($sql_eventos)) {

                                        ?>

                                        <option value="<?php echo $vetor_evento['nome']; ?>"><?php echo $vetor_evento['nome']; ?></option>
