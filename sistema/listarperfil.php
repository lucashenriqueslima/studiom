<?php
     ...
     $sql_permissao = mysqli_query($con, "select * from perfil_paginas where id_pagina = '$id_pagina' and id_perfil = '$vetor_cadastro[id_perfil]'");
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <?php if($vetor_permissao['cadastro'] == 1) { } else { ?><a href="cadastroperfil.php"><button type="button" class="btn waves-effect waves-light btn-warning">Novo Perfil</button></a>
                                ...
                                <div class="table-responsive">
                                    <table id="lang_opt" class="table table-striped table-bordered display" style="width:100%">
                                        ...
                                        <tbody>
                                            ...
                                            $sql_atual = mysqli_query($con, "select * from perfil order by nome ASC");
                                            ...
                                            <tr>
                                                ...
                                                <td><a class="fancybox fancybox.ajax" href="alterarperfil.php?id=<?php echo $vetor['id_perfil']; ?>" target="_blank"><button type="button" class="btn btn-success mesmo-tamanho" title="Ver ou Alterar Cadastro"><i class="mdi mdi-tooltip-edit"></i></button></a> <a href="liberarpermissoes_perfil.php?id=<?php echo $vetor['id_perfil']; ?>"><button type="button" class="btn btn-warning mesmo-tamanho" title="Liberar Permissões"><i class="mdi mdi-account-key"></i></button></a> <?php if($vetor_permissao['exclusao'] == 1) { } else { ?><a class="fancybox fancybox.ajax" href="confexcluirperfil.php?id=<?php echo $vetor['id_perfil']; ?>"><button type="button" class="btn btn-danger mesmo-tamanho" title="Excluir Cadastro"><i class="mdi mdi-window-close"></i></button></a><?php } ?></td>
                                            </tr>
                                            <?php } ?>
                                        </tbody>
                                    </table>
