            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                <form action="recebe_pacote.php" method="post" name="cliente"
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-4">
                                            <fieldset class="form-group">
                                                <label class="form-label semibold" for="exampleInput">Data de Abertura da Venda</label>
                                                <input type="date" name="dataabertura" value="" class="form-control" required="">
                                            </fieldset>
                                        </div>

                                        <div class="col-lg-4">
                                            <fieldset class="form-group">
                                                <label class="form-label semibold" for="exampleInput">Data de Encerramento da Venda</label>
                                                <input type="date" name="termino" value="" class="form-control" id="exampleInput" required="">
                                            </fieldset>
                                        </div>
                                        <div class="col-lg-4">
                                            <fieldset class="form-group">
                                                <label class="form-label semibold" for="exampleInput">Data da Formatura</label>
                                                <input type="month" name="dataentrega" value="" class="form-control" id="exampleInput" required="">
                                            </fieldset>
                                        </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-12">
                                            <fieldset class="form-group">
                                                <label class="form-label semibold" for="exampleInput">Desconto a vista
                                                    (%)</label>
                                                <input type="text" name="desconto"
                                                       value="" class="form-control"
                                                       id="exampleInput" placeholder="Valor Desconto">
                                            </fieldset>
                                        </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-6">
                                            <fieldset class="form-group">
                                                ...
                                                <select name="tipocontrato" id="tipocontrato" class="form-control" required="">
                                                    ...
                                                    <option value="1">Contrato Antigo</option>
                                                    <option value="2">Taxa - Ensaio Foto de Convite </option>
                                                    <option value="3">Páginas - Ensaio Foto de Convite </option>
                                                    <option value="4">Arquivo Digital - Ensaio Foto de Convite </option>
                                                </select>
                                            </fieldset>
                                        </div>
                                        <div class="col-lg-6" id="hidden_div" style="display: none;">
                                            <fieldset class="form-group">
                                                ...
                                                <input type="text" name="valorcontrato" class="form-control"
                                                       id="valorcontrato">
                                            </fieldset>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-4">
                                            <fieldset class="form-group">
                                                <label class="form-label semibold" for="exampleInput">Tipo Pagamento
                                                    Cartão</label>
                                                <select name="tipopagamentocartao" class="form-control" required="">
                                                    <option value="" selected="">Selecione...</option>
                                                    <option value="1">Santander</option>
                                                    <option value="2">Outros</option>
                                                </select>
