...
<!--                          <h4 class="page-title">Gestão de Projetos</h4>-->
                          <div class="d-flex align-items-center">
                              <nav aria-label="breadcrumb">
                                  <ol class="breadcrumb">
                                      <li class="breadcrumb-item">Projetos</a></li>
                                      <li class="breadcrumb-item active" aria-current="page">Gestão de Projetos</li>
                                  </ol>
                              </nav>
                          </div>
                      </div>
...
<!--                                  <h4 class="card-title">Projetos</h4>-->
																...
																}else { ?><a href="cadastrar_turma.php">
                                          ...
                                          <tbody>
                                              ...
                                              <tr>
                                                  ...
                                                  <td><a class="fancybox fancybox.ajax"
                                                         href="alterarturma.php?id=<?php echo $vetor['id_turma']; ?>"
                                                         target="_blank">
                                                          <button type="button" class="btn btn-success mesmo-tamanho"
                                                                 ...
                                                                 href="confexcluirturma.php?id=<?php echo $vetor['id_turma']; ?>">
