<?php
    ...
    $sql_duplicata = mysqli_query($con, "select * from duplicatas where id_venda = '$vetor_venda[id_venda]'");
                        ...
                        <div class="d-flex align-items-center">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active" aria-current="page">Vendas Avulsas</li>
                                </ol>
                            </nav>
                        </div>
                    </div>
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title">Vendas Avulsas</h4>
                                ...
                                <table class="table table-bordered table-striped">
                                  ...
                                  <tbody>
                                    ...
                                    $sql_forma = mysqli_query($con, "select * from formaspag where id_forma = '$vetor_duplicatas[formapag]'");
