...
<!--                                  <h4 class="card-title">Departamentos</h4>-->
																...
																}else { ?><a href="cadastrar_departamento.php">
                                  ...
                                  <div class="table-responsive">
                                      <table id="lang_opt" class="table table-striped table-bordered display"
                                          ...
                                          <tbody>
																					<?php
																					$sql_atual = mysqli_query($con, "select * from departamentos order by nome ASC");
																					while ($vetor = mysqli_fetch_array($sql_atual)) {
																						?>
                                              <tr>
                                                  <td><?php echo $vetor['nome']; ?></td>
                                                  <td><a class="fancybox fancybox.ajax"
                                                         href="alterardepartamento.php?id=<?php echo $vetor['id_departamento']; ?>"
                                                         target="_blank">
                                                          <button type="button" class="btn btn-success mesmo-tamanho"
                                                                 ...
                                                                 href="confexcluirdepartamento.php?id=<?php echo $vetor['id_departamento']; ?>">
