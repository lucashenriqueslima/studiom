                          ...
                          <div class="d-flex align-items-center">
                              <nav aria-label="breadcrumb">
                                  <ol class="breadcrumb">
                                      ...
                                      <li class="breadcrumb-item active" aria-current="page">Gerar Aceite de Convites</li>
                                  </ol>
                              </nav>
                          </div>
                      </div>
...
<!--                                  <h4 class="card-title">Gestão de Convites</h4>-->
                                  ...
                                  <form action="recebe_geraraceites.php" method="post" name="cliente"
                                      ...
                                      <button type="submit" class="btn btn-primary" style="float: left;">Gerar</button>
