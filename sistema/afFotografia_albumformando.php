...
if ($_SESSION['id'] == null) {
	...
	if ($vetor_permissao['listar'] == 2) {
                      ...
                      <div class="col-12">
                          <div class="card">
                              <div class="card-body">
																...
																}else { ?><a href="cadastrar_albumformando.php">
                                    <button type="button" class="btn waves-effect waves-light btn-warning">Novo Produto
                                        de
                                        Formando
                                    </button>
                                </a>
                                  ...
                                  <ul class="nav nav-tabs" role="tablist">
                                      <li class="nav-item"><a class="nav-link active" data-toggle="tab" href="#aberto"
                                                              role="tab"><span class="hidden-sm-up"><i
                                                          class="ti-email"></i></span> <span class="hidden-xs-down">Em Aberto</span></a>
                                      </li>
                                      <li class="nav-item"><a class="nav-link" data-toggle="tab" href="#ressalva"
                                                              role="tab"><span class="hidden-sm-up"><i
                                                          class="ti-email"></i></span> <span class="hidden-xs-down">Com Ressalva</span></a>
                                      </li>
                                      <li class="nav-item"><a class="nav-link" data-toggle="tab" href="#finalizado"
                                                              role="tab"><span class="hidden-sm-up"><i
                                  ...
                                  <div class="tab-content tabcontent-border">
                                      <div class="tab-pane active" id="aberto" role="tabpanel">
                                          ...
                                          <div class="table-responsive">
                                              <table id="lang_opt" class="table table-striped table-bordered display"
                                                  ...
                                                  <tbody>
																									<?php
																									$sql_atual = mysqli_query($con, "select * from meu_album where status = 1 or status = 2 order by id_meualbum DESC");
                                                          ...
                                                          <td><a class="fancybox fancybox.ajax"
                                                                 ...
                                                                 target="_blank">
                                                                  <button type="button"
                                                                         ...
                                                                         href="confexcluiralbumformando.php?id=<?php echo $vetor['id_meualbum']; ?>">
                                                                      <button type="button"
                                      ...
                                      <div class="tab-pane" id="ressalva" role="tabpanel">
                                          <br>
                                          <div class="table-responsive">
                                              <table id="lang_opt2" class="table table-striped table-bordered display"
                                                  ...
                                                  <tbody>
																									<?php
																									$sql_atual = mysqli_query($con, "select * from meu_album where status = 3 order by id_meualbum DESC");
																									while ($vetor = mysqli_fetch_array($sql_atual)) {
																										$sql_formando = mysqli_query($con, "select * from formandos where id_formando = '$vetor[id_formando]'");
																										$vetor_formando = mysqli_fetch_array($sql_formando);
																										$sql_contrato = mysqli_query($con, "select * from turmas where id_turma = '$vetor_formando[turma]'");
                                      ...
                                      <div class="tab-pane" id="finalizado" role="tabpanel">
                                          <br>
                                          <div class="table-responsive">
                                              <table id="lang_opt3" class="table table-striped table-bordered display"
                                                     style="width:100%">
                                                  <thead>
                                                  <tr>
                                                      <th width="10%">Cód. Cliente</th>
                                                  ...
                                                  <tbody>
																									<?php
																									$sql_atual = mysqli_query($con, "select * from meu_album where status = 4 or status = 5 order by id_meualbum DESC");
																									while ($vetor = mysqli_fetch_array($sql_atual)) {
																										$sql_formando = mysqli_query($con, "select * from formandos where id_formando = '$vetor[id_formando]'");
																										$vetor_formando = mysqli_fetch_array($sql_formando);
																										$sql_contrato = mysqli_query($con, "select * from turmas where id_turma = '$vetor_formando[turma]'");
      ...
      <script type="text/javascript">
          ...
          var init_data_Table3 = function () {
              var tabelaNcms3 = null;
              if ($.fn.dataTable.isDataTable('#lang_opt3')) {
                  $('#lang_opt3').dataTable().fnDestroy();
                  init_data_Table3();
              } else {
                  tabelaNcms2 = $('#lang_opt3').DataTable({
                      destroy: false,
                      scrollCollapse: true,
                      ordering: true,
                      info: true,
