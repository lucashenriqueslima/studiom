            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title">Exclusão de Produto</h4>
                                ...
                                <tr style="    background: #FF6600; color: #fff;">
                                  ...
                                  <th width="15%">Ação</th> 
                                         ...
                                         <tr>
                                              ...
                                              <td><a href="excluirprodutoop.php?id=<?php echo $id; ?>&id_formando=<?php echo $vetor[id_formando]; ?>"><button type="button" class="btn btn-inline btn-danger">Sim</button></a> <a href="recebe_buscaprodutosformando_get.php?id_formando=<?php echo $vetor[id_formando]; ?>"><button type="button" class="btn btn-inline btn-success">Não</button></a></td>   
                                          </tr>
