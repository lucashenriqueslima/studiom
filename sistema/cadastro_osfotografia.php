...
if ($_SESSION['id'] == null) {
    ...
    $sql_encarregado = mysqli_query($con, "select nome from colaboradores where status = '1' and funcao = 'Supervisor de Produção Gráfica'");
    $vetor_encarregado = mysqli_fetch_array($sql_encarregado);
        ...
        <head>
            ...
            <script>
                ...
                $('#id_turma').change(function () {
                    $('#formando').load('formandos_vendas.php?id_turma=' + $('#id_turma').val());
                });

                $('#formando').change(function () {
                    $('#produtos').load('previsualiza_osfotografia.php?formando=' + $('#formando').val());
                });
            });
            </script>
        </head>
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                <form action="recebe_osfotografia.php" method="post" name="cliente"
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <select name="formando" id="formando" class="form-control"
                                                        required="">
                                    ...
                                    <button type="submit" value="Submit" name="submit" class="btn btn-primary" style="float: left;">Cadastrar
                                    </button>
