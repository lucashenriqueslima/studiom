                        ...
                        <div class="d-flex align-items-center">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item">Ajustes e Evoluções</a></li>
                                    <li class="breadcrumb-item active" aria-current="page">Cadastrar Suporte
                                    </li>
                                </ol>
                            </nav>
                        </div>
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                <form action="recebe_suporte.php" method="post" name="cliente"
                                        ...
                                        <div class="col-lg-6">
                                            <fieldset class="form-group">
                                                ...
                                                <select name="tipo" class="form-control" required="">
                                                    ...
                                                    <option value="desenv">Evolução</option>
                                                </select>
                                            </fieldset>
                                        </div>
                                        <div class="col-lg-6">
                                    ...
                                    <div class="row">
                                        <div class="col-lg-6">
                                            <fieldset class="form-group">
                                                ...
                                                <input type="text" name="link" class="form-control" id="exampleInput"
                                                       placeholder="Cole o Link">
                                            </fieldset>
                                        </div>
<!--                                        <div class="col-lg-6">-->
<!--                                            <fieldset class="form-group">-->
<!--                                                <label class="form-label semibold" for="exampleInput">Prioridade</label>-->
<!--                                                <select name="prioridade" class="form-control" required="">-->
<!--                                                    <option value="" selected>Selecione...</option>-->
<!--                                                    <option value="alto">Suporte</option>-->
                                    ...
                                    <div class="row">
                                        <div class="col-lg-12">
                                            <fieldset class="form-group">
                                                ...
                                                <input type="text" name="assunto" class="form-control" id="exampleInput"
                                                       placeholder="Digite o Assunto" required="" maxlength="50">
                                            </fieldset>
                                        </div>
                                    </div>
                                    <div class="row">
