<?php
    ...
    $sql = mysqli_query($con, "select * from bancos where cod = '$id'");
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title">Cadastro de Banco</h4>

                                <form action="recebe_alterarcadbanco.php?id=<?php echo $id; ?>" method="post" name="cliente" enctype="multipart/form-data" onSubmit="return verificarCPF()" id="formID">
                               
                                <div class="row">
                                    <div class="col-lg-12">
                                        <fieldset class="form-group">
                                            <label class="form-label semibold" for="exampleInput">Banco</label>
                                            <input type="text" name="banco" value="<?php echo $vetor['banco']; ?>" class="form-control" id="exampleInput" placeholder="Digite o Banco" required>
                                        </fieldset>
                                    </div>
                                </div><!--.row-->
