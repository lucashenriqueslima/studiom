...
<body>
    ...
    <div id="main-wrapper">
        ...
        <div class="page-wrapper">
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title">Compra de <?php if($vetor['tipo'] == 1) { echo "Convites"; } if($vetor['tipo'] == 2) { echo "Álbum"; } ?></h4>

                                <form action="recebe_aprovarcompra.php?id=<?php echo $id; ?>&id_turma=<?php echo $vetor_formando['turma']; ?>" method="post" name="cliente" enctype="multipart/form-data" onSubmit="return verificarCPF()" id="formID">
            
            <strong>Dados do Formando</strong>
            ...
            <br>
                  ...
                  <div class="col-lg-12">
                    <fieldset class="form-group">
                      <label class="form-label semibold" for="exampleInput">Formando</label>
                      <input type="text" name="nome" value="<?php echo $vetor_formando['nome']; ?>" class="form-control" id="exampleInput" placeholder="Digite o nome" disabled>
                    </fieldset>
                  </div> 
                  </div> 
                    ...
                    <div class="col-lg-4">
                      <fieldset class="form-group">
                        <label class="form-label semibold" for="exampleInput">RG</label>
                            <input type="number" name="rg" value="<?php echo $vetor_formando['rg']; ?>" class="form-control" placeholder="RG" disabled>
                    </div>

                    <div class="col-lg-4">
                      <fieldset class="form-group">
                        <label class="form-label semibold" for="exampleInput">Orgão Exp.</label>
                            <input type="text" name="oe" value="<?php echo $vetor_formando['oe']; ?>" class="form-control" placeholder="Orgão Exp." disabled>
                    </div>

                    <div class="col-lg-4">
                      <fieldset class="form-group">
                        <label class="form-label semibold" for="exampleInput">CPF</label>
                            <input type="number" name="cpf" value="<?php echo $vetor_formando['cpf']; ?>" class="form-control" placeholder="CPF" disabled>
                      </fieldset>
                    </div> 
                      ...
                      <div class="row">
                        <div class="col-lg-4">
                          <fieldset class="form-group">
                            ...
                            <input type="text" name="cep" value="<?php echo $vetor_formando['cep']; ?>" id="cep" class="form-control" placeholder="CEP" disabled>
                          </fieldset>
                        </div>
                        <div class="col-lg-8">
                          <fieldset class="form-group">
                            <label class="form-label" for="exampleInputPassword1">Bairro</label>
                            <input type="text" name="bairro" value="<?php echo $vetor_formando['bairro']; ?>" id="bairro" class="form-control" placeholder="Bairro" disabled>
                          </fieldset>
                        </div>
                      </div><!--.row-->
              ...
              <div class="col-md-4">
                      ...
                      <div class="col-lg-8">
                          <fieldset class="form-group">
                            ...
                            <input type="text" name="endereco" value="<?php echo $vetor_formando['endereco']; ?>" id="rua" class="form-control" placeholder="Endereço" disabled>
                          </fieldset>
                      </div>
                      ...
                      <div class="col-lg-4">
                          <fieldset class="form-group">
                            ...
                            <input type="text" name="complemento" value="<?php echo $vetor_formando['complemento']; ?>" class="form-control" placeholder="Complemento" disabled>
                          </fieldset>
                      </div>
                  ...
                  <div class="row">
                    <div class="col-lg-4">
                      <fieldset class="form-group">
                        ...
                        <input type="number" name="numero" value="<?php echo $vetor_formando['numero']; ?>" class="form-control" id="exampleInput" placeholder="Número" disabled>
                      </fieldset>
                    </div>
                    ...
                    <div class="col-lg-4">
                      <fieldset class="form-group">
                        ...
                        <input type="text" name="cidade" value="<?php echo $vetor_formando['cidade']; ?>" id="cidade" class="form-control" placeholder="Cidade" disabled>
                      </fieldset>
                    </div>
                    <div class="col-lg-4">
                      <fieldset class="form-group">
                        <label class="form-label" for="exampleInputEmail1">Estado</label>
                        <input type="text" name="estado" value="<?php echo $vetor_formando['estado']; ?>" id="uf" class="form-control" placeholder="Estado" disabled>
                      </fieldset>
                    </div>
              ...
              <div class="row">
                <div class="col-lg-4">
                  <fieldset class="form-group">
                    <label class="form-label semibold" for="exampleInput">Telefone com DDD</label>
                    <input type="text" name="telefone" id="telefone" value="<?php echo $vetor_formando['telefone']; ?>" class="form-control" placeholder="telefone" disabled>
                  </fieldset>
                </div>
                <div class="col-lg-4">
                  <fieldset class="form-group">
                    <label class="form-label" for="exampleInputEmail1">Celular com DDD</label>
                    <input type="text" name="celular" id="telefone2" value="<?php echo $vetor_formando['celular']; ?>" class="form-control" placeholder="Celular" disabled>
                  </fieldset>
                </div>
                <div class="col-lg-4">
                  <fieldset class="form-group">
                    <label class="form-label" for="exampleInputEmail1">E-mail</label>
                    <input type="email" name="email" value="<?php echo $vetor_formando['email']; ?>" class="form-control" placeholder="Estado" disabled>
                  </fieldset>
                </div>
            ...
            $gerarpdf = '<table width="100%" class="table table-bordered table-striped">
              <tr bgcolor="#e8e8e8">
          ...
          echo $gerarpdf;
            ...
            <table class="table table-bordered table-striped">
              ...
              <thead>
                ...
                <tr bgcolor="#e8e8e8">
                  <th>NF-Fatura nº</th>
                  <th>NF-Fatura – Valor Total</th>
                  <th>Duplicata nº</th>
                  <th>Duplicata - Valor</th>
                  <th>Vencimento</th>
                  <th></th>
                </tr>
              ...
              <tbody>
                ...
                <?php while($vetor_duplicatas = mysqli_fetch_array($sql_duplicatas)) { ?>

                <tr>

                  
                  
                  <td><?php echo $vetor_duplicatas['id_duplicata']; ?></td>
                  <td><?php echo $num = number_format($vetor_duplicata['valor'],2,',','.'); ?></td>
                  <td><?php echo $vetor_duplicatas['id_duplicata']; ?> <?php if($vetor_duplicatas['posicao'] == 1) { echo"A"; } if($vetor_duplicatas['posicao'] == 2) { echo"B"; } if($vetor_duplicatas['posicao'] == 3) { echo"C"; } if($vetor_duplicatas['posicao'] == 4) { echo"D"; } if($vetor_duplicatas['posicao'] == 5) { echo"E"; } if($vetor_duplicatas['posicao'] == 6) { echo"F"; } ?></td>
                  <td><?php echo $num = number_format($vetor_duplicatas['valor'],2,',','.'); ?></td>
                  <td><?php echo date('d/m/Y', strtotime($vetor_duplicatas['data'])); ?></td>
                  <td><?php if($vetor_duplicatas['link'] == NULL) { ?><a href="#" class="sidebar-link" onClick="window.open('cadastroboletofac.php?id=<?php echo $vetor_duplicatas['id_item']; ?>', 'Pagina', 'STATUS=NO, TOOLBAR=NO, LOCATION=NO, DIRECTORIES=NO, RESISABLE=NO, SCROLLBARS=NO, WIDTH=350, HEIGHT=100');"><button type="button" class="btn btn-success mesmo-tamanho" title="Enviar Boleto"><i class="fa fa-edit"></i></button></a><?php } ?></td>
            ...
            <button type="submit" class="btn btn-primary"  style="float: left;">Aprovar</button>
            ...
            <a href="remessa-boleto-falta.php?id=<?php echo $id; ?>"><button type="button" class="btn btn-primary"  style="float: left;">Gerar Boletos Santander Faltantes</button></a>
                            </div>
                        </div>
                    </div>
                </div>
