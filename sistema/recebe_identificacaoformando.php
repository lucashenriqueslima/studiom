                        ...
                        <div class="d-flex align-items-center">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active" aria-current="page">Indentificação de Formandos</li>
                                </ol>
                            </nav>
                        </div>
                    </div>
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title">Indentificação de Formandos</h4>
              ...
              $sql_identificacao = mysqli_query($con, "select * from identificacao_formandos where id_formando = '$vetor_formando[id_formando]' and id_evento = '$vetor_evento[id_evento]'");
              $vetor_identificacao = mysqli_fetch_array($sql_identificacao);

              if(mysqli_num_rows($sql_identificacao) > 0) {
              ...
              <div class="col-md-3">
                ...
                <img src="arquivos/<?php echo $vetor_identificacao['imagem']; ?>">

                </div>

                <br>

                <?php echo $vetor_turma['ncontrato']; ?> - <?php echo $vetor_formando['id_cadastro']; ?> - <?php echo $vetor_formando['nome']; ?> <br><a href="excluirfotoidentificacao.php?id=<?php echo $vetor_identificacao['id_identificacao']; ?>&id_evento=<?php echo $id_evento; ?>&id_turma=<?php echo $id_turma; ?>" ><button type="button" class="btn btn-danger mesmo-tamanho" title="Excluir Cadastro"><i class="mdi mdi-window-close"></i></button></a>
