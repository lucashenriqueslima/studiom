                          ...
                          <div class="d-flex align-items-center">
                              <nav aria-label="breadcrumb">
                                  <ol class="breadcrumb">
                                      ...
                                      <li class="breadcrumb-item active" aria-current="page">Categoria de Eventos</li>
                                  </ol>
                              </nav>
                          </div>
                      </div>
              ...
              <div class="container-fluid">
                  ...
                  <div class="row">
                      <div class="col-12">
                          <div class="card">
                              <div class="card-body">
<!--                                  <h4 class="card-title">Categoria de Eventos</h4>-->
																
																<?php if ($vetor_permissao['cadastro'] == 1) {
																}else { ?><a href="cadastrar_categoriaevento.php">
                                  ...
                                  <div class="table-responsive">
                                      <table id="lang_opt" class="table table-striped table-bordered display"
                                          ...
                                          <tr>
                                              ...
                                              <th width="10%"><strong><h5>Posição no Álbum</h5></strong></th>
                                              <th width="10%"><strong><h5>Ação</h5></strong></th>
                                          </tr>
                                          </thead>
                                          <tbody>
																					<?php
																					$sql_atual = mysqli_query($con, "select * from categoriaevento order by nome ASC");
																					while ($vetor = mysqli_fetch_array($sql_atual)) {
																						?>
                                              <tr>
                                                  <td><?php echo $vetor['nome']; ?></td>
                                                  <td align="center"><?php echo $vetor['sigla']; ?></td>
                                                  <td align="center"><?php echo $vetor['posicao']; ?></td>
                                                  <td align="center"><a class="fancybox fancybox.ajax"
                                                         href="alterarcategoriaevento.php?id=<?php echo $vetor['id_categoria']; ?>"
                                                         target="_blank">
                                                          <button type="button" class="btn btn-success mesmo-tamanho"
                                                                 ...
                                                                 href="confexcluircategoriaevento.php?id=<?php echo $vetor['id_categoria']; ?>">
