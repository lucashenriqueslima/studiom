...
if ($_SESSION['id'] == null) {
	...
	$id = $_GET['id'];
	$sql = mysqli_query($con, "select * from meu_album where id_meualbum = '$id'");
                        ...
                        <div class="d-flex align-items-center">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item">Produtos Formando</a></li>
                                    <li class="breadcrumb-item active" aria-current="page">Alterar Produto de Formando</li>
                                </ol>
                            </nav>
                        </div>
                    </div>
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
<!--                                <h4 class="card-title">Cadastro de Produtos Formando</h4>-->

                                <form action="recebe_alteraralbumformando.php?id=<?php echo $id; ?>" method="post"
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select name="id_item" id="turmas" class="form-control" required="">
                                                    <option value="" selected="selected">Selecione...</option>
																									<?php
																									$sql_produtos = mysqli_query($con, "select * from tipo_opcionais where aprovacao = '2' order by nome ASC");
                                ...
                                <div class="table-responsive">
                                    ...
                                    <table width="100%" class="table table-bordered table-striped">
                                        ...
                                        <tbody>
                                            ...
                                            <form action="recebe_alterarfotoalbumformando.php?id=<?php echo $id; ?>"
                                                ...
                                                <tr>
                                                    <td>
                                                        <img src="arquivos/turmas/<?php echo $vetor_imagens['imagem']; ?>"
                                                             width="420px"></td>
                                                    <td>
                                                        <button style="display:block;width:120px; height:30px;"
                                                                onclick="document.getElementById('getFile_<?php echo $i; ?>').click()">
                                                            Nova Imagem?
                                                        </button>
                                                        <input type="file" id="getFile_<?php echo $i; ?>"
                                                               style="display:none" name="imagem"></td>
                                                    ...
                                                    <td>
                                                        <table class="table">
                                                            ...
                                                            <tr>
																															...
																															<?php
																															$sql_fotos_cadastradas = mysqli_query($con, "select * from meualbum_fotos_escolhidas where id_meualbum = '$vetor_imagens[id_pagina]'");
                                                    ...
                                                    href="excluirimagemalbumformando.php?id=<?php echo $vetor_imagens['id_pagina']; ?>&id1=<?php echo $id; ?>">
