                                            ...
                                            <td width="16%" valign="middle">
                                                <table width="100%">
                                                    <tr>
                                                        ...
                                                        <td width="30%"><a href="imprimirrelvenda.php?id_turma=<?php echo $id_turma; ?>" target="_blank"><button type="button" class="btn btn-primary mesmo-tamanho" title="Imprimir Cadastros"><i class="fa fa-print"></i></button></a></td>
                                                    </tr>
                                                    <tr>
                                                        <td></td>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td width="30%"><a href="imprimirrelvendaboleto.php?id_turma=<?php echo $id_turma; ?>" target="_blank"><button type="button" class="btn btn-primary mesmo-tamanho" title="Imprimir Cadastros"><i class="fa fa-print"></i></button></a></td>
                                                    </tr>
                                                    <tr>
                                                        <td></td>
                                                        <td><img src="imgs/transp.png"></td>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td width="30%"><a href="imprimirrelprotocolo.php?id_turma=<?php echo $id_turma; ?>" target="_blank"><button type="button" class="btn btn-primary mesmo-tamanho" title="Imprimir Cadastros"><i class="fa fa-print"></i></button></a></td>
                                                    </tr>
                                                    <tr>
                                                        <td></td>
                                                        <td><img src="imgs/transp.png"></td>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td width="30%"><a href="imprimirrelcsv.php?id_turma=<?php echo $id_turma; ?>" target="_blank"><button type="button" class="btn btn-primary mesmo-tamanho" title="Imprimir Cadastros"><i class="fa fa-print"></i></button></a></td>
                                                    </tr>
                                                </table>
                                            </td>
                                        </tr>
