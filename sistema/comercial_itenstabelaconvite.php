              ...
              <div class="container-fluid">
                  ...
                  <div class="row">
                      <div class="col-12">
                          <div class="card">
                              <div class="card-body">
<!--                                  <h4 class="card-title">Tabela de Valores</h4>-->
																
																<?php if ($vetor_permissao['cadastro'] == 1) {
																}else { ?><a href="cadastrotipotabelaconvite.php">
                                  ...
                                  <div class="table-responsive">
                                      <table id="lang_opt" class="table table-striped table-bordered display"
                                          ...
                                          <tbody>
																					<?php
																					$sql_atual = mysqli_query($con, "select * from tabela_tipos order by titulo ASC");
																					while ($vetor = mysqli_fetch_array($sql_atual)) {
																						$sql_tipo = mysqli_query($con, "select * from tabela_item where id_tipo = '$vetor[tipo]'");
                                              ...
                                              <tr>
                                                  ...
                                                  <td><a class="fancybox fancybox.ajax"
                                                         href="alterartipotabela.php?id=<?php echo $vetor['id_tipo']; ?>"
                                                         target="_blank">
                                                          <button type="button" class="btn btn-success mesmo-tamanho"
                                                                 ...
                                                                 href="confexcluirtipotabela.php?id=<?php echo $vetor['id_tipo']; ?>">
