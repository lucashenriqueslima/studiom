            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title">Cadastro de Perfil</h4>

                                <form action="recebe_perfil.php" method="post" name="cliente" enctype="multipart/form-data" onSubmit="return verificarCPF()" id="formID">
                                <div class="row">
                                    <div class="col-lg-12">
                                        <fieldset class="form-group">
                                            <label class="form-label semibold" for="exampleInput">Perfil</label>
                                            <input type="text" name="nome" class="form-control" id="exampleInput" placeholder="Digite o perfil" required>
                                        </fieldset>
                                    </div>
                                </div><!--.row-->
