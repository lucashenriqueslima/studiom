        ...
        <div class="col-xs-12">
          <div class="box">
            <div class="box-header">
              <h3 class="box-title">Aprovação Formando</h3>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
            
            <form action="recebe_alteraraprovacaoformando.php?id=<?php echo $id; ?>" method="post" name="cliente" enctype="multipart/form-data" onSubmit="return verificarCPF()" id="formID">
              ...
              <table width="100%" class="table table-bordered table-striped">
                ...
                $sql_imagens = mysqli_query($con, "select * from minhas_aprovacoes_paginas where id_minhaaprovacao = '$id' order by npagina ASC");
                ...
                <form action="recebe_alterarfotoaprovacaoformando.php?id=<?php echo $id; ?>" method="post" name="cliente" enctype="multipart/form-data" onSubmit="return verificarCPF()" id="formID">

                <input type="hidden" name="id_pagina" value="<?php echo $vetor_imagens['id_pagina']; ?>">

                <tr>
                  <td><img src="arquivos/turmas/<?php echo $vetor_imagens['imagem']; ?>" width="420px"></td>
                  <td><button style="display:block;width:120px; height:30px;" onclick="document.getElementById('getFile_<?php echo $i; ?>').click()">Nova Imagem?</button>
                  <input type="file" id="getFile_<?php echo $i; ?>" style="display:none" name="imagem" required ></td>
                  <td><input type="number" name="npagina1" value="<?php echo $vetor_imagens['npagina']; ?>" required=""></td>
                  <td><?php echo $vetor_imagens['descricao']; ?></td>
                  <td><button type="submit" class="btn btn-info mesmo-tamanho" title="Ver ou Alterar Cadastro"><i class="fa fa-edit"></i></button></form> <a href="excluirimagemaprovacaoformando.php?id=<?php echo $vetor_imagens['id_pagina']; ?>&id1=<?php echo $id; ?>" ><button type="button" class="btn btn-danger mesmo-tamanho" title="Excluir Cadastro"><i class="fa fa-close"></i></button></a></td>
                </tr>
