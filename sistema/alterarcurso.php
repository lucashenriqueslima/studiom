<?php
    ...
    $id = $_GET['id'];
    $sql = mysqli_query($con, "select * from cursos where id_curso = '$id'");
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <form action="recebe_alterarcurso.php?id=<?php echo $id; ?>" method="post" name="cliente" enctype="multipart/form-data" onSubmit="return verificarCPF()" id="formID">
                                  ...
                                  <div class="col-lg-12">
                                    <fieldset class="form-group">
                                      ...
                                      <select name="id_instituicao" id="categorias" class="form-control">
                                            ...
                                            <option value="<?php echo $vetor_instituicao['id_instituicao']; ?>" <?php if (strcasecmp($vetor['id_instituicao'], $vetor_instituicao['id_instituicao']) == 0) : ?>selected="selected"<?php endif; ?>><?php echo $vetor_instituicao['nome'] ?> - <?php echo $vetor_instituicao['sigla'] ?></option>
                                            <?php } ?>
                                          </select>
                                    </fieldset>
                                  </div>
                                ...
                                <div class="row">
                                  ...
                                  <div class="col-lg-4">
                                    <fieldset class="form-group">
                                      <label class="form-label semibold" for="exampleInput">Viabilidade</label>
                                      <select name="viavel" class="form-control">
                                        <option value="Não" <?php if (strcasecmp($vetor['viavel'], 'Não') == 0) : ?>selected="selected"<?php endif; ?>>Não</option>
                                        <option value="Sim" <?php if (strcasecmp($vetor['viavel'], 'Sim') == 0) : ?>selected="selected"<?php endif; ?>>Sim</option>
                                        <option value="Talvez" <?php if (strcasecmp($vetor['viavel'], 'Talvez') == 0) : ?>selected="selected"<?php endif; ?>>Talvez</option>
                                      </select>
                                    </fieldset>
                                  </div>
                                  ...
                                  <div class="col-lg-4">
                                    <fieldset class="form-group">
                                      ...
                                      <br>
                                      <input type="radio" name="ocorrencia" value="Anual" <?php if($vetor['ocorrencia'] == 'Anual') { ?>checked <?php } ?>> Anual <img src="imgs/transp.png"> <input type="radio" name="ocorrencia" value="Semestral" <?php if($vetor['ocorrencia'] == 'Semestral') { ?>checked <?php } ?>> Semestral
                                    </fieldset>
                                  </div>

                                  <div class="col-lg-4">
                                    <fieldset class="form-group">
                                      <label class="form-label semibold" for="exampleInput">Qtd. Vagas</label>
                                      <input type="text" name="vagas1" value="<?php echo $vetor['vagas1']; ?>" class="form-control" id="exampleInput" placeholder="Digite a Quantidade">
                                    </fieldset>
                                  </div>
                                ...
                                <div class="row">
                                  ...
                                  <div class="col-lg-6">
                                    <fieldset class="form-group">
                                      <label class="form-label semibold" for="exampleInput">Atlética</label>
                                      <input type="text" name="atletica" value="<?php echo $vetor['atletica']; ?>" class="form-control" id="exampleInput" placeholder="Nome da Atlética">
                                    </fieldset>
                                  </div>

                                  <div class="col-lg-6">
                                    <fieldset class="form-group">
                                      <label class="form-label semibold" for="exampleInput">Bateria</label>
                                      <input type="text" name="atletica1" value="<?php echo $vetor['atletica1']; ?>" class="form-control" placeholder="Nome da Bateria">
                                    </fieldset>
                                  </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                      <textarea rows="4" name="observacoes" class="form-control" placeholder="Digite suas Observações"><?php echo $vetor['observacoes']; ?></textarea>
                                    </div>
                                </div>
