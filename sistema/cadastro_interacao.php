...
if(isset($_GET['id_departamento'])){
    ...
    $sql = mysqli_query($con, "select * from usuarios where departamento = '$id_departamento'");
    if(mysqli_num_rows($sql) > 0) {
        echo "<option value='' selected='selected'>Selecione o Colaborador</option>";
        while ($vetor = mysqli_fetch_array($sql)) {
            echo "<option value='" . $vetor['id_usuario'] . "'>" . $vetor['nome'] . "</option>";
        }
    }else{
        echo "<option value='' selected='selected'>Nenhum Colaborador Encontrado</option>";
    }
    die();
}
if($_SESSION['id'] == NULL) {
        ...
        <script type="text/javascript">
            $(document).ready(function(){
                ...
                $('#departamento').change(function () {
                    $('#responsavel').load('cadastro_interacao.php?id_departamento='+$('#departamento').val());
                });
                    ...
                    <div class="col-5 align-self-center">
                        <div class="d-flex align-items-center">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    <li class="breadcrumb-item">Lead</a></li>
                                    <li class="breadcrumb-item active" aria-current="page">Cadastrar Interação</li>
                                </ol>
                            </nav>
                        </div>
                    </div>
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <form action="recebe_interacoes.php?id=<?php echo $id; ?>" enctype="multipart/form-data" method="post">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <select name="assunto" class="form-control" required="">
                                                    ...
                                                    $sql_assunto = mysqli_query($con, "select * from assuntos order by nome ASC");

                                                    while($vetor_assunto = mysqli_fetch_array($sql_assunto)) {

                                                        ?>
                                                        <option value="<?php echo $vetor_assunto['id_assunto']; ?>"><?php echo $vetor_assunto['nome']; ?></option>
                                                    <?php } ?>
                                                </select>
                                            </div>
                                        </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <textarea id="mymce" name="ocorrenciatexto" class="form-control" rows="5"></textarea>
                                            </div>
                                        </div>
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <select id="departamento" name="departamento" class="form-control">
                                                            ...
                                                            <?php while ($vetor_departamento=mysqli_fetch_array($sql_departamento)) { ?>
                                                                <option value="<?php echo $vetor_departamento['id_departamento']; ?>"><?php echo $vetor_departamento['nome'] ?></option>
                                                            <?php } ?>
                                                        </select>
                                                    </div>
                                                </div>
                                    ...
                                    <?php if(isset($_GET['oportunidade'])){  ?>
                                        <input type="text" value="oportunidade" name="oportunidade" hidden>
                                    <?php }elseif(isset($_GET['prospeccao'])){ ?>
