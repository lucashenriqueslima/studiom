            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title">Impressão de Aceites Álbuns</h4>
                                ...
                                <table width="100%">
                                  <tr>
                                    <td width="100%" valign="middle"><strong><?php echo $vetor_turma['ncontrato']; ?> - <?php echo $vetor_curso_inicio['nome']; ?> <?php echo $vetor['ano']; ?> <?php echo $vetor_instituicao_inicio['nome']; ?></strong></td>
                                  </tr>
                                </table>
                                ...
                                <table class="table table-bordered table-striped">
                                    ...
                                    <tr>
                                      ...
                                      $sql_soma_qtd2 = mysqli_query($con, "SELECT SUM(a.valorvenda) as total FROM vendas a, formandos c where a.id_formando = c.id_formando and a.tipo = '2' and c.turma = '$id_turma' and a.status != '4'");
                                      $vetor_soma_qtd2 = mysqli_fetch_array($sql_soma_qtd2);

                                      $sql_soma_avista = mysqli_query($con, "SELECT SUM(a.valorvenda) as total FROM vendas a, formandos c where a.id_formando = c.id_formando and a.tipo = '2' and c.turma = '$id_turma' and a.formapag = '4' and a.status != '4'");
                                    ...
                                    <?php 
                                      ...
                                      $sql_venda = mysqli_query($con, "select * from vendas where id_formando = '$vetor_atual[id_formando]' and tipo = '2' order by id_venda DESC limit 0,1");
                                    ...
                                    <tr>
                                      ...
                                      $sql_soma_valor = mysqli_query($con, "SELECT SUM(valorvenda) as total FROM vendas where id_formando = '$vetor_atual[id_formando]' and tipo = '2'");
                                      ...
                                      <td><?php if($vetor_venda['aceite'] == 2) { ?><a href="imprimiraceitealbum.php?id=<?php echo $vetor_venda['id_venda']; ?>" target="_blank"><i class="fa fa-print" title="Imprimir Aceite"></i></a><?php } ?></td>
                                    </tr>
                                    <?php } ?>
                                    </tbody>
                                  </table>
