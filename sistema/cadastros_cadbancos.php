...
<!--                                  <h4 class="card-title">Bancos</h4>-->
																...
																}else { ?><a href="cadastrar_cadbanco.php">
                                    <button type="button" class="btn waves-effect waves-light btn-warning"> Novo Banco
                                    </button>
                                </a>
                                  ...
                                  <div class="table-responsive">
                                      <table id="lang_opt" class="table table-striped table-bordered display"
                                          ...
                                          <tbody>
																					<?php
																					$sql_atual = mysqli_query($con, "select * from bancos order by banco ASC");
																					while ($vetor = mysqli_fetch_array($sql_atual)) {
																						?>
                                              <tr>
                                                  <td><?php echo $vetor['banco']; ?></td>
                                                  <td><a class="fancybox fancybox.ajax"
                                                         href="alterarcadbanco.php?id=<?php echo $vetor['cod']; ?>"
                                                         target="_blank">
                                                          <button type="button" class="btn btn-success mesmo-tamanho"
                                                                 ...
                                                                 href="confexcluircadbanco.php?id=<?php echo $vetor['cod']; ?>">
