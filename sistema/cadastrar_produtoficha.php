...
if (isset($_POST['cat_pai'])) {
    ...
    if ($cat_pai != '') {
        $sql = mysqli_query($con, "select * from ficha_tecnica where cat_pai='$cat_pai' and status='1' and categoria_fornecedor='0'");
        if (mysqli_num_rows($sql) > 0) {
            echo "<div class=\"col-lg-2 col-md-3 col-sm-4 remover\">
		        <div class=\"form-group\">
			        <label>Subcategoria</label>
		            <select name=\"cat_pai\" class=\"form-control categoria\" required=\"\">";
...
if ($_SESSION['id'] == NULL) {
                        ...
                        <div class="d-flex align-items-center">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active" aria-current="page">Cadastrar Nova Ficha
                                    </li>
                                </ol>
                            </nav>
                        </div>
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <form action="recebe_fichatecnica.php?f=1" enctype="multipart/form-data" method="post">
                                    <div class="row">
                                        <div class="col-lg-2 col-md-3 col-sm-4">
                                            <div class="form-group">
                                                <label>Tipologia</label>
                                                <select id="cat_pai_raiz" name="cat_pai" class="form-control categoria" required="">
                                        ...
                                        <div class="col-lg-2 col-md-3 col-sm-4">
                                            <button id="addCat" type="button" class="btn btn-md btn-success" onclick="carregaSelect()" style="float: left;margin-top: 29px"><span><i class="fas fa-plus"></i></span> Subcategoria</button>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                <label>Titulo</label>
                                                <input name="titulo" class="form-control"></input>
                                            </div>
                                        </div>
                                        <!--                                        <div class="col-md-4" id="cat_fornecedor" hidden>-->
                                        <!--                                            <div class="form-group">-->
    ...
    <script type="text/javascript">
        function carregaSelect() {
            $('.categoria').each(function () {
                ...
                if (!(typeof attr !== typeof undefined && attr !== false) && this.value != '') {
                    ...
                    $.ajax({
                        url: 'cadastrar_produtoficha.php',
                        type: 'post',
                        data: fd,
                        contentType: false,
                        processData: false,
        ...
        function resetar() {
            ...
            // $('#cat_fornecedor').attr('hidden','hidden');
        }
    </script>
    </body>
