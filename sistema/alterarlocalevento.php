<?php
    ...
    $id = $_GET['id'];
    $sql = mysqli_query($con, "select * from locais where id_local = '$id'");
                        ...
                        <div class="d-flex align-items-center">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active" aria-current="page">Locais de Eventos</li>
                                </ol>
                            </nav>
                        </div>
                    </div>
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title">Ver ou Alterar Cadastro de Local de Evento</h4>

                                <form action="recebe_alterarlocaevento.php?id=<?php echo $id; ?>" method="post" name="cliente" enctype="multipart/form-data" onSubmit="return verificarCPF()" id="formID">
                                ...
                                <div class="row">
                                  ...
                                  <div class="col-lg-6">
                                    <fieldset class="form-group">
                                      ...
                                      <input type="text" name="bairro" value="<?php echo $vetor['bairro']; ?>" id="bairro" class="form-control" placeholder="Bairro" required>
                                    </fieldset>
                                  </div>
                                </div><!--.row-->
                                ...
                                <div class="row">
                                  ...
                                  <div class="col-lg-6">
                                    <fieldset class="form-group">
                                      ...
                                      <input type="text" name="estado" value="<?php echo $vetor['estado']; ?>" id="uf" class="form-control" placeholder="Estado" required>
                                    </fieldset>
                                  </div>
