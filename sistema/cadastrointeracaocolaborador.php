            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title">Cadastro de Interação para o Colaborador: <?php echo $vetor['nome']; ?></h4>

                                <form action="recebe_interacaocolaborador.php?id=<?php echo $id; ?>" enctype="multipart/form-data" method="post">
                                ...
                                <div class="row">
                                  ...
                                  <div class="form-group">
                                    ...
                                    <textarea name="ocorrenciatexto" class="form-control" rows="5"></textarea>
                                  </div>
                                  </div>
                                ...
                                <div id="2">
                                  ...
                                  <input type="date" name="dataagenda" class="form-control">
