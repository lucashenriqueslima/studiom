...
<div align="center">
    ...
    <font size="2px"><strong><?php echo $vetor_turma['ncontrato']; ?>
            - <?php echo $vetor_curso_inicio['nome']; ?> <?php echo $vetor_turma['ano']; ?> <?php echo $vetor_instituicao_inicio['nome']; ?></strong></font>
</div>
<font size="1px">
    <br>
    ...
    <table width="100%" BORDER="1" style="border-collapse: collapse">
        ...
        <tr>
            ...
            <th width="26%"></th>
					<?php
					$sql_soma_qtd2 = mysqli_query($con, "SELECT SUM(a.valorvenda) as total FROM vendas a, formandos c where a.id_formando = c.id_formando and c.turma = '$id_turma'");
					$vetor_soma_qtd2 = mysqli_fetch_array($sql_soma_qtd2);
					while ($vetor_itens2 = mysqli_fetch_array($sql_itens2)) {
						$sql_soma_qtd1 = mysqli_query($con, "SELECT SUM(b.qtd) as total FROM vendas a, itens_venda_individual b where a.id_venda = b.id_venda and b.id_item = '$vetor_itens2[id_item]'");
            ...
            <tr>
                ...
                <td><?php echo $vetor_atual['nome']; ?></td>
                  ...
                  <td><?php echo $vetor_soma_qtd['total']; ?></td>
							...
							$sql_soma_valor = mysqli_query($con, "SELECT SUM(valorvenda) as total FROM vendas  where id_formando = '$vetor_atual[id_formando]'");
