                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <form action="recebe_catconta.php" enctype="multipart/form-data" method="post">
                                    <div class="row">
                                        <div class="col-lg-2 col-md-3 col-sm-4">
                                            <div class="form-group">
                                                ...
                                                <select id="cat_pai_raiz" name="cat_pai" class="form-control categoria" required="">
                                                    ...
                                                    <?php
                                                    $sql_contas = mysqli_query($con, "select * from categorias_contas where status='1' and cat_pai='0' order by titulo");
        ...
        function carregaSelect() {
            $('.categoria').each(function () {
                ...
                if (!(typeof attr !== typeof undefined && attr !== false) && this.value != '') {
                    ...
                    $.ajax({
                        url: 'cadastrar_contascategoria.php',
                        type: 'post',
                        data: fd,
                        contentType: false,
                        processData: false,
