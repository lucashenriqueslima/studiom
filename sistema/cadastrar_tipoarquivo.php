                        ...
                        <div class="d-flex align-items-center">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item">Tipos de Arquivos</a></li>
                                    <li class="breadcrumb-item active" aria-current="page">Cadastrar novo Tipo de Arquivo</li>
                                </ol>
                            </nav>
                        </div>
                    </div>
...
<!--                                <h4 class="card-title">Cadastro de Tipo de Arquivo</h4>-->
                                ...
                                <form action="recebe_tipoarquivo.php" method="post" name="cliente"
