...
<!--                                <h4 class="card-title">Cadastro de Campanha</h4>-->
                                ...
                                <form action="recebe_campanha.php" method="post" name="cliente"
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-6">
                                            <fieldset class="form-group">
                                                <label class="form-label semibold" for="exampleInput">Status da
                                                    Campanha</label>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-12">
                                            <fieldset class="form-group">
                                                <label class="form-label semibold" for="exampleInput">Investimento
                                                    R$</label>
                                                <input type="text" name="investimento" class="form-control"
                                                       onKeyPress="mascara(this,mvalor)" placeholder="0,00">
                                            </fieldset>
                                        </div>
                                    ...
                                    <div class="row">
                                        <div class="col-lg-12">
                                            <fieldset class="form-group">
                                                <label class="form-label semibold" for="exampleInput">Descrição da
                                                    Oportunidade</label>
                                    ...
                                    <div class="row">
                                        <div class="col-lg-12">
                                            <fieldset class="form-group">
                                                <label class="form-label semibold" for="exampleInput">Campanha
                                                    Ativa</label>
                                                <br>
                                                <input type="radio" name="ativa" value="1" class="minimal" checked> Sim
                                                <img src="imgs/transp.png"> <input type="radio" name="ativa" value="2"
                                                                                   class="minimal"> Não
                                            </fieldset>
                                        </div>
