              ...
              <div class="container-fluid">
                  ...
                  <div class="row">
                      <div class="col-12">
                          <div class="card">
                              <div class="card-body">
<!--                                  <h4 class="card-title">Impressão de Aceites</h4>-->
                                  ...
                                  <table class="table table-bordered table-striped">
                                      ...
                                      <tr>
                                          <th width="15%"></th>
																				<?php
																				$sql_soma_qtd2 = mysqli_query($con, "SELECT SUM(a.valorvenda) as total FROM vendas a, formandos c where a.id_formando = c.id_formando and c.turma = '$id_turma' and a.produto = '$produto'");
																				$vetor_soma_qtd2 = mysqli_fetch_array($sql_soma_qtd2);
																				while ($vetor_itens2 = mysqli_fetch_array($sql_itens2)) {
																					$sql_soma_qtd1 = mysqli_query($con, "SELECT SUM(b.qtd) as total FROM vendas a, itens_venda_individual b where a.id_venda = b.id_venda and b.id_item = '$vetor_itens2[id_item]' and a.produto = '$produto'");
                                      ...
                                      <tbody>
																			...
																			while ($vetor_atual = mysqli_fetch_array($sql_atual)) {
																				...
																				$sql_venda = mysqli_query($con, "select * from vendas where id_formando = '$vetor_atual[id_formando]' and produto = '$produto' order by id_venda DESC limit 0,1");
                                          ...
                                          <tr>
                                              <td><?php echo $vetor_atual['nome']; ?></td>
                                                ...
                                                <td><?php echo $vetor_soma_qtd['total']; ?></td>
																						...
																						$sql_soma_valor = mysqli_query($con, "SELECT SUM(valorvenda) as total FROM vendas where id_formando = '$vetor_atual[id_formando]' and produto = '$produto'");
                                              ...
                                              <td>
                                                  R$ <?php echo $num = number_format($vetor_soma_valor['total'], 2, ',', '.'); ?></td>
                                              <td><?php if ($vetor_venda['aceite'] == 2) { ?><a
                                                      href="imprimiraceite.php?id=<?php echo $vetor_venda['id_venda']; ?>"
                                                      target="_blank"><i class="fa fa-print"
                                                                         title="Imprimir Aceite"></i></a><?php } ?></td>
                                          </tr>
																			<?php } ?>
                                      </tbody>
                                  </table>
