<?php
    ...
    $sql = mysqli_query($con, "select * from eventos_pacote where id_evento_pacote = '$id'");
    $vetor = mysqli_fetch_array($sql);

    $sql_evento = mysqli_query($con, "select * from eventos_turma_lista where id_evento_turma = '$vetor[id_evento]'");
                                ...
                                <tr style="    background: #FF6600; color: #fff;">
                                  ...
                                  <th width="15%">Ação</th> 
                                         ...
                                         <tr>
                                              ...
                                              <td><a href="excluirpacoteevento.php?id=<?php echo $id; ?>&id1=<?php echo $id1; ?>"><button type="button" class="btn btn-inline btn-danger">Sim</button></a> <a href="alterarprodutopacotealbum.php?id=<?php echo $id1; ?>"><button type="button" class="btn btn-inline btn-success">Não</button></a></td>   
                                          </tr>
