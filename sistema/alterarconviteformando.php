...
if ($_SESSION['id'] == null) {
    ...
    $id = $_GET['id'];
    $sql = mysqli_query($con, "select * from meu_convite where id_meuconvite = '$id'");
                        ...
                        <div class="d-flex align-items-center">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item">Produtos Convite</a></li>
                                    <li class="breadcrumb-item active" aria-current="page">Alterar Produto de Convite
                                    </li>
                                </ol>
                            </nav>
                        </div>
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <form action="recebe_alterarconviteformando.php?id=<?php echo $id; ?>" method="post"
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="date" name="datafinal" class="form-control"
                                                       value="<?php echo $vetor['datafinal']; ?>" required="">
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <select name="status" id="turmas" class="form-control" required="">
                                                    ...
                                                    <option value="4"
                                                            <?php if (strcasecmp($vetor['status'], '4') == 0) : ?>selected="selected"<?php endif; ?>>
                                                        Aprovado
                                                    </option>
                                                </select>
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <textarea name="descricao" class="ckeditor"
                                                          id="editor1"><?php echo $vetor['descricao']; ?></textarea>
                                    ...
                                    <div id="origem">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-lg-3">
                                                <fieldset class="form-group">
                                                    <label class="form-label semibold"
                                                           for="exampleInput">Legenda</label>
                                                    <input type="text" name="legenda[]" class="form-control"
                                                           value="<?php echo $vetor['legenda']; ?>">
                                                </fieldset>
                                            </div>
                                            ...
                                            <div class="col-lg-3">
                                                <fieldset class="form-group">
                                                    <label class="form-label semibold"
                                                           for="exampleInput">Bloqueio?</label>
                                ...
                                <div class="table-responsive">
                                    ...
                                    <table width="100%" class="table table-bordered table-striped">
                                        ...
                                        <tr>
                                            ...
                                            <th width="20%">
                                                <div class="a">Legenda</div>
                                            </th>
                                            <th>
                                                <div class="a">Aprovado?</div>
                                            </th>
                                            <th>
                                        ...
                                        <?php
                                        $sql_imagens = mysqli_query($con, "select * from meu_convite_paginas where id_meuconvite = '$id' order by npagina ASC");
                                        $i = 0;
                                        while ($vetor_imagens = mysqli_fetch_array($sql_imagens)) {
                                            ?>

                                            <form action="recebe_alterarfotoconviteformando.php?id=<?php echo $id; ?>"
                                                ...
                                                <input type="hidden" name="id_pagina"
                                                       value="<?php echo $vetor_imagens['id_pagina']; ?>">
                                                ...
                                                <tr>
                                                    ...
                                                    <td><?php echo $vetor_imagens['legenda']; ?></td>
                                                    <td><?php if ($vetor_imagens['status'] == 1) {
                                                            echo "Em Aberto";
                                                        }
                                                        if ($vetor_imagens['status'] == 2) {
                                                            echo "Aprovado";
                                                        }
                                                        if ($vetor_imagens['status'] == 3) {
                                                            echo "Com Resssalva";
                                                        } ?></td>
                                                    <td>
                                                        <table class="table">
                                                            ...
                                                            <tr>
                                                                ...
                                                                <?php
                                                                $sql_fotos_cadastradas = mysqli_query($con, "select * from meuconvite_fotos_escolhidas where id_meuconvite = '$vetor_imagens[id_pagina]'");
                                                    ...
                                                    <td>
                                                        ...
                                                        <!--                                                                title="Ver ou Alterar Cadastro"><i class="fa fa-edit">-->
                                                        <!--                                                                -->
                                                        <!--                                                            </i>-->
                                                        <!--                                                        </button>-->
                                                        <a href="excluirimagemconviteformando.php?id=<?php echo $vetor_imagens['id_pagina']; ?>&id1=<?php echo $id; ?>">
                                                            <button type="button" class="btn btn-danger mesmo-tamanho"
                                                                    title="Excluir Cadastro"><i class="fa fa-close"></i>
                                                            </button>
                                                        </a>
                                                    </td>
                                                </tr>
