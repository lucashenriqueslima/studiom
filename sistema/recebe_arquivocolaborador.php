...
$sql_grava = mysqli_query($con, "insert into arquivos_colaborador (id_colaborador, id_usuario, titulo, data, hora, arquivo) VALUES ('$id', '$_SESSION[id]', '$titulo', '$data', '$horaatual', '$imagem')");
