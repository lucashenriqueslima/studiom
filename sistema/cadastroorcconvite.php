...
if ($_SESSION['id'] == null) {
	...
	$id = $_GET['id'];
	$sql = mysqli_query($con, "select * from tabela_fotografia where id_tabela = '$id'");
                        ...
                        <div class="d-flex align-items-center">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item">Orçamentos de Convites</a></li>
                                    <li class="breadcrumb-item active" aria-current="page">Cadastrar novo Orçamento de Convite</li>
                                </ol>
                            </nav>
                        </div>
                    </div>
...
<!--                                <h4 class="card-title">Cadastro de Orçamento Convite</h4>-->
                                ...
                                <form action="recebe_orcconvite.php" method="post" name="cliente"
                                        ...
                                        <div class="col-lg-4">
                                            <fieldset class="form-group">
                                                <label class="form-label semibold" for="exampleInput">Tipo
                                                    Cadastro</label>
                                                <select name="tipo" id="produto" class="form-control" required="">
                                            ...
                                            <div id="1">
                                                ...
                                                <div class="col-lg-4">
                                                    <fieldset class="form-group">
                                                        ...
                                                        <select name="id_oportunidade" class="form-control">
                                                            ...
                                                            <option value="" selected="">Selecione...</option>
                                                              ...
                                                              <option value="<?php echo $vetor_oportunidade['id_oportunidade']; ?>"><?php echo $vetor_oportunidade['id_oportunidade']; ?>
                                        ...
                                        <div class="col-lg-4">
                                            <fieldset class="form-group">
                                                <label class="form-label semibold" for="exampleInput">Qtd de
                                                    Formandos</label>
                                                <input type="number" name="qtdformandos" class="form-control"
                                                       id="exampleInput" placeholder="Digite a Quantidade" required>
                                            </fieldset>
                                        </div>
