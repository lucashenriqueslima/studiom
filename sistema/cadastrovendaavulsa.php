            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title">Venda Avulsa</h4>

                                <form action="recebe_vendaavulsa.php" method="post" name="cliente"
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-12">
                                            <fieldset class="form-group">
                                                <label class="form-label semibold" for="exampleInput">Selecione o
                                                    Contrato</label>
                                                <select name="id_turma" id="turmas" class="form-control" required="">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <select name="id_formando" id="formando" class="form-control"
                                                        required="">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-6">
                                            <fieldset class="form-group">
                                                <label class="form-label semibold" for="exampleInput">Forma de Pagamento
                                                    Parcelas</label>
                                        ...
                                        <div class="col-lg-6">
                                            <fieldset class="form-group">
                                                <label class="form-label semibold" for="exampleInput">Qtd de
                                                    Parcelas</label>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-3">
                                            <fieldset class="form-group">
                                                <label class="form-label semibold" for="exampleInput">Dia
                                                    Vencimento</label>
                                                <select name="diavencimento" class="form-control" required="">
                                        ...
                                        <div class="col-lg-3">
                                            <fieldset class="form-group">
                                                <label class="form-label semibold" for="exampleInput">Data 1°
                                                    Vencimento</label>
                                                <input type="date" name="datavencimento" class="form-control"
                                                       value="<?php echo $dataatual = date('Y-m-d'); ?>">
                                            </fieldset>
                                        </div>
                                        ...
                                        <div class="col-lg-3">
                                            <fieldset class="form-group">
                                                <label class="form-label semibold" for="exampleInput">Valor
                                                    Entrada</label>
                                                <input type="text" name="valorentrada" class="form-control"
                                                       id="exampleInput" placeholder="Valor"
                                        ...
                                        <div class="col-lg-3">
                                            <fieldset class="form-group">
                                                <label class="form-label semibold" for="exampleInput">Forma de Pagamento
                                                    Entrada</label>
                                                <select name="formapagentrada" class="form-control">
                                                    <option value="" selected="selected">Selecione...</option>
                                                    <?php

                                                    $sql_formas_ent = mysqli_query($con, "select * from formaspag where status='1' order by nome ASC");

                                                    while ($vetor_forma_ent = mysqli_fetch_array($sql_formas_ent)) {

                                                        ?>
                                                        <option value="<?php echo $vetor_forma_ent['id_forma']; ?>"><?php echo $vetor_forma_ent['nome'] ?></option>
                                                    <?php } ?>
                                                </select>
                                            </fieldset>
                                        </div>
                                            ...
                                            <div class="col-lg-4">
                                                <fieldset class="form-group">
                                                    <label class="form-label semibold"
                                                           for="exampleInput">Produto</label>
                                                    <select name="id_tipo[]" class="form-control">
                                                        ...
                                                        while ($vetor_produto = mysqli_fetch_array($sql_produtos)) {
                                                            ...
                                                            ?>
                                                            <option value="<?php echo $vetor_produto['id_tipo']; ?>"><?php echo $vetor_produto['nome'] ?></option>
                                                        <?php } ?>
                                                    </select>
                                                </fieldset>
                                            </div>
                                            ...
                                            <div class="col-lg-4">
                                                <fieldset class="form-group">
                                                    <label class="form-label semibold" for="exampleInput">Quantidade de
                                                        Paginas</label>
                                                    <input type="number" name="qtdpaginas[]" class="form-control"
                                                           value="<?php echo $vetor['valor']; ?>" id="exampleInput"
                                    ...
                                    <br>
                                    <input type="button" value="Adicionar Item" onclick="duplicarCampos();"
                                           class="btn btn-warning">
                                    <input type="button" value="Excluir Item" onclick="removerCampos(this);"
