        ...
        <div class="col-xs-12">
          <div class="box">
            <div class="box-header">
              <h3 class="box-title">Cadastro de Tipo de Arquivo</h3>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
            
            <form action="recebe_tipoarquivoformando.php?id=<?php echo $id; ?>" method="post" name="cliente" enctype="multipart/form-data" onSubmit="return verificarCPF()" id="formID">
