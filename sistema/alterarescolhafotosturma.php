...
if ($_SESSION['id'] == null) {
	...
	$id = $_GET['id'];
	$sql = mysqli_query($con, "select * from turmas_escolha where id_turma_escolha = '$id'");
	$vetor = mysqli_fetch_array($sql);
	$sql_evento = mysqli_query($con, "SELECT * FROM eventos_turma WHERE id_evento = '$vetor[id_evento]'");
                        ...
                        <div class="d-flex align-items-center">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item">Top Fotos</a></li>
                                    <li class="breadcrumb-item active" aria-current="page">Alterar Top Fotos</li>
                                </ol>
                            </nav>
                        </div>
                    </div>
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
<!--                                <h4 class="card-title">Cadastro de Top Fotos</h4>-->

                                <ul class="nav nav-tabs" role="tablist">

                                    <li class="nav-item"><a class="nav-link active" data-toggle="tab" href="#dados"
                                                            role="tab"><span class="hidden-sm-up"><i
                                                        class="ti-email"></i></span> <span class="hidden-xs-down">Dados Gerais</span></a>
                                    </li>
                                ...
                                <div class="tab-content tabcontent-border">
                                    ...
                                    <div class="tab-pane active" id="dados" role="tabpanel">
                                        ...
                                        <form action="recebe_alterarescolhafototurma.php?id=<?php echo $id; ?>"
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-12">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <select name="id_evento" id="eventos" class="form-control"
                                                                required="">
                                                            <option value="" selected="">Escolha um Contrato</option>
                                                            <option value="<?php echo $vetor_evento['id_evento']; ?>"
                                                                    selected=""><?php echo $vetor_evento['nome']; ?></option>
                                                        </select>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="row">
                                                <div class="col-md-12">
                                                    <div class="form-group">
                                                        <label>Qtd de Fotos</label>
                                                        <input type="number" name="qtd"
                                                               value="<?php echo $vetor['qtd']; ?>" class="form-control"
                                                               required="">
                                    ...
                                    <div class="tab-pane" id="formandos" role="tabpanel">
                                        ...
                                        <table id="lang_opt" class="table table-bordered table-striped">
                                            ...
                                            <tbody>
																						<?php
																						$sql_formando = mysqli_query($con, "select * from turmas_escolha_formandos a, formandos b where a.id_formando = b.id_formando and id_turma_escolha = '$id' order by nome ASC");
																						while ($vetor_formando = mysqli_fetch_array($sql_formando)) {
																							?>
                                                <tr>
                                                    <td><?php echo $vetor_formando['nome']; ?></td>
                                                    <td><?php echo $vetor_formando['qtd']; ?></td>
                                                    <td>
                                                        <a href="alterarescolhafotosformando.php?id=<?php echo $vetor_formando['id_formando_escolha']; ?>&id1=<?php echo $id; ?>"
                                                           target="_blank">
                                                            <button type="button" class="btn btn-success mesmo-tamanho"
                                                                    title="Ver ou Alterar Cadastro"><i
                                                                        class="mdi mdi-tooltip-edit"></i></button>
                                                        </a>
                                                        <a href="confexcluirescolhafotosformando.php?id=<?php echo $vetor_formando['id_formando_escolha']; ?>&id1=<?php echo $id; ?>">
