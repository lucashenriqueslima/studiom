...
$dompdf = new Dompdf();
    ...
    $message = '<!DOCTYPE html>
        ...
        <table width="100%" style="border: 0">
                                        ...
                                        <tr>
                                        <td width="100%" style="text-align: right; border: 0"><b> Contrato n° '.$vetorturma['ncontrato'].'</b></td>
                                        </tr>
    ...
    (int)$tamanho = count($vetorprodutos);

    
    if(($tamanho <= 9) || ($tamanhofolha != 'A4')){
        ...
        //tabela inteira
          ...
          <table class="tabelap"> 
            <thead>
              <tr>
              <th width="3%"><div style="margin-left: 3px; margin-right: 3px">Cód. Formando</div></th>
              <th width="5%"><div style="margin-left: 3px; margin-right: 3px">Formando</div></th> ';


              foreach ($vetorprodutos as $vetorprodutos){

                $message .= ' <th width="3%"><div style="margin-left: 3px; margin-right: 3px;">'.$vetorprodutos.'</div></th>  
                <th width="3%"><div style="margin-left: 3px; margin-right: 3px">Qtd. Pag.</div></th>';
              }
              ...
              foreach($vetorformando as $vetorformando){  
                ...
                $message .= '
                <tr>
                  <td>'.$sql_formando['ncontrato'].'-'.$sql_formando['codformando'].'</td>
                  <td>'.$sql_formando['nomeformando'].'</td>';
                  ...
                  <tfoot style="background-color: black; color:#ffffff;">
                    <tr>
                      <td colspan="2" style="text-align: center;">Totais:</td>';

                      foreach($vetorTotal as $vetorTotal) { 

                        $message .= '<td>'.$vetorTotal.'</td>';
                      }
      ...
      //tabela 1
        ...
        $vetorprodutos = array_slice($vetorprodutos, 0, $metade);
        ...
        $sql_atual = mysqli_query($con, "select f.id_formando as id_formando, t.ncontrato as ncontrato, f.id_cadastro as codformando, to2.nome as produto, pip.qtdpaginas as qtdpaginas from pacotes_itens_produtos pip 
              ...
              <thead>
                ...
                foreach($vetorformando as $vetorformando){  
                  ...
                  <tr>
                    ...
                    $tamanho = count($vetorprodutos2);

                    if ($tamanho <= 18) {
                      $metade = $tamanho /2 ;
                
                    $vetorprodutos2 = array_slice($vetorprodutos2, 0, $metade);
                    $vetorprodutos22 = array_slice($vetorprodutos2, $metade);
          ...
          $sql_atualt2 = mysqli_query($con, "select f.id_formando as id_formando, t.ncontrato as ncontrato, f.id_cadastro as codformando, to2.nome as produto, pip.qtdpaginas as qtdpaginas from pacotes_itens_produtos pip 
          left join tipo_opcionais to2 on to2.id_tipo = pip.id_produto 
          left join vendas v on v.id_pacote = pip.id_pacote 
          left join formandos f on f.id_formando = v.id_formando
          left join turmas t on t.id_turma = f.turma 
          ...
          while ($vetort2 = mysqli_fetch_array($sql_atualt2)) {
            $vetort2produtos[] = $vetort2['produto'];
          }
          $vetort2produtos = array_unique($vetort2produtos);

          $vetort2produtos = array_slice($vetort2produtos, $metade);
          ...
          while ($vetort2 = mysqli_fetch_array($sql_atualt2)) {
            $vetort2formando[] = $vetort2['id_formando'];
          }
          $vetort2formando = array_unique($vetort2formando);
          ...
          <table class="tabelap"> 
            <thead>
              ...
              foreach ($vetort2produtos as $vetort2produtos){

                $message .= ' <th width="3%"><div style="margin-left: 3px; margin-right: 3px;">'.$vetort2produtos.'</div></th>  
                <th width="3%"><div style="margin-left: 3px; margin-right: 3px">Qtd. Pag.</div></th>';
              }
              ...
              foreach($vetort2formando as $vetort2formando){  
                  $sql_formando = mysqli_fetch_array(mysqli_query($con, "select t.ncontrato as ncontrato, f.id_formando, f.id_cadastro as codformando, f.nome as nomeformando from formandos f
                  left join turmas t on t.id_turma = f.turma 
                  where f.id_formando =  $vetort2formando"));
                ...
                <tr>
                  ...
                  $sql_atualt2produto = mysqli_query($con, "select f.id_formando as id_formando, t.ncontrato as ncontrato, f.id_cadastro as codformando, to2.nome as produto, pip.qtdpaginas as qtdpaginas from pacotes_itens_produtos pip 
                  left join tipo_opcionais to2 on to2.id_tipo = pip.id_produto 
                  left join vendas v on v.id_pacote = pip.id_pacote 
                  left join formandos f on f.id_formando = v.id_formando
                  left join turmas t on t.id_turma = f.turma 
                  ...
                  while ($vetort2produto = mysqli_fetch_array($sql_atualt2produto)) {
                    
                    $vetort2produtoss[] = $vetort2produto['produto'];
                  }
                  
                  $vetort2produtos2 = array_unique($vetort2produtoss);

                  $tamanho = count($vetort2produtos2);

                  if ($tamanho <= 18) {
                    $metade = $tamanho /2 ;
              
                  $vetort2produtos2 = array_slice($vetort2produtos2, $metade);
                  
                  }



                  foreach($vetort2produtos2 as $vetort2produtos2){
                    $sql_qtd = mysqli_fetch_array(mysqli_query($con, "select distinct id_produto_item, CONCAT(pip.id_produto, '(',count(pip.id_produto_item),')') as qtd
                            from pacotes_itens_produtos pip 
                            left join tipo_opcionais to2 on to2.id_tipo = pip.id_produto 
                            left join vendas v on v.id_pacote = pip.id_pacote 
                            left join formandos f on f.id_formando = v.id_formando
                            left join turmas t on t.id_turma = f.turma 
                            where f.id_formando = $vetort2formando and to2.nome = '$vetort2produtos2'"));
                  ...
                  foreach($vetort2produtos2 as $vetort2produtos2){
                    ...
                    $sql_totalProduto = mysqli_num_rows(mysqli_query($con, "select f.nome   from pacotes_itens_produtos pip 
                          left join tipo_opcionais to2 on to2.id_tipo = pip.id_produto 
                                ...
                                left join formandos f on f.id_formando = v.id_formando
                                left join turmas t on t.id_turma = f.turma 
                                where t.id_turma = $idturma and to2.nome = '$vetort2produtos2'"));
                          ...
                          if (!isset($sql_totalProduto)) {
                            ...
                            $vetort2Total[] = $sql_totalProduto;
                          }

                          if (!isset($sql_totalQuantidade['qtdpaginas'])) {
                            $vetort2Total[] = 0;
                          }else {
                            $vetort2Total[] = $sql_totalQuantidade['qtdpaginas'];
                          }   
                  ...
                  <tfoot style="background-color: black; color:#ffffff;">
                    <tr>
                      ...
                      foreach($vetort2Total as $vetort2Total) { 

                        $message .= '<td>'.$vetort2Total.'</td>';
                      }
      ...
      $sql_atual = mysqli_query($con, "select f.id_formando as id_formando, t.ncontrato as ncontrato, f.id_cadastro as codformando, to2.nome as produto, pip.qtdpaginas as qtdpaginas from pacotes_itens_produtos pip 
        ...
        $vetort2produtos = array_slice($vetort2produtos, $metade , +$metade);
          ...
          <thead>
            ...
            foreach($vetort2formando as $vetort2formando){  
              ...
              <tr>
                ...
                $vetort2produtos2 = array_slice($vetort2produtos2, $metade , +$metade);
      ...
      $sql_atualt3 = mysqli_query($con, "select f.id_formando as id_formando, t.ncontrato as ncontrato, f.id_cadastro as codformando, to2.nome as produto, pip.qtdpaginas as qtdpaginas from pacotes_itens_produtos pip 
      left join tipo_opcionais to2 on to2.id_tipo = pip.id_produto 
      left join vendas v on v.id_pacote = pip.id_pacote 
      left join formandos f on f.id_formando = v.id_formando
      left join turmas t on t.id_turma = f.turma 
      ...
      while ($vetort3 = mysqli_fetch_array($sql_atualt3)) {
        $vetort3produtos[] = $vetort3['produto'];
      }
      $vetort3produtos = array_unique($vetort3produtos);
      
      $vetort3produtos = array_slice($vetort3produtos, ($metade+$metade));
      ...
      while ($vetort3 = mysqli_fetch_array($sql_atualt3)) {
        $vetort3formando[] = $vetort3['id_formando'];
      }
      $vetort3formando = array_unique($vetort3formando);
      ...
      <table class="tabelap"> 
        <thead>
          ...
          foreach ($vetort3produtos as $vetort3produtos){

            $message .= ' <th width="3%"><div style="margin-left: 3px; margin-right: 3px;">'.$vetort3produtos.'</div></th>  
            <th width="3%"><div style="margin-left: 3px; margin-right: 3px">Qtd. Pag.</div></th>';
          }
          ...
          foreach($vetort3formando as $vetort3formando){  
              $sql_formando = mysqli_fetch_array(mysqli_query($con, "select t.ncontrato as ncontrato, f.id_formando, f.id_cadastro as codformando, f.nome as nomeformando from formandos f
              left join turmas t on t.id_turma = f.turma 
              where f.id_formando =  $vetort3formando"));
            ...
            <tr>
              ...
              $sql_atualt3produto = mysqli_query($con, "select f.id_formando as id_formando, t.ncontrato as ncontrato, f.id_cadastro as codformando, to2.nome as produto, pip.qtdpaginas as qtdpaginas from pacotes_itens_produtos pip 
              left join tipo_opcionais to2 on to2.id_tipo = pip.id_produto 
              left join vendas v on v.id_pacote = pip.id_pacote 
              left join formandos f on f.id_formando = v.id_formando
              left join turmas t on t.id_turma = f.turma 
              ...
              while ($vetort3produto = mysqli_fetch_array($sql_atualt3produto)) {
                
                $vetort3produtoss[] = $vetort3produto['produto'];
              }
              
              $vetort3produtos2 = array_unique($vetort3produtoss);

              $tamanho = count($vetort3produtos2);

              if ($tamanho > 18) {
                $metade = $tamanho /3 ;
          
              $vetort3produtos2 = array_slice($vetort3produtos2, ($metade+$metade));
              
              }



              foreach($vetort3produtos2 as $vetort3produtos2){
                $sql_qtd = mysqli_fetch_array(mysqli_query($con, "select distinct id_produto_item, CONCAT(pip.id_produto, '(',count(pip.id_produto_item),')') as qtd
                        from pacotes_itens_produtos pip 
                        left join tipo_opcionais to2 on to2.id_tipo = pip.id_produto 
                        left join vendas v on v.id_pacote = pip.id_pacote 
                        left join formandos f on f.id_formando = v.id_formando
                        left join turmas t on t.id_turma = f.turma 
                        where f.id_formando = $vetort3formando and to2.nome = '$vetort3produtos2'"));
              ...
              foreach($vetort3produtos2 as $vetort3produtos2){
                ...
                $sql_totalProduto = mysqli_num_rows(mysqli_query($con, "select f.nome   from pacotes_itens_produtos pip 
                      left join tipo_opcionais to2 on to2.id_tipo = pip.id_produto 
                            ...
                            left join formandos f on f.id_formando = v.id_formando
                            left join turmas t on t.id_turma = f.turma 
                            where t.id_turma = $idturma and to2.nome = '$vetort3produtos2'"));
                      ...
                      if (!isset($sql_totalProduto)) {
                        ...
                        $vetort3Total[] = $sql_totalProduto;
                      }

                      if (!isset($sql_totalQuantidade['qtdpaginas'])) {
                        $vetort3Total[] = 0;
                      }else {
                        $vetort3Total[] = $sql_totalQuantidade['qtdpaginas'];
                      }   
              ...
              <tfoot style="background-color: black; color:#ffffff;">
                <tr>
                  ...
                  foreach($vetort3Total as $vetort3Total) { 

                    $message .= '<td>'.$vetort3Total.'</td>';
                  }
    ...
    $dompdf->setPaper($tamanhofolha, 'landscape');
    //$dompdf->setPaper('A4', 'portrait');
    $dompdf->render();
    
    //$dompdf->stream($message,array("Attachment"=>0));
    $dompdf->stream( "Relatório de Compra de Produto(s) - ".$vetorturma['ncontrato'].' - '.$vetor_curso['nome'].".pdf");
    $dompdf->stream($message, array("Attachment" => true));
?>