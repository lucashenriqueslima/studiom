<?php
    ...
    $sql = mysqli_query($con, "select * from vendas where id_venda = '$id'");
    ...
    $sql_duplicatas = mysqli_query($con, "select * from duplicatas_faturas where id_duplicata = '$vetor_duplicata[id_duplicata]'");
...
<script type="text/javascript">
          $(document).ready(function(){
              $('#turmas').change(function(){
                  $('#produto').load('produtosturma.php?id_turma='+$('#turmas').val() );
                        ...
                        <div class="d-flex align-items-center">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active" aria-current="page">Gestão de Álbuns</li>
                                </ol>
                            </nav>
                        </div>
                    </div>
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title">Gestão de Álbuns</h4>
                                ...
                                <table width="100%">
                                  <tr>
                                    <td width="74%" valign="middle"><strong><?php echo $vetor_turma['ncontrato']; ?> - <?php echo $vetor_curso_inicio['nome']; ?> <?php echo $vetor['ano']; ?> <?php echo $vetor_instituicao_inicio['nome']; ?></strong></td>
                                    <td width="10%"></td>
                                    <td width="16%" valign="middle">
                                      <table width="100%">
                                        <tr>
                                          <td width="70%">Relatório de Venda: </td>
                                          <td width="30%"><a href="imprimirrelvendaalbum.php?id_turma=<?php echo $id_turma; ?>" target="_blank"><button type="button" class="btn btn-primary mesmo-tamanho" title="Imprimir Cadastros"><i class="fa fa-print"></i></button></a></td>
                                        </tr>
                                        <tr>
                                          <td></td>
                                        ...
                                        <tr>
                                          ...
                                          <td width="30%"><a href="imprimirrelvendaboletoalbum.php?id_turma=<?php echo $id_turma; ?>" target="_blank"><button type="button" class="btn btn-primary mesmo-tamanho" title="Imprimir Cadastros"><i class="fa fa-print"></i></button></a></td>
                                        </tr>
                                        <tr>
                                          <td></td>
                                          <td><img src="imgs/transp.png"></td>
                                        ...
                                        <tr>
                                          ...
                                          <td width="30%"><a href="imprimirrelprotocoloalbum.php?id_turma=<?php echo $id_turma; ?>" target="_blank"><button type="button" class="btn btn-primary mesmo-tamanho" title="Imprimir Cadastros"><i class="fa fa-print"></i></button></a></td>
                                        </tr>
                                      </table>
                                    </td>
                                  </tr>
                                ...
                                <table class="table table-bordered table-striped">
                                    ...
                                    <tr>
                                      ...
                                      $sql_total_contratos = mysqli_query($con, "select * from vendas a, formandos b where a.id_formando = b.id_formando and b.turma = '$id_turma' and a.iniciada = '2' and (a.tipo = '2' or a.tipo = '3')");

                                      $sql_soma_qtd2 = mysqli_query($con, "SELECT SUM(a.valorvenda) as total FROM vendas a, formandos c where a.id_formando = c.id_formando and c.turma = '$id_turma' and a.status != '4' and a.iniciada = '2' and (a.tipo = '2' or a.tipo = '3')");
                                      $vetor_soma_qtd2 = mysqli_fetch_array($sql_soma_qtd2);

                                      $sql_soma_avista = mysqli_query($con, "SELECT SUM(a.valorvenda) as total FROM vendas a, formandos c where a.id_formando = c.id_formando and c.turma = '$id_turma' and a.status != '4' and a.formapag = '4' and a.iniciada = '2' and (a.tipo = '2' or a.tipo = '3')");
                                      $vetor_soma_vista = mysqli_fetch_array($sql_soma_avista);

                                      $sql_soma_avista1 = mysqli_query($con, "SELECT SUM(a.valorvenda) as total FROM vendas a, formandos c where a.id_formando = c.id_formando and c.turma = '$id_turma' and a.status != '4' and a.formapag = '12' and a.iniciada = '2' and (a.tipo = '2' or a.tipo = '3')");
                                      $vetor_soma_vista1 = mysqli_fetch_array($sql_soma_avista1);

                                      $sql_soma_avista2 = mysqli_query($con, "SELECT SUM(a.valorvenda) as total FROM vendas a, formandos c where a.id_formando = c.id_formando and c.turma = '$id_turma' and a.status != '4' and a.formapag = '13' and a.iniciada = '2' and (a.tipo = '2' or a.tipo = '3')");
                                      $vetor_soma_vista2 = mysqli_fetch_array($sql_soma_avista2);

                                      $totalavista = $vetor_soma_vista['total'] + $vetor_soma_vista1['total'] + $vetor_soma_vista2['total'];

                                      $sql_vendas = mysqli_query($con, "select * from vendas a, formandos b where a.id_formando = b.id_formando and b.turma = '$id_turma' and a.iniciada = '2' and (a.tipo = '2' or a.tipo = '3')");
                                      $vetor_vendas = mysqli_fetch_array($sql_vendas);

                                      $sql_pacotes = mysqli_query($con, "select * from pacotes_itens_album where id_item = '$vetor_vendas[id_pacote]' order by id_item ASC");
                                      ...
                                      $totalcomissao = $totalavista - ($percentual * $totalavista);

                                      $sobra = $totalavista - $totalcomissao;
                                      ...
                                      <th></th>
                                      <th></th>
                                      <th>R$ <?php echo $num = number_format($vetor_soma_qtd2['total'],2,',','.'); ?></th>
                                      <th>R$ <?php echo $num = number_format($finalvenda,2,',','.'); ?></th>
                                      <th></th>
                                    </tr>
                                    <tr bgcolor="#e8e8e8">
                                      <th></th>
                                    ...
                                    <?php 
                                      ...
                                      $sql_venda = mysqli_query($con, "select * from vendas where id_formando = '$vetor_atual[id_formando]' and iniciada = '2' and (a.tipo = '2' or a.tipo = '3') order by id_venda DESC limit 0,1");
                                      $vetor_venda = mysqli_fetch_array($sql_venda);

                                      $sql_pacotes_formando = mysqli_query($con, "select * from pacotes_itens_album where id_item = '$vetor_venda[id_pacote]' order by id_item ASC");
                                      $vetor_pacotes_formando = mysqli_fetch_array($sql_pacotes_formando);

                                      $sql_pacote_venda_formando = mysqli_query($con, "select * from pacotes where id_pacote = '$vetor_pacotes_formando[id_pacote]'");
                                      $vetor_pacote_venda_formando = mysqli_fetch_array($sql_pacote_venda_formando);
                                    ...
                                    <tr>
                                      ...
                                      $sql_soma_valor = mysqli_query($con, "SELECT SUM(valorvenda) as total FROM vendas where id_formando = '$vetor_atual[id_formando]' and iniciada = '2' and (tipo = '2' or tipo = '3')");
                                      ...
                                      $percentual = $vetor_pacote_venda['desconto'] / 100.0; 
                                      $valorfinal = $vetor_soma_valor['total'] - ($percentual * $vetor_soma_valor['total']); 

                                      } else { 

                                          $valorfinal = $vetor_soma_valor['total'];
                                      ...
                                      <td><?php if($vetor_venda['duplicata'] == 1) { ?><a href="confirmarcompraalbum.php?id=<?php echo $vetor_venda['id_venda']; ?>"><i class="fa fa-check-circle" title="Confirmar Venda"></i></a><?php } ?></td>
                                    </tr>
                                    <?php $i++; } ?>
                                    </tbody>
                                  </table>

                                  <h3>Total de contratos: <?php echo mysqli_num_rows($sql_total_contratos); ?></h3>
                            </div>
                        </div>
                    </div>
                </div>
