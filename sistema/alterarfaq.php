    ...
    <div id="main-wrapper">
        ...
        <div class="page-wrapper">
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title">Cadastro de Convite Formando</h4>

                                <form action="recebe_alterarfaq.php?id=<?php echo $id; ?>" method="post" name="cliente" enctype="multipart/form-data" onSubmit="return verificarCPF()" id="formID">
            ...
            <div class="row">
              <div class="col-lg-6">
                <fieldset class="form-group">
                  ...
                  <select name="id_departamento" class="form-control" required="">
                    ...
                    ?>
                    <option value="<?php echo $vetor_departamento['id_departamento']; ?>" <?php if (strcasecmp($vetor['id_departamento'], $vetor_departamento['id_departamento']) == 0) : ?>selected="selected"<?php endif; ?>><?php echo $vetor_departamento['nome']; ?></option>
                    <?php } ?>
                  </select>
                </fieldset>
              </div>
              <div class="col-lg-6">
                <fieldset class="form-group">
                  <label class="form-label semibold" for="exampleInput">Serviço</label>
                  <select name="servico" class="form-control" required="">
                    <option value="" selected="">Selecione...</option>
                    <option value="1" <?php if (strcasecmp($vetor['servico'], '1') == 0) : ?>selected="selected"<?php endif; ?>>Convite</option>
                    <option value="2" <?php if (strcasecmp($vetor['servico'], '2') == 0) : ?>selected="selected"<?php endif; ?>>Fotografia</option>
                  </select>
                </fieldset>
              </div>
            </div><!--.row-->
            ...
            <div class="row">
              <div class="col-lg-6">
                <fieldset class="form-group">
                  <label class="form-label semibold" for="exampleInput">Tipo Cadastro</label>
                  <select name="tipocad" class="form-control" required="">
                    <option value="" selected="">Selecione...</option>
                    <option value="1" <?php if (strcasecmp($vetor['tipocad'], '1') == 0) : ?>selected="selected"<?php endif; ?>>Interno</option>
                    <option value="2" <?php if (strcasecmp($vetor['tipocad'], '2') == 0) : ?>selected="selected"<?php endif; ?>>Formando</option>
                    <option value="3" <?php if (strcasecmp($vetor['tipocad'], '3') == 0) : ?>selected="selected"<?php endif; ?>>Ambos</option>
                  </select>
                </fieldset>
              </div>
              <div class="col-lg-6">
                <fieldset class="form-group">
                  <label class="form-label semibold" for="exampleInput">Assunto</label>
                  <input type="text" name="assunto" value="<?php echo $vetor['assunto']; ?>" class="form-control" id="exampleInput" placeholder="Digite o Assunto" required>
                </fieldset>
              </div>
            </div><!--.row-->
            ...
            <div class="row">
                        <div class="col-lg-12">
                            <fieldset class="form-group">
                                <label class="form-label semibold" for="exampleInput">Pergunta</label>
                                <input type="text" name="pergunta" value="<?php echo $vetor['pergunta']; ?>" class="form-control" id="exampleInput" placeholder="Digite a Pergunta" required>
                            </fieldset>
                        </div>
                    </div><!--.row-->
            ...
            <div class="row">
              <div class="col-lg-12">
                <fieldset class="form-group">
                  <label class="form-label semibold" for="exampleInput">Resposta</label>
