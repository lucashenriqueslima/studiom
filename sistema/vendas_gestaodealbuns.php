                          ...
                          <div class="d-flex align-items-center">
                              <nav aria-label="breadcrumb">
                                  <ol class="breadcrumb">
                                      ...
                                      <li class="breadcrumb-item active" aria-current="page">Gestão de Álbuns e Fotografias</li>
                                  </ol>
                              </nav>
                          </div>
                      </div>
...
<!--                                  <h4 class="card-title">Gestão de Álbuns</h4>-->
                                  ...
                                  <form action="recebe_buscagestaoalbuns.php" method="post" name="cliente"
                                          ...
                                          <div class="col-lg-12">
                                              <fieldset class="form-group">
                                                  ...
                                                  <select name="tipo" id="tipo" class="form-control">
                                                      <option value="1" selected="selected">Álbuns e Vendas Avulsas</option>
                                                      <option value="2">Taxa de Estúdio</option>
                                                  </select>
                                              </fieldset>
                                          </div>
                                      </div>
