                          ...
                          <div class="d-flex align-items-center">
                              <nav aria-label="breadcrumb">
                                  <ol class="breadcrumb">
                                      ...
                                      <li class="breadcrumb-item active" aria-current="page">Orçamentos de Convites</li>
                                  </ol>
                              </nav>
                          </div>
                      </div>
              ...
              <div class="container-fluid">
                  ...
                  <div class="row">
                      <div class="col-12">
                          <div class="card">
                              <div class="card-body">
<!--                                  <h4 class="card-title">Orçamentos Convite</h4>-->
																
																<?php if ($vetor_permissao['cadastro'] == 1) {
																}else { ?><a href="cadastroorcconvite.php">
                                    <button type="button" class="btn waves-effect waves-light btn-warning">Nova Tabela
                                    </button>
                                </a>
                                  ...
                                  <div class="table-responsive">
                                      <table id="lang_opt" class="table table-striped table-bordered display"
                                          ...
                                          <tbody>
																					<?php
																					$sql_atual = mysqli_query($con, "select * from orcamento_convite order by id_orcamento DESC");
																					while ($vetor = mysqli_fetch_array($sql_atual)) {
																						...
																						if ($vetor['tipo'] == 2) {
																							$sql_turma = mysqli_query($con, "select * from turmas where id_turma = '$vetor[id_oportunidade]'");
																							$vetor_turma = mysqli_fetch_array($sql_turma);
																						...
																						?>
                                              <tr>
                                                  <td><?php echo $vetor['id_orcamento']; ?></td>
                                                  <td><?php if ($vetor['tipo'] == 1) { ?><?php echo $vetor['id_oportunidade']; ?> - <?php echo $vetor_curso['nome']; ?> / <?php echo $vetor_curso['sigla']; ?> / <?php echo $vetor_turma['conclusao']; ?>-<?php echo $vetor_turma['semestre']; ?><?php }
																										if ($vetor['tipo'] == 2) { ?><?php echo $vetor_turma['ncontrato']; ?> - <?php echo $vetor_curso_inicio['nome']; ?> / <?php echo $vetor_instituicao_inicio['nome']; ?> / <?php echo $vetor_turma['ano']; ?><?php } ?></td>
                                                  <td><?php echo $vetor['qtdformandos']; ?></td>
                                                  <td><?php echo date('d/m/Y', strtotime($vetor['data'])); ?></td>
                                                  <td>
                                                      R$<?php echo $num = number_format($vetor['valortotal'], 2, ',', '.'); ?></td>
                                                  ...
                                                  <td><a class="fancybox fancybox.ajax"
                                                         href="cadastroorcconvite_produtos.php?id=<?php echo $vetor['id_orcamento']; ?>"
                                                         target="_blank">
