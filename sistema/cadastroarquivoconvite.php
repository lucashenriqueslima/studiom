            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title">Cadastro de Convite</h4>

                                <form action="recebe_arquivodeconvite.php" method="post" name="cliente" enctype="multipart/form-data" onSubmit="return verificarCPF()" id="formID">
                              ...
                              <select name="tipo" class="form-control" required="">
                                ...
                                <option value="1">Layout Artes</option>
                                <option value="2">Layout Convite</option>
                                <option value="3">Fotos</option>
                                <option value="4">Dados Convite</option>
                                <option value="5">Fotos Recortadas</option>
                              </select>
                              </div>
                              </div>
                              <div class="col-md-6">
