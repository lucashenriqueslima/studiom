                        ...
                        <div class="d-flex align-items-center">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item">Bancos</a></li>
                                    <li class="breadcrumb-item active" aria-current="page">Cadastrar novo Banco</li>
                                </ol>
                            </nav>
                        </div>
                    </div>
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <form action="recebe_cadbanco.php" method="post" name="cliente"
                                    ...
                                    <div class="row">
                                        <div class="col-lg-12">
                                            <fieldset class="form-group">
                                                ...
                                                <input type="text" name="banco" class="form-control" id="exampleInput"
                                                       placeholder="Digite o Banco" required>
                                            </fieldset>
                                        </div>
                                    </div><!--.row-->
