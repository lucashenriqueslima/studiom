                          ...
                          <div class="d-flex align-items-center">
                              <nav aria-label="breadcrumb">
                                  <ol class="breadcrumb">
                                      ...
                                      <li class="breadcrumb-item active" aria-current="page">Liberar Fotos</li>
                                  </ol>
                              </nav>
                          </div>
                      </div>
              ...
              <div class="container-fluid">
                  ...
                  <div class="row">
                      <div class="col-12">
                          <div class="card">
                              <div class="card-body">
<!--                                  <h4 class="card-title">Liberar Fotos</h4>-->

                                  <form action="recebe_liberarfotos.php" method="post" name="cliente"
                                      ...
                                      <button type="submit" class="btn btn-primary" style="float: left;">Liberar
                                      </button>
      ...
      <script>
            $(document).ready(function(){
                $('#turmas').change(function(){
                    $('#formando').load('listaformandos_libera.php?id_turma='+$('#turmas').val() );
                });
            });
        </script>
      </body>
