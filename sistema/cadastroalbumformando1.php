...
<head>
  ...
  <title>Studiom Fotografias</title>
        ...
        <div class="col-xs-12">
          <div class="box">
            <div class="box-header">
              <h3 class="box-title">Álbum Turma</h3>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
            
            <form action="recebe_albumformando.php" method="post" name="cliente" enctype="multipart/form-data" onSubmit="return verificarCPF()" id="formID">
				
              <input type="hidden" name="id_turma" value="<?php echo $vetor_formando['turma']; ?>">
