                        ...
                        <div class="d-flex align-items-center">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item">Turmas</a></li>
                                    <li class="breadcrumb-item active" aria-current="page">Cadastrar Nova Turma</li>
                                </ol>
                            </nav>
                        </div>
                    </div>
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title">Turma</h4>

                                <form action="recebe_turmamkt.php" method="post" name="cliente"
                                                ...
                                                <select name="id_curso" id="categorias" class="form-control">
                                                    ...
                                                    while ($vetor_curso = mysqli_fetch_array($sql_cursos)) {
                                                        ...
                                                        <option value="<?php echo $vetor_curso['id_curso']; ?>"><?php echo $vetor_curso['nome'] ?>
                                                            / <?php echo $vetor_curso['sigla'] ?></option>
                                                    <?php } ?>
                                                </select>
                                            </fieldset>
                                        </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-6">
                                            <fieldset class="form-group">
                                                <label class="form-label semibold" for="exampleInput">Ano
                                                    Conclusão</label>
                                                <input type="number" name="conclusao" class="form-control"
                                                       id="exampleInput" placeholder="Digite o Ano Conclusão" required>
                                            </fieldset>
                                        </div>
                                        ...
                                        <div class="col-lg-6">
                                            <fieldset class="form-group">
                                                ...
                                                <input type="number" name="semestre" class="form-control"
                                                       id="exampleInput" placeholder="Digite a Semestre" required>
                                            </fieldset>
                                        </div>
                                                ...
                                                <fieldset class="form-group">
                                                    ...
                                                    <select name="tipo[]" class="form-control">
                                                        ...
                                                        <option value="Facebook"
                                                                <?php if (strcasecmp($vetor_rede['tipo'], 'Facebook') == 0) : ?>selected="selected"<?php endif; ?>>
                                                            Facebook
                                                        </option>
                                                        <option value="Instagram"
                                                                <?php if (strcasecmp($vetor_rede['tipo'], 'Instagram') == 0) : ?>selected="selected"<?php endif; ?>>
                                                            Instagram
                                                        </option>
                                                        <option value="Twitter"
                                                                <?php if (strcasecmp($vetor_rede['tipo'], 'Twitter') == 0) : ?>selected="selected"<?php endif; ?>>
                                                            Twitter
                                                        </option>
                                            ...
                                            <div class="col-lg-6">
                                                <fieldset class="form-group">
                                                    ...
                                                    <input type="text" name="link[]" class="form-control"
                                                           value="<?php echo $vetor_rede['link']; ?>">
                                                </fieldset>
                                            </div>
                                    ...
                                    <br>
                                    <input type="button" value="Adicionar Rede Social" onclick="duplicarCampos();"
                                           class="btn btn-warning">
                                    <input type="button" value="Excluir Rede Social" onclick="removerCampos(this);"
