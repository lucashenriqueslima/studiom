...
if ($_SESSION['id'] == null) {
	...
	$id = $_GET['id'];
	$id1 = $_GET['id1'];
	$sql = mysqli_query($con, "select * from turmas_escolha_formandos a, formandos b where a.id_formando = b.id_formando and id_formando_escolha = '$id'");
                        ...
                        <div class="d-flex align-items-center">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item">Alterar Top Fotos</a></li>
                                    <li class="breadcrumb-item active" aria-current="page">Ver ou Alterar Cadastro</li>
                                </ol>
                            </nav>
                        </div>
                    </div>
...
<!--                                <h4 class="card-title">Cadastro de Top Fotos</h4>-->
                                ...
                                <form action="recebe_alterarescolhafotoformando.php?id=<?php echo $id; ?>&id1=<?php echo $id1; ?>"
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <input type="number" name="qtd" value="<?php echo $vetor['qtd']; ?>"
