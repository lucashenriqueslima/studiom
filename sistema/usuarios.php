...
<!--                                <h4 class="card-title">Usuários</h4>-->
                                ...
                                <div class="table-responsive">
                                    <table id="lang_opt" class="table table-striped table-bordered display"
                                        ...
                                        <tbody>
																				<?php
																				$sql_atual = mysqli_query($con, "select * from usuarios order by nome ASC");
																				while ($vetor = mysqli_fetch_array($sql_atual)) {
																					...
																					$sql_perfil = mysqli_query($con, "select * from perfil where id_perfil = '$vetor[id_perfil]'");
																					$vetor_perfil = mysqli_fetch_array($sql_perfil);
																					?>
                                            <tr>
                                                <td><?php echo $vetor['id_usuario']; ?></td>
                                                <td><?php echo $vetor['nome']; ?></td>
                                                <td><?php echo $vetor_departamento['nome']; ?></td>
                                                <td><?php echo $vetor_perfil['nome']; ?></td>
                                                <td><a class="fancybox fancybox.ajax"
                                                       href="alterarusuario.php?id=<?php echo $vetor['id_usuario']; ?>"
                                                       target="_blank">
                                                        <button type="button" class="btn btn-success mesmo-tamanho"
                                                                title="Ver ou Alterar Cadastro"><i
                                                                    class="mdi mdi-tooltip-edit"></i></button>
                                                    </a>
                                                    <a href="liberarpermissoes.php?id=<?php echo $vetor['id_usuario']; ?>">
                                                        <button type="button" class="btn btn-warning mesmo-tamanho"
                                                                title="Liberar Permissões"><i
                                                                    class="mdi mdi-account-key"></i></button>
                                                    </a> <a class="fancybox fancybox.ajax"
                                                            href="confexcluirusuario.php?id=<?php echo $vetor['id_usuario']; ?>">
