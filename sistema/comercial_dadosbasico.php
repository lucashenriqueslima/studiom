              ...
              <div class="container-fluid">
                  ...
                  <div class="row">
                      <div class="col-12">
                          <div class="card">
                              <div class="card-body">
<!--                                  <h4 class="card-title">Dados Convite</h4>-->
																
																<?php if ($vetor_permissao['cadastro'] == 1) {
																}else { ?><a href="cadastrodadosbasico.php">
                                    <button type="button" class="btn waves-effect waves-light btn-warning">Novo Dado de Convite
                                    </button>
                                </a>
                                  ...
                                  <div class="table-responsive">
                                      <table id="lang_opt" class="table table-striped table-bordered display"
                                          ...
                                          <tbody>
																					<?php
																					$sql_atual = mysqli_query($con, "select * from tabela_basico order by id_basico ASC");
																					while ($vetor = mysqli_fetch_array($sql_atual)) {
																						$sql_tipo = mysqli_query($con, "select * from tipos_produtos where id_tipo = '$vetor[id_produto]'");
																						$vetor_tipo = mysqli_fetch_array($sql_tipo);
																						$sql_tipo_final = mysqli_query($con, "select * from tabela_tipos where id_tipo = '$vetor[id_tamanho]'");
																						$vetor_tipo_final = mysqli_fetch_array($sql_tipo_final);
																						?>
                                              <tr>
                                                  <td><?php if ($vetor['id_produto'] == 2) {
																											echo "Super Luxo";
																										}else {
																											echo "Simples";
																										} ?></td>
