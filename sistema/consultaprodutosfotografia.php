                        ...
                        <div class="d-flex align-items-center">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active" aria-current="page">Aprovações - Produtos
                                        Fotografia
                                    </li>
                                </ol>
                            </nav>
                            ...
                            <div class="card-body">
                                <h4 class="card-title">Aprovações - Produtos Fotografia</h4>
                                  ...
                                  <div class="alert alert-success" role="alert">
																		<?php echo $_SESSION['nome']; ?>, parabéns pela aprovação do
                                      seu <?php echo $vetor_produto_item_final['nome']; ?>. Logo entraremos em contato
                                      informando sobre o envio do (s) produto (s).
                                  </div>
															
															<?php }else { ?>

                                  <div class="alert alert-danger" role="alert">
																		<?php echo $_SESSION['nome']; ?>, ainda restam produtos a serem aprovados. Por favor
                                      finalize a aprovação destes produtos. Deseja finalizar a aprovação para os demais
                                      produtos agora?.
                                  </div>
                                      ...
                                      <div class="modal-dialog">
                                          <div class="modal-content">
                                              <div class="modal-header">
                                                  <h4 class="modal-title" id="myModalLabel">Aprovações - Produtos
                                                      Fotografia</h4>
                                              ...
                                              <div class="modal-body">
                                                  <p>Ainda restam produtos as quais as fotografias ainda precisam ser
                                                      escolhidas. Informamos que seus produtos entrarão em nosso
                                                      cronograma de produção apenas quando finalizar a escolha de todos
                                                      eles, pois serão produzidos de uma só vez devido a logística da
                                                      entrega..</p>
                                              </div>
                                              <div class="modal-footer">
                                                  <a href="dashboard.php">
                                                      <button type="button" class="btn btn-danger"
                                                              style="    float: left;">Sair das Aprovações
                                                      </button>
                                                  </a>
                                                  <a href="consultaprodutosfotografia_continuar.php?id=<?php echo $id; ?>">
                                                      <button type="button" class="btn btn-info waves-effect"
                                                              data-dismiss="modal">Continuar nas Aprovações
                                                      </button>
                                                  </a>
                                              </div>
                                          </div>
                                      ...
                                      <tr>
                                          <td width="3%">
                                              <button type="button" class="btn btn-primary"
                                                      onclick="EscondeElemento('escondido')" value="Esconde Div"
                                                      style="    float: left;">Sim
                                              </button>
                                          </td>
                                          <td width="1%"></td>
                                          <td>
                                              <button type="button" class="btn btn-danger" data-toggle="modal"
                                                      data-target="#myModal" data-whatever="@mdo"
                                                      style="    float: left;">Não
                                              </button>
                                          </td>
                                      </tr>
                                  </table>
                                              ...
                                              <tbody>
                                                  ...
                                                  <tr>
                                                      <td><?php echo $vetor_contrato['ncontrato']; ?>
                                                          - <?php echo $vetor_curso_inicio['nome']; ?> <?php echo $vetor_contrato['ano']; ?> <?php echo $vetor_instituicao_inicio['nome']; ?>
                                                          / <?php echo $i; ?></td>
                                                      <td><?php echo $vetor_formando['nome']; ?></td>
                                                      <td><?php echo date('d/m/Y', strtotime($vetor['data'])); ?></td>
                                                      <td><?php if ($vetor['status'] == 1) {
																													echo "Em Aberto";
																												}
																												if ($vetor['status'] == 2) {
																													echo "Em Preenchimento";
																												}
																												if ($vetor['status'] == 3) {
																													echo "Aprovado com Ressalva";
																												}
																												if ($vetor['status'] == 4) {
																													echo "Aprovado";
																												} ?></td>
                                                      <td><?php if ($vetor['datafinal'] == null || $vetor['datafinal'] >= $dataatual) { ?>
                                                              <a
                                                              href="inicioalbum.php?id=<?php echo $vetor['id_meualbum']; ?>">
                                                                  <button type="button"
                                                                          class="btn btn-default mesmo-tamanho"
                                                                          title="Ver ou Alterar Cadastro"><i
                                                                              class="fa fa-edit"></i></button>
                                                              </a><?php }else { ?><a
                                                              href="veralbum.php?id=<?php echo $vetor['id_meualbum']; ?>">
                                                                  <button type="button"
                                                                          class="btn btn-default mesmo-tamanho"
                                                                          title="Ver ou Alterar Cadastro"><i
