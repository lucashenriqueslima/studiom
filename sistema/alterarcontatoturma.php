<?php
    ...
    $sql = mysqli_query($con, "select * from contatos_mkt where id_contato = '$id'");
                        ...
                        <div class="d-flex align-items-center">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active" aria-current="page">Contato Turma</li>
                                </ol>
                            </nav>
                        </div>
                    </div>
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title">Cadastro de Contato Turma</h4>

                                <form action="recebe_alterarcontatoturma.php?id=<?php echo $id; ?>&id1=<?php echo $id1; ?>" method="post" name="cliente" enctype="multipart/form-data" onSubmit="return verificarCPF()" id="formID">
                                ...
                                <div class="row">
                                  ...
                                  <div class="col-lg-6">
                                    <fieldset class="form-group">
                                      ...
                                      <input type="text" name="nome" class="form-control" value="<?php echo $vetor['nome']; ?>">
                                    </fieldset>
                                  </div>
                                  ...
                                  <div class="col-lg-6">
                                    <fieldset class="form-group">
                                      ...
                                      <input type="text" name="telefone" id="telefone" class="form-control" value="<?php echo $vetor['telefone']; ?>">
                                    </fieldset>
                                  </div>
                                ...
                                <div class="row">
                                  ...
                                  <div class="col-lg-4">
                                    <fieldset class="form-group">
                                      ...
                                      <input type="text" name="email" class="form-control" value="<?php echo $vetor['email']; ?>">
                                    </fieldset>
                                  </div>
                                  ...
                                  <div class="col-lg-4">
                                    <fieldset class="form-group">
                                      ...
                                      <select name="redesocial" class="form-control">
                                            ...
                                            <option value="Facebook" <?php if (strcasecmp($vetor['redesocial'], 'Facebook') == 0) : ?>selected="selected"<?php endif; ?>>Facebook</option>
                                            <option value="Instagram" <?php if (strcasecmp($vetor['redesocial'], 'Instagram') == 0) : ?>selected="selected"<?php endif; ?>>Instagram</option>
                                            <option value="Twitter" <?php if (strcasecmp($vetor['redesocial'], 'Twitter') == 0) : ?>selected="selected"<?php endif; ?>>Twitter</option>
                                  ...
                                  <div class="col-lg-4">
                                    <fieldset class="form-group">
                                      ...
                                      <input type="text" name="link" class="form-control" value="<?php echo $vetor['link']; ?>" >
                                    </fieldset>
                                  </div>
                                  ...
                                  <div class="col-lg-6">
                                    <fieldset class="form-group">
                                      <label class="form-label semibold" for="exampleInput">Membro da Comissão</label>
                                  ...
                                  <div class="col-lg-6">
                                    <fieldset class="form-group">
                                      ...
                                      <input type="text" name="cargo" class="form-control" value="<?php echo $vetor['cargo']; ?>">
                                    </fieldset>
                                  </div>
