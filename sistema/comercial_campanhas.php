                          ...
                          <div class="d-flex align-items-center">
                              <nav aria-label="breadcrumb">
                                  <ol class="breadcrumb">
                                      ...
                                      <li class="breadcrumb-item">Campanhas</a></li>
              ...
              <div class="container-fluid">
                  ...
                  <div class="row">
                      <div class="col-12">
                          <div class="card">
                              <div class="card-body">
<!--                                  <h4 class="card-title">Campanhas</h4>-->
																
																<?php if ($vetor_permissao['cadastro'] == 1) {
																}else { ?><a href="cadastrocampanha.php">
                                  ...
                                  <div class="table-responsive">
                                      <table id="lang_opt" class="table table-striped table-bordered display"
                                          ...
                                          <tbody>
																					<?php
																					$sql_atual = mysqli_query($con, "select * from campanhas order by id_campanha DESC");
																					while ($vetor = mysqli_fetch_array($sql_atual)) {
																						?>
                                              <tr>
                                                  <td><?php echo $vetor['id_campanha']; ?></td>
                                                  <td><?php echo $vetor['titulo']; ?></td>
                                                  <td><?php echo $vetor['tipo']; ?></td>
                                                  <td><?php echo $vetor['status']; ?></td>
                                                  <td><?php echo $num1 = number_format($vetor['investimento'], 2, ',', '.'); ?></td>
                                                  <td><?php if ($vetor['ativa'] == 1) {
																											echo "Sim";
																										}else {
																											echo "Não";
																										} ?></td>
                                                  <td><?php echo date('d/m/Y', strtotime($vetor['datainicio'])); ?></td>
                                                  <td><?php echo date('d/m/Y', strtotime($vetor['datafim'])); ?></td>
                                                  <td><a class="fancybox fancybox.ajax"
                                                         href="alterarcampanha.php?id=<?php echo $vetor['id_campanha']; ?>"
                                                         target="_blank">
                                                          <button type="button" class="btn btn-success mesmo-tamanho"
                                                                 ...
                                                                 href="confexcluircampanha.php?id=<?php echo $vetor['id_campanha']; ?>">
