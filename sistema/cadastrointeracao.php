            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title">Cadastro de Interação para o
                                    Formando: <?php echo $vetor['nome']; ?></h4>

                                <form action="recebe_interacao.php?id=<?php echo $id; ?>" enctype="multipart/form-data"
                                      method="post">

                                    <input type="hidden" name="turma" value="<?php echo $vetor['turma']; ?>">
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <textarea name="ocorrenciatexto" class="form-control"
                                                          rows="5"></textarea>
                                            </div>
                                        </div>
