<?php
    ...
    $id = $_GET['id'];
    $sql = mysqli_query($con, "select * from instituicoes where id_instituicao = '$id'");
                        ...
                        <div class="d-flex align-items-center">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active" aria-current="page">Instituição</li>
                                </ol>
                            </nav>
                        </div>
                    </div>
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <form action="recebe_alterarinstituicao.php?id=<?php echo $id; ?>" method="post" name="cliente" enctype="multipart/form-data" onSubmit="return verificarCPF()" id="formID">
                                ...
                                <div class="row">
                                  ...
                                  <div class="col-lg-6">
                                    <fieldset class="form-group">
                                      ...
                                      <input type="text" name="sigla" value="<?php echo $vetor['sigla']; ?>" class="form-control" id="exampleInput" placeholder="Digite a Sigla">
                                    </fieldset>
                                  </div>
                                ...
                                <div class="row">
                                  <div class="col-lg-6">
                                    <fieldset class="form-group">
                                      ...
                                      <input type="text" name="cep" id="cep" value="<?php echo $vetor['cep']; ?>" class="form-control" placeholder="CEP" required>
                                    </fieldset>
                                  </div>
                                  <div class="col-lg-6">
                                    <fieldset class="form-group">
                                      <label class="form-label" for="exampleInputPassword1">Endereço</label>
                                      <input type="text" name="endereco" value="<?php echo $vetor['endereco']; ?>" id="rua" class="form-control" placeholder="Endereço" required>
                                    </fieldset>
                                  </div>
                                </div><!--.row-->
                                ...
                                <div class="row">
                                  <div class="col-lg-6">
                                    <fieldset class="form-group">
                                      ...
                                      <input type="text" name="complemento" value="<?php echo $vetor['complemento']; ?>" class="form-control" placeholder="Complemento">
                                    </fieldset>
                                  </div>
                                  <div class="col-lg-6">
                                    <fieldset class="form-group">
                                      <label class="form-label" for="exampleInputPassword1">Bairro</label>
                                      <input type="text" name="bairro" id="bairro" value="<?php echo $vetor['bairro']; ?>" class="form-control" placeholder="Bairro" required>
                                    </fieldset>
                                  </div>
                                </div><!--.row-->
                                ...
                                <div class="row">
                                  <div class="col-lg-4">
                                    <fieldset class="form-group">
                                      ...
                                      <input type="text" name="cidade" value="<?php echo $vetor['cidade']; ?>" id="cidade" class="form-control" placeholder="Cidade" required>
                                    </fieldset>
                                  </div>
                                  <div class="col-lg-4">
                                    <fieldset class="form-group">
                                  ...
                                  <div class="col-lg-4">
                                    <fieldset class="form-group">
                                      ...
                                      <input type="text" name="telefone" value="<?php echo $vetor['telefone']; ?>" class="form-control" id="telefone3" placeholder="Telefone">
                                    </fieldset>
                                  </div>
                                ...
                                <div class="row">
                                  ...
                                  <div class="col-lg-6">
                                    <fieldset class="form-group">
                                      ...
                                      <input type="text" name="site" value="<?php echo $vetor['site']; ?>" class="form-control" id="exampleInput" placeholder="Digite o Site">
                                    </fieldset>
                                  </div>
                                ...
                                <div class="row">
                                  ...
                                  <div class="col-lg-6">
                                    <fieldset class="form-group">
                                      <label class="form-label semibold" for="exampleInput">Administração</label>
                                  ...
                                  <div class="col-lg-6">
                                    <fieldset class="form-group">
                                      <label class="form-label" for="exampleInputEmail1">Distância (Km)</label>
                                      <input type="text" name="distancia" value="<?php echo $vetor['distancia']; ?>" class="form-control" placeholder="Distancia" required>
                                    </fieldset>
                                  </div>
