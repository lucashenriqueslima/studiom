                          ...
                          <div class="d-flex align-items-center">
                              <nav aria-label="breadcrumb">
                                  <ol class="breadcrumb">
                                      ...
                                      <li class="breadcrumb-item active" aria-current="page">Convites Contratos</li>
                                  </ol>
                              </nav>
                          </div>
                      </div>
              ...
              <div class="container-fluid">
                  ...
                  <div class="row">
                      <div class="col-12">
                          <div class="card">
                              <div class="card-body">
                                  <!--                                  <h4 class="card-title">Convites Contrato</h4>-->
																
																<?php if ($vetor_permissao['cadastro'] == 1) {
																}else { ?><a href="cadastrar_contratodeconvite.php">
                                  ...
                                  <div class="table-responsive">
                                      <table id="lang_opt" class="table table-striped table-bordered display"
                                          ...
                                          <thead align="center">
                                          <tr>
                                              <th style="vertical-align: middle"><strong><h5>Contrato</h5></strong></th>
                                          ...
                                          <tbody>
																					<?php
																					$sql_atual = mysqli_query($con, "select * from meu_convite_turma order by id_meuconvite DESC");
                                              ...
                                              <tr>
                                                  ...
                                                  <td align="center"><a class="fancybox fancybox.ajax"
                                                         href="alterarconviteturma.php?id=<?php echo $vetor['id_meuconvite']; ?>"
                                                         target="_blank">
                                                          <button type="button" class="btn btn-success mesmo-tamanho"
                                                                 ...
                                                                 href="confexcluirconviteturma.php?id=<?php echo $vetor['id_meuconvite']; ?>">
