                        ...
                        <div class="d-flex align-items-center">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active" aria-current="page">Cadastrar Produto de Convite</li>
                                </ol>
                            </nav>
                        </div>
                    </div>
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <form action="recebe_conviteformando.php" method="post" name="cliente"
                                            ...
                                            <div class="col-lg-3">
                                                <fieldset class="form-group">
                                                    ...
                                                    <input type="number" name="npagina[]" class="form-control"
                                                           value="<?php echo $vetor['npagina']; ?>" required>
                                                </fieldset>
                                            </div>
