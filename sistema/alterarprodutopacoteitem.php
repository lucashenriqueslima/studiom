...
if ($_SESSION['id'] == null) {
	...
	$id = $_GET['id']; // id_pacote pacotes turma
	$id1 = $_GET['id1']; // id_produto produtos turma
	$id_tipo = $_GET['tipo']; // id_tipo tipos produtos
	$tipo = mysqli_fetch_array(mysqli_query($con, "select * from tipos_produtos where id_tipo = '$id_tipo'"));
	?>
    <!DOCTYPE html>
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                <h3 class="card-title">Produto: <?php echo $tipo['nome']; ?></h3>
                                <div id="origem" hidden>
                                    <div class="row">
                                        <input type="text" name="id_item[]" value="" hidden>
                                        <div class="col-lg-4">
                                            <fieldset class="form-group">
                                                <label class="form-label semibold" for="exampleInput">Quantidade
                                                    Mínima</label>
                                                <input type="number" name="qtdminima[]"
                                                       value=""
                                                       class="form-control">
                                            </fieldset>
                                        </div>
                                ...
                                <form action="recebe_alterarprodutopacoteitem.php?id=<?php echo $id; ?>&id1=<?php echo $id1; ?>"
                                    ...
                                    <input type="text" name="id_tipo" class="form-control"
                                           value="<?php echo $tipo['id_tipo']; ?>" hidden>
																	<?php
																	$sql = mysqli_query($con, "select * from pacotes_itens where status = '1' and id_pacote = '$id' and id_tipo = '$id_tipo' order by qtdminima ASC");
																	while ($vetor = mysqli_fetch_array($sql)) { ?>
                                      <div class="row">
                                          <input type="text" name="id_item[]" value="<?php echo $vetor['id_item']; ?>" hidden>
                                          <div class="col-lg-4">
                                              <fieldset class="form-group">
                                                  <label class="form-label semibold" for="exampleInput">Quantidade
                                                      Mínima</label>
                                                  <input type="number" name="qtdminima[]"
                                                         value="<?php echo $vetor['qtdminima']; ?>"
                                                         class="form-control">
                                              </fieldset>
                                          </div>
                                          ...
                                          <div class="col-lg-4">
                                              <fieldset class="form-group">
                                                  <label class="form-label semibold" for="exampleInput">Valor
                                                      Un.</label>
                                                  <input type="text" name="valorun[]"
                                                         value="<?php echo $num = number_format($vetor['valorun'], 2, ',', '.'); ?>"
                                                         class="form-control" id="exampleInput"
                                                         placeholder="Valor Pagamento"
                                                         onKeyPress="mascara(this,mvalor)">
                                              </fieldset>
                                          ...
                                          <div class="col-lg-4">
                                              <fieldset class="form-group">
                                                  <a class="fancybox fancybox.ajax"
                                                     href="recebe_alterarprodutopacoteitem.php?id_item=<?php echo $vetor['id_item']; ?>&id=<?php echo $id; ?>&tipo=<?php echo $id_tipo ?>&id1=<?php echo $id1; ?>">
