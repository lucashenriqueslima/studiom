<?php
    ...
    $sql = mysqli_query($con, "select * from qr_convite where turmafk = '$id'");
    $vetor = mysqli_fetch_array($sql);
        
    
    $sql_contrato = mysqli_query($con,  "SELECT * FROM turmas as t INNER JOIN qr_convite as q on t.id_turma =  '$id'");
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title">Exclusão de convite qrcode</h4>
                                ...
                                <tr style="    background: #FF6600; color: #fff;">
                                  ...
                                  <th width="15%">Ação</th> 
                                         ...
                                         <tr>
                                              <td>Cotrato nº <?php echo $vetor_contrato['ncontrato']; ?></td>
                                              <td><a href="excluirqrconvite.php?id=<?php echo $id; ?>"><button type="button" class="btn btn-inline btn-danger">Sim</button></a> <a href="solenidades_qrcode.php"><button type="button" class="btn btn-inline btn-success">Não</button></a></td>
                                          </tr>
