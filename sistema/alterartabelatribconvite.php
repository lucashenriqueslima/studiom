<?php
    ...
    $sql = mysqli_query($con, "select * from tabela_tributos where id_tributo = '$id'");
                        ...
                        <div class="d-flex align-items-center">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active" aria-current="page">Tabela</li>
                                </ol>
                            </nav>
                        </div>
                    </div>
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title">Cadastro de Tabela</h4>

                                <form action="recebe_alterartabelatribconvite.php?id=<?php echo $id; ?>" method="post" name="cliente" enctype="multipart/form-data" onSubmit="return verificarCPF()" id="formID">
                                ...
                                <div class="row">
                                  ...
                                  <div class="col-lg-4">
                                    <fieldset class="form-group">
                                      ...
                                      <input type="text" name="titulo" value="<?php echo $vetor['titulo']; ?>" class="form-control" required="">
                                    </fieldset>
                                  </div>
                                  ...
                                  <div class="col-lg-4">
                                    <fieldset class="form-group">
                                      ...
                                      <select name="tipo" class="form-control" required="">
                                        ...
                                        <option value="1" <?php if (strcasecmp($vetor['tipo'], '1') == 0) : ?>selected="selected"<?php endif; ?>>Percentual</option>
                                        <option value="2" <?php if (strcasecmp($vetor['tipo'], '2') == 0) : ?>selected="selected"<?php endif; ?>>Valor</option>
                                      </select>
                                    </fieldset>
                                  </div>
                                  ...
                                  <div class="col-lg-4">
                                    <fieldset class="form-group">
                                      ...
                                      <input type="text" name="valor" value="<?php echo $num = number_format($vetor['valor'],2,',','.'); ?>" class="form-control" onKeyPress="mascara(this,mvalor)" required="">
                                    </fieldset>
                                  </div>
