<?php
    ...
    $sql = mysqli_query($con, "select * from tabela_basico_itens where id_item = '$id'");
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <form action="recebe_alteraritemdadosbasico.php?id=<?php echo $id; ?>&id1=<?php echo $id1; ?>&id_tipo=<?php echo $id_tipo; ?>" method="post" name="cliente" enctype="multipart/form-data" onSubmit="return verificarCPF()" id="formID">

                                <div class="row">

                                  <div class="col-lg-3">
                                    <fieldset class="form-group">
                                      <label class="form-label semibold" for="exampleInput">Item</label>
                                      <select name="id_item" id="categorias" class="form-control">
                                            <option value="" selected="">Selecione...</option>
                                            <?php 

                                            $sql_embalagem = mysqli_query($con, "select * from tabela_tipos where tipo = '$id_tipo' order by titulo ASC");

                                            while ($vetor_embalagem=mysqli_fetch_array($sql_embalagem)) { 

                                            ?>
                                            <option value="<?php echo $vetor_embalagem['id_tipo']; ?>" <?php if (strcasecmp($vetor['id_itemtabela'], $vetor_embalagem['id_tipo']) == 0) : ?>selected="selected"<?php endif; ?>><?php echo $vetor_embalagem['titulo'] ?></option>
                                            <?php } ?>
                                          </select>
                                    </fieldset>
                                  </div>
                                  ...
                                  <div class="col-lg-3">
                                    <fieldset class="form-group">
                                      <label class="form-label semibold" for="exampleInput">Qtd Inicial</label>
                                      <input type="number" name="qtd" value="<?php echo $vetor['qtd']; ?>" class="form-control" required="">
                                    </fieldset>
                                  </div>

                                  <div class="col-lg-3">
                                    <fieldset class="form-group">
                                      <label class="form-label semibold" for="exampleInput">Qtd Fim</label>
                                      <input type="number" name="qtdfinal" value="<?php echo $vetor['qtdfim']; ?>" class="form-control" required="">
                                    </fieldset>
                                  </div>
                                  ...
                                  <div class="col-lg-3">
                                    <fieldset class="form-group">
                                      ...
                                      <input type="text" name="valor" class="form-control" value="<?php echo $num = number_format($vetor['valor'],2,',','.'); ?>" onKeyPress="mascara(this,mvalor)" required="">
                                    </fieldset>
                                  </div>
