...
if (isset($_GET['id'])) {
    $id = $_GET['id'];
    $res2 = mysqli_query($con, "delete FROM pacotes where id_pacote = '$id'");
    $res2 = mysqli_query($con, "delete FROM pacotes_itens_album where id_pacote = '$id'");
    $res2 = mysqli_query($con, "delete FROM formaspag_pacote where id_pacote = '$id'");
    echo 'OK';
    die();
}
$id_pagina = 51;
                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    } else { ?><a href="cadastropacote.php">
                                    ...
                                    <div class="table-responsive">
                                        <table id="lang_opt" class="table table-striped table-bordered display"
                                            ...
                                            <tbody>
                                            <?php
                                            $sql_atual = mysqli_query($con, "select * from pacotes order by id_pacote DESC");
                                            ...
                                            <tr>
                                                ...
                                                <td><?php if ($vetor['tipo'] == '1') {
                                                        echo "Convite";
                                                    } else {
                                                        echo "Fotografia";
                                                    } ?></td>
                                                <td><?php echo date('d/m/Y', strtotime($vetor['dataabertura'])); ?></td>
                                                <td><?php echo date('d/m/Y', strtotime($vetor['termino'])); ?></td>
                                                <td><a class="fancybox fancybox.ajax"
                                                       href="alterarpacote.php?id=<?php echo $vetor['id_pacote']; ?>"
                                                       target="_blank">
                                                    ...
                                                    <button type="button" class="btn btn-danger"
                                                            ...
                                                            title="Excluir Lead"
                                                            onclick="arrumaModalP(<?php echo $vetor['id_pacote']; ?>)">
                                                        <i
