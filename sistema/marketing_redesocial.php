                              ...
                              <div class="card-body">
                                  <div class="table-responsive">
                                      <table id="lang_opt" class="table table-striped table-bordered display"
                                          ...
                                          <thead align="center">
                                          <tr>
                                              <th><strong><h5>Cód. Aluno</h5></strong></th>
                                              ...
                                              <th><strong><h5>Facebook</h5></strong></th>
                                              <th><strong><h5>Instagram</h5></strong></th>
                                              <th><strong><h5>Tipo Formando</h5></strong></th>
                                              <th><strong><h5>Ação</h5></strong></th>
                                          </tr>
                                          </thead>
                                          <tbody>
																					<?php
																					$sql_atual = mysqli_query($con, "select * from formandos f ");
                                              ...
                                              <tr>
                                                  ...
                                                  <td align="center"><?php echo $vetor['facebook']; ?></td>
                                                  <td><?php echo ($vetor['instagram'] != ''?(substr($vetor['instagram'], 0, 1) == '@' ? $vetor['instagram'] : '@'.$vetor['instagram']):''); ?></td>
