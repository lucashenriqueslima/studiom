...
if ($_SESSION['id'] == null) {
	...
	$sql = mysqli_query($con, "select id_feriado, titulo, data from feriados");
	?>
    <!DOCTYPE html>
    ...
    <script>
        !function ($) {
            ...
            CalendarApp.prototype.init = function () {
                ...
                var Events = [
									<?php while($feriado = mysqli_fetch_array($sql)){ ?>
                    {
                        id: '<?php echo $feriado['id_feriado']; ?>',
                        title: '<?php echo $feriado['titulo']; ?>',
                        start: '<?php echo date('Y').substr($feriado['data'],4,9).' 00:00:00'; ?>',
                        backgroundColor: '#ebb9b9',
                        end: '<?php echo date('Y').substr($feriado['data'],4,9).' 23:59:59'; ?>',
                    },
									<?php } ?>
                ];
                var $this = this;
