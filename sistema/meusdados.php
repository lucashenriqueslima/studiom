      ...
      <div class="row">
        <div class="col-xs-12">
          <div class="box">
            ...
            <form action="recebe_alterarmeusdados.php?id=<?php echo $id; ?>" method="post" name="cliente" enctype="multipart/form-data" onSubmit="return verificarCPF()" id="formID">
				<div class="row">
					<div class="col-lg-4">
          ...
          <div class="col-lg-4">
            <fieldset class="form-group">
              ...
              <input type="text" name="usuario" value="<?php echo $vetor['usuario']; ?>" class="form-control" id="exampleInput" placeholder="Digite o usuário" disabled>
            </fieldset>
          </div>
          ...
          <div class="col-lg-4">
            <fieldset class="form-group">
              ...
              <input type="password" name="senha" value="<?php echo $vetor['senha']; ?>" class="form-control" id="exampleInput" placeholder="Digite a Senha" required>
            </fieldset>
          </div>
        ...
        <div class="col-lg-12">
            <fieldset class="form-group">
              ...
              <br>
              <img src="arquivos/<?php echo $vetor['imagem']; ?>" width="180px"> Alterar imagem?
