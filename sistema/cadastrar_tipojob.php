                        ...
                        <div class="d-flex align-items-center">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active" aria-current="page">Cadastrar Novo Tipo de Job</li>
                                </ol>
                            </nav>
                        </div>
                    </div>
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                <div id="origem" hidden>
                                    <div class="row">
                                        ...
                                        <div class="col-lg-2">
                                            <fieldset class="form-group">
                                                <label class="form-label semibold"
                                                       for="exampleInput">Tempo Estimado de Serviço (horas)</label>
                                                <input type="number" class="form-control"
                                ...
                                <form action="recebe_tipojob.php" method="post" name="cliente"
