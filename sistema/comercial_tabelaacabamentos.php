                          ...
                          <div class="d-flex align-items-center">
                              <nav aria-label="breadcrumb">
                                  <ol class="breadcrumb">
                                      ...
                                      <li class="breadcrumb-item active" aria-current="page">Tabela de Acabamentos</li>
                                  </ol>
                              </nav>
                          </div>
                      </div>
...
<!--                                  <h4 class="card-title">Tabela</h4>-->
																...
																}else { ?><a href="cadastroitemdadosbasicoacabamento.php">
                                  ...
                                  <div class="table-responsive">
                                      <table id="lang_opt" class="table table-striped table-bordered display"
                                          ...
                                          <tr>
                                              ...
                                              <th>Qtd Fim</th>
                                              <th>Valor</th>
                                              <th>Acabamento Externo da Embalagem</th>
                                              <th>Acabamento da Capa</th>
                                              <th width="10%">Ação</th>
                                          </tr>
                                          </thead>
                                          <tbody>
																					<?php
																					$sql_itens = mysqli_query($con, "select * from tabela_basico_acabamentos order by id_item DESC");
                                              ...
                                              <tr>
                                                  ...
                                                  <td><?php if ($vetor_itens['acabamentoembalagem'] == 1) {
																											echo "Não";
																										}
																										if ($vetor_itens['acabamentoembalagem'] == 2) {
																											echo "Sim";
																										} ?></td>
                                                  <td><?php if ($vetor_itens['acabamentodacapa'] == 1) {
																											echo "Não";
																										}
																										if ($vetor_itens['acabamentodacapa'] == 2) {
																											echo "Sim";
																										} ?></td>
                                                  <td><a class="fancybox fancybox.ajax"
                                                         href="alterardadosbasico.php?id=<?php echo $vetor['id_basico']; ?>"
                                                         target="_blank">
                                                          <button type="button" class="btn btn-success mesmo-tamanho"
                                                                 ...
                                                                 href="confexcluirdadosbasico.php?id=<?php echo $vetor['id_basico']; ?>">
