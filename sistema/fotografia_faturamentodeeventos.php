              ...
              <div class="container-fluid">
                  ...
                  <div class="row">
                      <div class="col-12">
                          <div class="card">
                              <div class="card-body">
<!--                                  <h4 class="card-title">Faturamento de Eventos</h4>-->
                                          ...
                                          <tbody>
                                              ...
                                              <tr>
                                                  ...
                                                  <td><a class="fancybox fancybox.ajax"
                                                         href="alterarfaturamentoevento.php?id=<?php echo $vetor['id_escala']; ?>"
                                                         target="_blank">
                                                          <button type="button" class="btn btn-success mesmo-tamanho"
                                                                  title="Ver ou Alterar Cadastro"><i
                                                                      class="mdi mdi-tooltip-edit"></i></button>
                                                      </a>
                                                      <a href="imprimirfaturamentoevento.php?id=<?php echo $vetor['id_escala']; ?>"
                                                         target="_blank">
