<?php
  ...
  $sql_item = mysqli_query($con, "select * from tipo_opcionais where id_tipo = '$vetor[id_tipo]'");
        ...
        <div class="col-xs-12">
          <div class="box">
            <div class="box-header">
              <h3 class="box-title">Exclusão de Produto</h3>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
    ...
    color: #fff;">
                  ...
                  <th width="15%">Ação</th> 
                         ...
                         <tr>
                              ...
                              <td><a href="excluirprodutoopvenda.php?id=<?php echo $id; ?>&id1=<?php echo $id1; ?>"><button type="button" class="btn btn-inline btn-danger">Sim</button></a> <a href="alterarprodutoop.php?id=<?php echo $id1; ?>"><button type="button" class="btn btn-inline btn-success">Não</button></a></td>  
                          </tr>
