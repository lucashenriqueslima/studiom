    ...
    <td><?php
            ...
            <table width="100%" BORDER="1" style="border-collapse: collapse">
                ...
                <tr>
                  ...
                  $sql_soma_qtd2 = mysqli_query($con, "SELECT SUM(a.valorvenda) as total FROM vendas a, formandos c where a.id_formando = c.id_formando and c.turma = '$id_turma' and a.formapag = '2'");
                  $vetor_soma_qtd2 = mysqli_fetch_array($sql_soma_qtd2); 

                  while($vetor_itens2 = mysqli_fetch_array($sql_itens2)) {

                  $sql_soma_qtd1 = mysqli_query($con, "SELECT SUM(b.qtd) as total FROM vendas a, itens_venda_individual b where a.id_venda = b.id_venda and b.id_item = '$vetor_itens2[id_item]' and a.formapag = '2'");
                  $vetor_soma_qtd1 = mysqli_fetch_array($sql_soma_qtd1); 

                  ?>
                  <th width="6%"><?php echo $vetor_soma_qtd1['total']; ?></th>
                  <?php } ?>
                  <th width="6%">R$ <?php echo $num = number_format($vetor_soma_qtd2['total'],2,',','.'); ?></th>
                </tr>
                <tr>
                  <th width="1" bgcolor="#e8e8e8">Item</th>
                  <th bgcolor="#e8e8e8">Formando</th>
                  <?php 
                  ...
                  ?>
                  <th bgcolor="#e8e8e8"><?php echo $vetor_nome_produto['nome']; ?></th>
                  <?php } ?>
                  <th bgcolor="#e8e8e8">Valor</th>
                </tr>
                </thead>
                <tbody>
                <?php 
                  ...
                  $sql_venda = mysqli_query($con, "select * from vendas where id_formando = '$vetor_atual[id_formando]' and formapag = '2' order by id_venda DESC limit 0,1");
                  ...
                  $sql_vencimentos = mysqli_query($con, "select a.id_duplicata, a.id_venda, b.id_duplicata, b.data, b.posicao from duplicatas a, duplicatas_faturas b where a.id_duplicata = b.id_duplicata and a.id_venda = '$vetor_venda[id_venda]' and a.formapag = '2' order by b.posicao ASC limit 0,1");
                  $vetor_vencimento = mysqli_fetch_array($sql_vencimentos);

                  if($vetor_venda['formapag'] == 2) { 
                ...
                <tr>
                  ...
                  $sql_soma_qtd = mysqli_query($con, "SELECT SUM(b.qtd) as total FROM vendas a, itens_venda_individual b where a.id_venda = b.id_venda and a.id_formando = '$vetor_atual[id_formando]' and b.id_item = '$vetor_itens1[id_item]' and a.formapag = '2'");
                  ...
                  $sql_soma_valor = mysqli_query($con, "SELECT SUM(valorvenda) as total FROM vendas where id_formando = '$vetor_atual[id_formando]' and formapag = '2'");
                  $vetor_soma_valor = mysqli_fetch_array($sql_soma_valor);

                  ?>
                  <td>R$ <?php echo $num = number_format($vetor_soma_valor['total'],2,',','.'); ?></td>
                </tr>
                <?php $i++; } } ?>
                </tbody>
              </table>
