                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <form action="recebe_alterartipoarquivoturma.php?id=<?php echo $id; ?>&id1=<?php echo $id1; ?>" method="post" name="cliente" enctype="multipart/form-data" onSubmit="return verificarCPF()" id="formID">

                                <div class="row">

                                  <div class="col-lg-6">
                                    <fieldset class="form-group">
                                      <label class="form-label semibold" for="exampleInput">Tipo Arquivo</label>
                                      <select name="id_tipo" class="form-control">
                                            <option value="" selected="selected">Selecione...</option>
                                            <?php 

                                            $sql_tipo = mysqli_query($con, "select * from tipos_arquivos order by nome ASC");
                                  ...
                                  <div class="col-lg-6">
                                    <fieldset class="form-group">
                                      <label class="form-label semibold" for="exampleInput">Qtd de Caracteres</label>
                                      <input type="number" name="qtd" value="<?php echo $vetor['qtd']; ?>" class="form-control">
                                    </fieldset>
                                  </div>
