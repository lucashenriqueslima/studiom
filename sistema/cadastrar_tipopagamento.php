                        ...
                        <div class="card">
                            <div class="card-body">
                                <form action="recebe_tipopagamento.php" method="post"
                                        ...
                                        <div class="col-lg-3 col-md-6 col-sm-12">
                                            <fieldset class="form-group">
                                                ...
                                                <select id="tipo" name="tipo" class="form-control" required>
                                                    <option value="" selected>Selecione uma base de Cálculo</option>
                                                ...
                                                <select name="conta" class="form-control" required>
                                                    <option value="" selected>Selecione uma Conta</option>
																									...
																									while ($vetor = mysqli_fetch_array($sql)) {
																										echo "<option value='".$vetor['id_conta']."'>".$vetor['nome']."</option>";
																									}
																									?>
                                                </select>
                                            </fieldset>
                                            ...
                                            <fieldset class="form-group">
                                                ...
                                                <select name="formapag" class="form-control" required>
                                                    <option value="" selected>Selecione uma Forma</option>
																									<?php
																									$sql = mysqli_query($con, "select * from formaspag where financeiro = 1");
																									while ($vetor = mysqli_fetch_array($sql)) {
																										echo "<option value='".$vetor['id_forma']."'>".$vetor['nome']."</option>";
																									}
																									?>
                                                </select>
                                            </fieldset>
                                    ...
                                    <div id="libera-receita" hidden>
                                        <div class="row">
                                            <div class="col-lg-3 col-md-6 col-sm-12">
                                                <fieldset class="form-group">
                                                    <label class="form-label semibold" for="exampleInput">Compensação
                                                        (dias)</label>
                                                    <input type="number" name="compensacao" class="form-control">
                                                </fieldset>
                                            </div>
                                        </div>
                                        <div class="row">
                                        ...
                                        <div class="row" id="liberaTaxa" hidden>
                                            <div class="col-lg-3 col-md-6 col-sm-12">
                                                <fieldset class="form-group">
