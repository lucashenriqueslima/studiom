                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <form action="recebe_faq.php" method="post" name="cliente" enctype="multipart/form-data" onSubmit="return verificarCPF()" id="formID">
            ...
            <div class="row">
              ...
              <div class="col-lg-6">
                <fieldset class="form-group">
                  ...
                  <input type="text" name="assunto" class="form-control" id="exampleInput" placeholder="Digite o Assunto" required>
                </fieldset>
              </div>
            </div><!--.row-->
            ...
            <div class="row">
                        <div class="col-lg-12">
                            <fieldset class="form-group">
                                ...
                                <input type="text" name="pergunta" class="form-control" id="exampleInput" placeholder="Digite a Pergunta" required>
                            </fieldset>
                        </div>
                    </div><!--.row-->
