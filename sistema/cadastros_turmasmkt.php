...
<!--                                  <h4 class="card-title">Turmas</h4>-->
                                    ...
                                    <table width="100%">
                                        <tr>
                                            <td width="13%"><a href="cadastrar_turmamkt.php">
                                                    <button class="btn btn-primary" style="    float: left;">Cadastrar
                                                        Nova Turma
                                                    </button>
                                                </a></td>
                                            <td><a href="cadastrar_turmamktaut.php">
                                                    <button class="btn btn-primary" style="    float: left;">Cadastrar
                                                        Novas Turmas Automaticamente
                                                    </button>
                                                </a></td>
                                        </tr>
                                    </table>
                                  ...
                                  <div class="table-responsive">
                                      <table id="lang_opt" class="table table-striped table-bordered display"
                                          ...
                                          <tbody>
																					<?php
																					$sql_atual = mysqli_query($con, "select * from turmas_mkt order by id_turma ASC");
                                              ...
                                              <tr>
                                                  ...
                                                  <td><?php if ($vetor['contratofechado'] == 1) { ?>
                                                          <button type="button" class="btn btn-success mesmo-tamanho"
                                                                  title="Contrato Fechado"><i
                                                                      class="fa fa-thumbs-up"></i></button><?php }
																										if ($vetor['contratofechado'] == 2) { ?>
                                                        ...
                                                        <button type="button" class="btn btn-info mesmo-tamanho"
                                                                title="Em Negociação"><i class="fa fa-handshake-o"></i>
                                                        </button><?php } ?></td>
                                                  <td><a class="fancybox fancybox.ajax"
                                                         href="alterarturmamkt.php?id=<?php echo $vetor['id_turma']; ?>"
                                                         target="_blank">
                                                          <button type="button" class="btn btn-success mesmo-tamanho"
                                                                 ...
                                                                 href="confexcluirturmamkt.php?id=<?php echo $vetor['id_turma']; ?>">
                                                              <button type="button" class="btn btn-danger mesmo-tamanho"
