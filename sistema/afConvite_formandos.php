              ...
              <div class="container-fluid">
                  ...
                  <div class="row">
                      <div class="col-12">
                          <div class="card">
                              <div class="card-body">
<!--                                  <h4 class="card-title">Convites Formando</h4>-->
																
																<?php if ($vetor_permissao['cadastro'] == 1) {
																}else { ?><a href="cadastroconviteformando.php">
                                  ...
                                  <div class="table-responsive">
                                      <table id="lang_opt" class="table table-striped table-bordered display"
                                          ...
                                          <tr>
                                              <th style="vertical-align: middle"><strong><h5>Cód. Cliente</h5></strong></th>
                                              <th style="vertical-align: middle"><strong><h5>Formando</h5></strong></th>
                                              <th style="vertical-align: middle"><strong><h5>Produto</h5></strong></th>
                                              <th style="vertical-align: middle"><strong><h5>Data (inclusão)</h5></strong></th>
                                              <th style="vertical-align: middle"><strong><h5>Data (finalização)</h5></strong></th>
                                              <th style="vertical-align: middle"><strong><h5>Data Final (aprovação)</h5></strong></th>
                                              <th style="vertical-align: middle"><strong><h5>Status</h5></strong></th>
                                              <th width="10%" style="vertical-align: middle"><strong><h5>Ação</h5></strong></th>
                                          </tr>
                                          </thead>
                                          <tbody>
																					<?php
																					$id = $_GET['id'];
																					$sql_atual = mysqli_query($con, "select * from meu_convite order by id_meuconvite DESC");
																					while ($vetor = mysqli_fetch_array($sql_atual)) {
																						...
																						$sql_produtos = mysqli_query($con, "select * from tipos_produtos where id_tipo = '$vetor[id_item]'");
																						$vetor_produtos = mysqli_fetch_array($sql_produtos);
																						?>
                                              <tr>
                                                  <td align="center"><?php echo $vetor_contrato['ncontrato']; ?>
                                                      - <?php echo $vetor_formando['id_cadastro']; ?></td>
                                                  <td><?php echo $vetor_formando['nome']; ?></td>
                                                  <td align="center"><?php echo $vetor_produtos['nome']; ?></td>
                                                  ...
                                                  <td align="center"><?php echo date('d/m/Y', strtotime($vetor['datafinal'])); ?></td>
                                                  ...
                                                  <td align="center"><a class="fancybox fancybox.ajax"
                                                         href="alterarconviteformando.php?id=<?php echo $vetor['id_meuconvite']; ?>"
                                                         target="_blank">
                                                          <button type="button" class="btn btn-success mesmo-tamanho"
                                                                 ...
                                                                 href="confexcluirconviteformando.php?id=<?php echo $vetor['id_meuconvite']; ?>">
