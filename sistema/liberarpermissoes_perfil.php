...
<body>
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title">Permissões de Perfil - <?php echo $vetor['nome']; ?></h4>

                                <form action="recebe_permissao_perfil.php?id=<?php echo $id; ?>" method="post">
    ...
    color: #000;">
            ...
            <table class="table table-bordered table-striped">
                ...
                $sql_permissao = mysqli_query($con, "select * from perfil_paginas where id_perfil = '$id' and id_pagina = '$vetor_paginas[id_pagina]'");
