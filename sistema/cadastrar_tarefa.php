...
if ($_SESSION['id'] == null) {
        ...
        <script type="text/javascript">
            ...
            $(document).ready(function () {
                $('#departamento').change(function () {
                    $('#responsavel').load('cadastrar_tarefa.php?id_departamento='+$('#departamento').val());
                });
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                <form action="recebe_calendario.php" method="post" name="cliente"
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-12">
                                            ...
                                            <fieldset class="form-group">
                                                <label class="form-label semibold"
                                                       for="exampleInput">Resposável</label>
                                                <select name="responsavel" id="responsavel"
                                                        class="form-control select2" style="width: 100%;height: 36px;">
                                                    <?php
                                                    $sql_usuarios = mysqli_query($con, "select * from usuarios order by nome ASC");
                                                    while ($vetor_usuario = mysqli_fetch_array($sql_usuarios)) { ?>
                                        ...
                                        <div class="col-lg-12">
                                            <fieldset class="form-group">
                                                ...
                                                <input type="text" name="titulo" class="form-control"
                                                       placeholder="Digite o Tiulo" maxlength="50">
                                            </fieldset>
                                        </div>
                                    </div><!--.row-->
    ...
    <script src="../layout/assets/libs/select2/dist/js/select2.full.min.js"></script>
    <script src="../layout/assets/libs/select2/dist/js/select2.min.js"></script>
    <script src="../layout/dist/js/pages/forms/select2/select2.init.js"></script>
