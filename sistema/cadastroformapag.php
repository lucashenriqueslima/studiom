                        ...
                        <div class="d-flex align-items-center">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item">Formas de Pagamento</a></li>
                                    <li class="breadcrumb-item active" aria-current="page">Cadastrar Forma de Pagamento</li>
                                </ol>
                            </nav>
                        </div>
                    </div>
...
<!--                                <h4 class="card-title">Cadastro de Forma de Pagamento</h4>-->
                                ...
                                <form action="recebe_formapag.php" method="post" name="cliente"
                                        ...
                                        <div class="col-lg-12">
                                            <fieldset class="form-group">
                                                ...
                                                <input type="text" name="nome" class="form-control" id="exampleInput"
                                                       placeholder="Digite a Forma" required>
                                            </fieldset>
                                        </div>
                                    </div><!--.row-->
