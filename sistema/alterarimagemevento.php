...
if ($_SESSION['id'] == NULL) {
    ...
    $eventos_pacote = mysqli_fetch_array(mysqli_query($con, "select * from eventos_pacote where id_pacote = '$id' and id_evento = '$id_evento'"));
    $eventos_turma_lista = mysqli_fetch_array(mysqli_query($con, "select * from eventos_turma_lista where id_evento_turma = '$eventos_pacote[id_evento]'"));
    ...
    <head>
        ...
        <script type="text/javascript">
            function removeImagem(id) {
                $.post('recebe_imagemproduto.php?id_imagem=' + id + '&id_pacote=<?php echo $id_pacote ?>&id_evento=<?php echo $id_evento ?>&id=<?php echo $id ?>', function () {
                        ...
                        <div class="d-flex align-items-center">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active" aria-current="page">Alterar Imagem Eventos</li>
                                </ol>
                            </nav>
                        </div>
                    </div>
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                <h3 class="card-title">Evento: <?php echo $categoria_eventos['nome']; ?></h3>
                                ...
                                <form action="recebe_imagemproduto.php?id=<?php echo $id; ?>&id_pacote=<?php echo $id_pacote; ?>&id_evento=<?php echo $id_evento; ?>&add=sim" method="post"
                                    ...
                                    <?php
                                    $lock = 0;
                                    $sql_imagem = mysqli_query($con, "select * from imagens_produtos where chave_imagem = '$eventos_pacote[chave_imagem]' and id_evento='$id_evento' order by posicao ASC");
