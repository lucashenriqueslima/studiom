<?php
    ...
    $id = $_GET['id'];
    $id1 = $_GET['id1'];
    $sql = mysqli_query($con, "select * from escala_faturamento where id_escala_faturamento = '$id'");
    $vetor = mysqli_fetch_array($sql);

    if($vetor['id_tabela'] == 1) {

    $calculokm = $vetor['qtdtotal'] / 10;
    $mediakm = floor($calculokm);

    $calculo = $mediakm * $vetor['valor'];
    $valorfinal = $calculo * $vetor['qtd'];

    } else {

    $calculo = $vetor['qtdtotal'] * $vetor['valor'];
    $valorfinal = $calculo * $vetor['qtd'];
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title">Alteração de Item Planejamento de Evento</h4>

                                <form action="recebe_alteraritemfaturamentoevento.php?id=<?php echo $id; ?>&id1=<?php echo $id1; ?>" method="post" name="cliente" enctype="multipart/form-data" onSubmit="return verificarCPF()" id="formID">

            <div class="row">
              <div class="col-md-12">
                <div class="form-group">
                  <label>Valor Pré-Orçado</label>
                  <input type="text" name="valor" class="form-control" value="<?php echo $num = number_format($valorfinal,2,',','.'); ?>" onKeyPress="mascara(this,mvalor)" disabled>
                </div>
              </div>
            </div>
            ...
            <div class="row">
              <div class="col-md-12">
                <div class="form-group">
                  ...
                  <input type="text" name="valorfinal" class="form-control" value="<?php echo $num = number_format($vetor_escala_profissionais['valorfinal'],2,',','.'); ?>" onKeyPress="mascara(this,mvalor)">
                </div>
              </div>
            </div>
