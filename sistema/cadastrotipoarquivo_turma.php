                        ...
                        <div class="d-flex align-items-center">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item">Alterar Turma</a></li>
                                    <li class="breadcrumb-item">Convite</a></li>
                                    <li class="breadcrumb-item">Arquivos de Convite</a></li>
                                    <li class="breadcrumb-item active" aria-current="page">Cadastrar Arquivo de Convite</li>
                                </ol>
                            </nav>
                        </div>
                    </div>
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <form action="recebe_tipoarquivoturma.php?id=<?php echo $id; ?>"
