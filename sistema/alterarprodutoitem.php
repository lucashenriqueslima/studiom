...
if ($_SESSION['id'] == null) {
	...
	$id = $_GET['id'];
	$id1 = $_GET['id1'];
	$sql = mysqli_query($con, "select * from produtos_turma_item where id_item = '$id'");
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <form action="recebe_alterarprodutoitem.php?id=<?php echo $id; ?>&id1=<?php echo $id1; ?>"
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-4">
                                            <fieldset class="form-group">
                                                <label class="form-label semibold" for="exampleInput">Tipo do
                                                    Produto</label>
                                                <select name="id_tipo" class="form-control">
                                                    <option value="" selected="selected">Selecione...</option>
                                                      ...
                                                      <option value="<?php echo $vetor_produto['id_tipo']; ?>"
																											        <?php if (strcasecmp($vetor['id_tipo'], $vetor_produto['id_tipo']) == 0) : ?>selected="selected"<?php endif; ?>><?php echo $vetor_produto['nome'] ?></option>
																									<?php } ?>
                                                </select>
                                            </fieldset>
                                        </div>
                                        ...
                                        <div class="col-lg-4">
                                            <fieldset class="form-group">
                                                ...
                                                <input type="number" name="qtdminima"
                                                       value="<?php echo $vetor['qtdminima']; ?>" class="form-control"
                                                       required="">
                                            </fieldset>
                                        </div>
