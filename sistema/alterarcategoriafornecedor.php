<?php
    ...
    $id = $_GET['id'];
    $sql = mysqli_query($con, "select * from categoriafornecedor where id_categoria = '$id'");
                        ...
                        <div class="d-flex align-items-center">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active" aria-current="page">Categorias de Fornecedores</li>
                                </ol>
                            </nav>
                        </div>
                    </div>
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title">Cadastro de Categoria de Fornecedor</h4>

                                <form action="recebe_alterarcategoriafornecedor.php?id=<?php echo $id; ?>" method="post" name="cliente" enctype="multipart/form-data" onSubmit="return verificarCPF()" id="formID">
                                ...
                                <div class="row">
                                  ...
                                  <div class="form-group">
                                    <label>Mostrar na Escala?</label>
                                    <select name="escala" class="form-control select2" style="width: 100%;" required>
                                      <option value="1" <?php if (strcasecmp($vetor['escala'], '1') == 0) : ?>selected="selected"<?php endif; ?>>Não</option>
                                      <option value="2" <?php if (strcasecmp($vetor['escala'], '2') == 0) : ?>selected="selected"<?php endif; ?>>Sim</option>
                                    </select>
                                  </div>
                                  </div>
