            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title">Convite Personal</h4>

                                <br>

                                <?php

                                  $sql_itens = mysqli_query($con, "select * from convite_personal_itens where id_convite = '$id' order by id_item ASC");
                                  ...
                                  ?>
                                      ...
                                      $sql_fotos = mysqli_query($con, "select * from ")
