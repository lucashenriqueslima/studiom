...
if ($_SESSION['id'] == null) {
	...
	$id = $_GET['id'];
	$sql = mysqli_query($con, "select * from escolha_fotos where id_escolha = '{$id}'");
                        ...
                        <div class="d-flex align-items-center">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active" aria-current="page">Alterar Escolha</li>
                                </ol>
                            </nav>
                        </div>
                    </div>
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
<!--                                <h4 class="card-title">Cadastro de Álbum</h4>-->

                                <form action="recebe_alterarescolhafoto.php?id=<?php echo $id; ?>" method="post"
                                ...
                                <div class="table-responsive">
                                    ...
                                    <table width="100%" class="table table-bordered table-striped">
                                        ...
                                        <tbody>
																				...
																				<?php
																				$sql_imagens = mysqli_query($con, "select * from escolha_fotos_itens where id_escolha = '{$id}' order by npagina ASC");
																				$i = 0;
																				while ($vetor_imagens = mysqli_fetch_array($sql_imagens)) {
																					?>

                                            <form action="recebe_alterarfotoescolhafoto.php?id=<?php echo $id; ?>"
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <table class="table">
                                                            ...
                                                            <tr>
																															...
																															<?php
																															$sql_fotos_cadastradas = mysqli_query($con, "select * from escolha_fotos_escolhidas where id_escolha = '{$vetor_imagens['id_item']}'");
                                                    ...
                                                    href="excluirlaminaescolha.php?id=<?php echo $vetor_imagens['id_item']; ?>&id1=<?php echo $id; ?>">
