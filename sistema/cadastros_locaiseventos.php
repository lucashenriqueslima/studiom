              ...
              <div class="container-fluid">
                  ...
                  <div class="row">
                      <div class="col-12">
                          <div class="card">
                              <div class="card-body">
<!--                                  <h4 class="card-title">Locais de Eventos</h4>-->
																
																<?php if ($vetor_permissao['cadastro'] == 1) {
																}else { ?><a href="cadastrar_localevento.php">
                                    <button type="button" class="btn waves-effect waves-light btn-warning">Novo Local de
                                        Evento
                                    </button>
                                </a>
                                  ...
                                  <div class="table-responsive">
                                      <table id="lang_opt" class="table table-striped table-bordered display"
                                          ...
                                          <tbody>
																					<?php
																					$sql_atual = mysqli_query($con, "select * from locais order by nome ASC");
																					while ($vetor = mysqli_fetch_array($sql_atual)) {
																						?>
                                              <tr>
                                                  <td><?php echo $vetor['nome']; ?></td>
                                                  <td><?php echo $vetor['cidade']; ?></td>
                                                  <td><?php echo $vetor['estado']; ?></td>
                                                  <td><a class="fancybox fancybox.ajax"
                                                         href="alterarlocalevento.php?id=<?php echo $vetor['id_local']; ?>"
                                                         target="_blank">
                                                          <button type="button" class="btn btn-success mesmo-tamanho"
                                                                 ...
                                                                 href="confexcluirlocalevento.php?id=<?php echo $vetor['id_local']; ?>">
