            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title">Cadastro de Arquivo para o Colaborador: <?php echo $vetor['nome']; ?></h4>

                                <form action="recebe_arquivocolaborador.php?id=<?php echo $id; ?>" enctype="multipart/form-data" method="post">
