<?php
  ...
  $id1 = $_GET[ 'id1' ];
	...
	$sql = mysqli_query($con, "select * from redessociais_turmas where id_redes = '$id'");
        ...
        <div class="col-xs-12">
          <div class="box">
            <div class="box-header">
              <h3 class="box-title">Exclusão de Rede Social</h3>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
    ...
    color: #fff;">
                  ...
                  <th width="15%">Ação</th> 
                         ...
                         <tr>
                              ...
                              <td><a href="excluirredesocial.php?id=<?php echo $id; ?>&id1=<?php echo $id1; ?>"><button type="button" class="btn btn-inline btn-danger">Sim</button></a> <a href="alterarturmamkt.php?id=<?php echo $id1; ?>"><button type="button" class="btn btn-inline btn-success">Não</button></a></td>  
                          </tr>
