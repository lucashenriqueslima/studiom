                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <?php if($vetor_permissao['cadastro'] == 1) { } else { ?><a href="cadastrofaq.php"><button type="button" class="btn waves-effect waves-light btn-warning">Nova FAQ</button></a>
                                ...
                                <div id="accordian-part">
                                    <div id="accordian-3">
                                        ...
                                        $sql_faq = mysqli_query($con, "select * from faq where tipocad IN ('2', '3') and servico = '1' order by id_faq DESC");

                                        while($vetor_faq = mysqli_fetch_array($sql_faq)) {

                                        $sql_departamento = mysqli_query($con, "select * from departamentos where id_departamento = '$vetor_faq[id_departamento]'");
                                        ...
                                        <div class="card mb-0">
                                            <div class="card-header bg-white pl-0">
                                                <h5 class="mb-0">
                                                    <a href="#" class="link" id="headingOne" data-toggle="collapse" data-target="#convite-<?php echo $vetor_faq['id_faq']; ?>" aria-expanded="true" aria-controls="collapse1">
                                                        <?php echo $vetor_faq['pergunta']; ?>
                                                    </a>
                                                </h5>
                                            </div>
                                            <div id="convite-<?php echo $vetor_faq['id_faq']; ?>" class="collapse" aria-labelledby="headingOne" data-parent="#accordian-3">
                                                <div class="card-body pl-0">
                                                    <div align="justify"><?php echo $vetor_faq['resposta']; ?></div>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <br>
                                          ...
                                          <table width="100%">
                                            <tr>
                                              <td width="5%"><?php if($vetor_permissao['cadastro'] == 1) { } else { ?>
                                          <a href="alterarfaq.php?id=<?php echo $vetor_faq['id_faq']; ?>" target="_blank"><button type="button" class="btn btn-info mesmo-tamanho" title="Ver ou Alterar Cadastro"><i class="fa fa-edit"></i></button></a>
                                          <?php } ?></td>
                                              <td width="2%"></td>
                                              <td><?php if($vetor_permissao['exclusao'] == 1) { } else { ?><a href="confexcluirfaq.php?id=<?php echo $vetor_faq['id_faq']; ?>" ><button type="button" class="btn btn-danger mesmo-tamanho" title="Excluir Cadastro"><i class="mdi mdi-window-close"></i></button></a><?php } ?></td>
                                            </tr>
                                          </table>
                            ...
                            <div class="card-body">
                                ...
                                <div id="accordian-part">
                                    <div id="accordian-3">
                                        ...
                                        $sql_faq = mysqli_query($con, "select * from faq where tipocad IN ('2', '3') and servico = '2' order by id_faq DESC");
                                        ...
                                        <div class="card mb-0">
                                            <div class="card-header bg-white pl-0">
                                                <h5 class="mb-0">
                                                    <a href="#" class="link" id="headingOne" data-toggle="collapse" data-target="#fotografia-<?php echo $vetor_faq['id_faq']; ?>" aria-expanded="true" aria-controls="collapse1">
                                                        <?php echo $vetor_faq['pergunta']; ?>
                                                    </a>
                                                </h5>
                                            </div>
                                            <div id="fotografia-<?php echo $vetor_faq['id_faq']; ?>" class="collapse" aria-labelledby="headingOne" data-parent="#accordian-3">
                                                <div class="card-body pl-0">
                                                    <div align="justify"><?php echo $vetor_faq['resposta']; ?></div>
                                                </div>
                                            </div>
