  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">Convite Personal</li>
      </ol>
    </section>
        ...
        <div class="col-xs-12">
          <div class="box">
            <div class="box-header">
              <h3 class="box-title">Exclusão de Convite Personal</h3>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
    ...
    color: #fff;">
                  ...
                  <th width="15%">Ação</th> 
                         ...
                         <tr>
                              ...
                              <td><a href="excluirconvitepersonal.php?id=<?php echo $id; ?>"><button type="button" class="btn btn-inline btn-danger">Sim</button></a> <a href="afFotografia_personal.php"><button type="button" class="btn btn-inline btn-success">Não</button></a></td>
                          </tr>
