        ...
        <div class="col-xs-12">
          <div class="box">
            <div class="box-header">
              <h3 class="box-title">Exclusão de Evento</h3>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
    ...
    color: #fff;">
                  ...
                  <th width="15%">Ação</th> 
                         ...
                         <tr>
                              ...
                              <td><a href="excluirplanejamentoescala.php?id=<?php echo $id; ?>"><button type="button" class="btn btn-inline btn-danger">Sim</button></a> <a href="fotografia_planejamento_eventos.php"><button type="button" class="btn btn-inline btn-success">Não</button></a></td>
                          </tr>
