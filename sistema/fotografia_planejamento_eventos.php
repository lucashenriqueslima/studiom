                          ...
                          <div class="d-flex align-items-center">
                              <nav aria-label="breadcrumb">
                                  <ol class="breadcrumb">
                                      ...
                                      <li class="breadcrumb-item active" aria-current="page">Escala de Eventos</li>
                                  </ol>
                              </nav>
                          </div>
                      </div>
              ...
              <div class="container-fluid">
                  ...
                  <div class="row">
                      <div class="col-12">
                          <div class="card">
                              <div class="card-body">
<!--                                  <h4 class="card-title">Planejamento de Eventos</h4>-->
																
																<?php if ($vetor_permissao['cadastro'] == 1) {
																}else { ?><a href="cadastrar_planejamentoevento.php">
                                  ...
                                  <div class="table-responsive">
                                      <table id="lang_opt" class="table table-striped table-bordered display"
                                          ...
                                          <tbody>
																					...
																					$sql_atual = mysqli_query($con, "select * from escala_eventos order by id_escala ASC");
                                              ...
                                              <tr>
                                                  ...
                                                  <td><a class="fancybox fancybox.ajax"
                                                         href="alterarplanejamentoevento.php?id=<?php echo $vetor['id_escala']; ?>"
                                                         target="_blank">
                                                          <button type="button" class="btn btn-success mesmo-tamanho"
                                                                 ...
                                                                 href="confexcluirplanejamentoevento.php?id=<?php echo $vetor['id_escala']; ?>">
