                          ...
                          <div class="d-flex align-items-center">
                              <nav aria-label="breadcrumb">
                                  <ol class="breadcrumb">
                                      ...
                                      <li class="breadcrumb-item active" aria-current="page">Tipos de Jobs</li>
                                  </ol>
                              </nav>
                          </div>
                      </div>
                              ...
                              <div class="card-body">
                                  <ul class="nav nav-tabs" role="tablist">
                                      ...
                                      <li class="nav-item"><a class="nav-link active" data-toggle="tab"
                                                          ...
                                                          class="ti-email"></i></span> <span class="hidden-xs-down">Tipos de Jobs</span></a>
                                      </li>
                                  </ul>
                                  <div class="tab-content tabcontent-border">
                                      ...
                                      <div class="tab-pane active" id="ch1" role="tabpanel">
                                          <br>
																				...
																				}else { ?><a href="cadastrar_tipojob.php">
                                          ...
                                          <ul class="nav nav-tabs" role="tablist">
                                              ...
                                              <li class="nav-item"><a class="nav-link active" data-toggle="tab"
                                                              ...
                                                              class="hidden-xs-down">Ativos</span></a>
                                              </li>
                                              <li class="nav-item"><a class="nav-link" data-toggle="tab"
                                                                      href="#ch1-2"
                                                                      role="tab"><span class="hidden-sm-up"><i
                                                                  class="ti-email"></i></span> <span
                                                              class="hidden-xs-down">Excluídos</span></a>
                                              </li>
                                          </ul>
                                          <div class="tab-content tabcontent-border">
                                              <div class="tab-pane active" id="ch1-1" role="tabpanel">
                                                  <br>
                                                  <div class="table-responsive">
                                                      <table id="lang_opt"
                                                          ...
                                                          <thead>
                                                          <tr align="center">
                                                              <th><strong><h5>Título</h5></strong></th>
                                                              <th><strong><h5>Ação</h5></strong></th>
                                                          </tr>
                                                          </thead>
                                                          <tbody>
																													<?php
																													$sql_atual = mysqli_query($con, "select * from jobs where status='1' order by titulo ASC");
																													while ($vetor = mysqli_fetch_array($sql_atual)) {
																														?>
                                                              <tr>
                                                                  <td align="center"><?php echo $vetor['titulo']; ?></td>
                                                                  
                                                                  <td align="center"><a
                                                                              href="alterartipojob.php?id=<?php echo $vetor['id_job']; ?>">
                                                                          <button type="button"
                                                                                 ...
                                                                                 href="recebe_tipojob.php?remover_job=<?php echo $vetor['id_job']; ?>">
                                                                              <button type="button"
                                              ...
                                              <div class="tab-pane" id="ch1-2" role="tabpanel">
                                                  <br>
                                                  <div class="table-responsive">
                                                      <table id="lang_opt2"
                                                             class="table table-striped table-bordered display"
                                                          ...
                                                          <tr align="center">
                                                              <th><strong><h5>Título</h5></strong></th>
<!--                                                              <th><strong><h5>Tempo Unitario<br>(minutos)</h5></strong>-->
                                                              </th>
                                                              <th><strong><h5>Ação</h5></strong></th>
                                                          </tr>
                                                          </thead>
                                                          <tbody>
																													<?php
																													$sql_atual = mysqli_query($con, "select * from jobs where status='0' order by titulo ASC");
																													while ($vetor = mysqli_fetch_array($sql_atual)) {
																														?>
                                                              <tr>
                                                                  <td align="center"><?php echo $vetor['titulo']; ?></td>
<!--                                                                  <td align="center">--><?php //echo((int)$vetor['tempo_unitario'] / 60); ?><!--</td>-->
                                                                  <td align="center">
                                                                      <a class="fancybox fancybox.ajax"
                                                                         href="recebe_tipojob.php?ativar=<?php echo $vetor['id_job']; ?>">
                                                                          <button type="button"
                                                                                  class="btn btn-info mesmo-tamanho"
                                                                                  title="Ativar Cadastro">Ativar
                                                                          </button>
                                                                      </a>
                                                                  </td>
                                                              </tr>
