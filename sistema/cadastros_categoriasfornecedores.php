                          ...
                          <div class="d-flex align-items-center">
                              <nav aria-label="breadcrumb">
                                  <ol class="breadcrumb">
                                      ...
                                      <li class="breadcrumb-item active" aria-current="page">Categoria de Fornecedores
                                      </li>
                                  </ol>
                              </nav>
                          </div>
              ...
              <div class="container-fluid">
                  ...
                  <div class="row">
                      <div class="col-12">
                          <div class="card">
                              <div class="card-body">
<!--                                  <h4 class="card-title">Categoria de Fornecedores</h4>-->
																
																<?php if ($vetor_permissao['cadastro'] == 1) {
																}else { ?><a href="cadastrar_categoriafornecedor.php">
                                  ...
                                  <div class="table-responsive">
                                      <table id="lang_opt" class="table table-striped table-bordered display"
                                          ...
                                          <tbody>
																					<?php
																					$sql_atual = mysqli_query($con, "select * from categoriafornecedor order by nome ASC");
																					while ($vetor = mysqli_fetch_array($sql_atual)) {
																						?>
                                              <tr>
                                                  <td><?php echo $vetor['nome']; ?></td>
                                                  <td><a class="fancybox fancybox.ajax"
                                                         href="alterarcategoriafornecedor.php?id=<?php echo $vetor['id_categoria']; ?>"
                                                         target="_blank">
                                                          <button type="button" class="btn btn-success mesmo-tamanho"
                                                                 ...
                                                                 href="confexcluircategoriafornecedor.php?id=<?php echo $vetor['id_categoria']; ?>">
