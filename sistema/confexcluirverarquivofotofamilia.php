<?php
  ...
  $sql_itens = mysqli_query($con, "select * from tipos_arquivos_turma where id_tipo = '$id'");
  ...
  $sql = mysqli_query($con, "select * from dadosconvite where id_tipo = '$id' and id_formando = '$id1'");
  $vetor = mysqli_fetch_array($sql);

  $sql_formando = mysqli_query($con, "select * from formandos where id_formando = '$id1'");
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">Arte Final - Convite</li>
      </ol>
    </section>
        ...
        <div class="col-xs-12">
          <div class="box">
            <div class="box-header">
              <h3 class="box-title">Exclusão de Arquivo de Convite</h3>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
    ...
    color: #fff;">
                  ...
                  <th width="15%">Ação</th> 
                         ...
                         <tr>
                              <td><?php echo $vetor_formando['nome']; ?> : <?php echo $vetor_tipo['nome']; ?></td>
                              <td><a href="excluirverarquivoconvitefotofamilia.php?id=<?php echo $id; ?>&id1=<?php echo $id1; ?>"><button type="button" class="btn btn-inline btn-danger">Sim</button></a> <a href="verarquivoconvite.php?id=<?php echo $id1; ?>"><button type="button" class="btn btn-inline btn-success">Não</button></a></td>  
                          </tr>
