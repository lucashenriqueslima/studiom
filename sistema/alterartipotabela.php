<?php
    ...
    $sql = mysqli_query($con, "select * from tabela_tipos where id_tipo = '$id'");
                        ...
                        <div class="d-flex align-items-center">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active" aria-current="page">Tabela de Valores</li>
                                </ol>
                            </nav>
                        </div>
                    </div>
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <form action="recebe_alterartipotabela.php?id=<?php echo $id; ?>" method="post" name="cliente" enctype="multipart/form-data" onSubmit="return verificarCPF()" id="formID">
                                ...
                                <div class="row">
                                  ...
                                  <div class="col-lg-6">
                                    <fieldset class="form-group">
                                      ...
                                      <select name="tipo" id="categorias" class="form-control select2">
                                            <option value="" selected="selected">Selecione...</option>
                                            <?php 
                                            $sql_tipo = mysqli_query($con, "select * from tabela_item order by titulo ASC");
                                            while ($vetor_tipo=mysqli_fetch_array($sql_tipo)) { ?>
                                            <option value="<?php echo $vetor_tipo['id_tipo']; ?>" <?php if (strcasecmp($vetor['tipo'], $vetor_tipo['id_tipo']) == 0) : ?>selected="selected"<?php endif; ?>><?php echo $vetor_tipo['titulo'] ?></option>
                                            <?php } ?>
                                          </select>
                                    </fieldset>
                                  </div>
                                  ...
                                  <div class="col-lg-6">
                                    <fieldset class="form-group">
                                      ...
                                      <input type="text" name="titulo" class="form-control" value="<?php echo $vetor['titulo']; ?>" required="">
                                    </fieldset>
                                  </div>
