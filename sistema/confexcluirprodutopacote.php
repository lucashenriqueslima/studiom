<?php
    ...
    $sql = mysqli_query($con, "select * from pacotes_turma where id_pacote = '$id'");
                                ...
                                <tr style="    background: #FF6600; color: #fff;">
                                  ...
                                  <th width="15%">Ação</th> 
                                         ...
                                         <tr>
                                              ...
                                              <td><a href="excluirprodutopacote.php?id=<?php echo $id; ?>&id1=<?php echo $id1; ?>"><button type="button" class="btn btn-inline btn-danger">Sim</button></a> <a href="alterarproduto.php?id=<?php echo $id1; ?>"><button type="button" class="btn btn-inline btn-success">Não</button></a></td>     
                                          </tr>
