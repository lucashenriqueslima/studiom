                        ...
                        <div class="d-flex align-items-center">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item">Categorias de Fornecedores</a></li>
                                    <li class="breadcrumb-item active" aria-current="page">Cadastrar Categoria de Fornecedor
                                    </li>
                                </ol>
                            </nav>
                        </div>
...
<!--                                <h4 class="card-title">Cadastro de Categoria de Fornecedor</h4>-->
                                ...
                                <form action="recebe_categoriafornecedor.php" method="post" name="cliente"
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <select name="escala" class="form-control select2" style="width: 100%;"
                                                        required>
