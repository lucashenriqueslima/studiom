...
if ($_SESSION['id'] == null) {
	...
	$id = $_GET['id'];
	$sql = mysqli_query($con, "select * from preeventos where id_pre = '$id'");
                        ...
                        <div class="d-flex align-items-center">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item">Pré-Eventos</a></li>
                                    <li class="breadcrumb-item active" aria-current="page">Alterar Pré-Evento</li>
                                </ol>
                            </nav>
                        </div>
                    </div>
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <form action="recebe_alterarpreevento.php?id=<?php echo $id; ?>" method="post"
                                        ...
                                        <div class="col-lg-12">
                                            <fieldset class="form-group">
                                                ...
                                                <input type="text" name="titulo" class="form-control"
                                                       value="<?php echo $vetor['titulo']; ?>" id="exampleInput"
