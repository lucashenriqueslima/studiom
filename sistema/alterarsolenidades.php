...
<!--                                <h4 class="card-title">Cadastro de Evento</h4>-->
                                ...
                                <form action="alteraqrcode.php" method="post" name="cliente"
                                            ...
                                            <fieldset class="form-group">
                                                ...
                                                <select name="id_turma" id="id_turma" class="form-control">
                                                    <option value="" selected="selected">Selecione...</option>
																									<?php
																									$sql_cursos = mysqli_query($con, "select * from turmas where id_turma = '$id' order by ncontrato ASC");
    ...
    <script>
        ...
        $(document).ready(function(){
            ...
            $("#id_turma").blur(function(){                
                ...
                var $colacaograuOfc = $("textarea[name='colacaograuOfc']");   
                ...
                $.getJSON('listar_solenidades.php',{
                    ...
                    $colacaograuOfc.val(json.colacaograuOfc);
