                          ...
                          <div class="d-flex align-items-center">
                              <nav aria-label="breadcrumb">
                                  <ol class="breadcrumb">
                                      ...
                                      <li class="breadcrumb-item">Pós</a></li>
                                      <li class="breadcrumb-item active" aria-current="page">Produtos de Formandos</li>
                                  </ol>
                              </nav>
                          </div>
                      </div>
              ...
              <div class="container-fluid">
                  ...
                  <div class="row">
                      <div class="col-12">
                          <div class="card">
                              <div class="card-body">
<!--                                  <h4 class="card-title">Produtos Formando</h4>-->
																
																<?php if ($vetor_permissao['cadastro'] == 1) {
																}else { ?><a href="cadastroprodutoformando.php">
                                  ...
                                  <form action="recebe_buscaprodutosformando.php" method="post" name="cliente"
