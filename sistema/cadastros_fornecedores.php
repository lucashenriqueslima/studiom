                          ...
                          <div class="card">
                              <div class="card-body">
                                  <!--                                  <h4 class="card-title">Fornecedores</h4>-->
																...
																}else { ?><a href="cadastrar_fornecedor.php">
                                  ...
                                  <div class="table-responsive">
                                      <table id="lang_opt" class="table table-striped table-bordered display"
                                          ...
                                          <thead align="center">
                                          <tr>
                                              <th width="5%"><strong><h5>Cod.</h5></strong></th>
                                              ...
                                              <th width="14%"><strong><h5>Telefone</h5></strong></th>
                                              <th width="10%"><strong><h5>Ação</h5></strong></th>
                                          </tr>
                                          </thead>
                                          <tbody>
																					<?php
																					$sql_atual = mysqli_query($con, "select * from clientes where tipocad = '2' order by nome ASC");
																					while ($vetor = mysqli_fetch_array($sql_atual)) {
																						$sql_categoria = mysqli_query($con, "select cf.* from fornecedor_categoria fc
                                                                                            left join categoriafornecedor cf on cf.id_categoria = fc.id_categoria
                                                                                            where fc.id_fornecedor = '$vetor[id_cli]' order by nome ASC");
																						$inicio = 1;
																						?>
                                              <tr>
                                                  <td align="center"><?php echo $vetor['id_cli']; ?></td>
                                                  <td><?php echo $vetor['nome']; ?></td>
                                                  <td align="center">
                                                    <?php
                                                        while ($vetor_cat = mysqli_fetch_array($sql_categoria)) {
                                                            if($inicio == 1){
	                                                            echo $vetor_cat['nome'];
	                                                            $inicio = 2;
                                                            }else{
	                                                            echo "<br>".$vetor_cat['nome'];
                                                            }
                                                        }
                                                        ?>
                                                  </td>
                                                  <td align="center"><?php echo $vetor['cidade']; ?></td>
                                                  <td align="center"><?php echo $vetor['estado']; ?></td>
                                                  <td align="center"><?php echo $vetor['telefone']; ?></td>
                                                  <td align="center"><a class="fancybox fancybox.ajax"
                                                         href="alterarfornecedor.php?id=<?php echo $vetor['id_cli']; ?>"
                                                         target="_blank">
                                                          <button type="button" class="btn btn-success mesmo-tamanho"
                                                                 ...
                                                                 href="confexcluirfornecedor.php?id=<?php echo $vetor['id_cli']; ?>">
