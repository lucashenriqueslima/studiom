...
<!--                                  <h4 class="card-title">HDs</h4>-->
																...
																}else { ?><a href="cadastrar_hd.php">
                                    <button type="button" class="btn waves-effect waves-light btn-warning">Novo HD
                                    </button>
                                </a>
                                  ...
                                  <div class="table-responsive">
                                      <table id="lang_opt" class="table table-striped table-bordered display"
                                          ...
                                          <tbody>
																					<?php
																					$sql_atual = mysqli_query($con, "select * from hds order by id_hd ASC");
																					while ($vetor = mysqli_fetch_array($sql_atual)) {
																						$sql_contrato = mysqli_query($con, "select * from turmas where id_turma = '$vetor[ncontrato]'");
                                              ...
                                              <tr>
                                                  ...
                                                  <td><?php echo $vetor['nhd']; ?></td>
                                                  <td><?php echo $vetor['marca']; ?></td>
                                                  <td><?php echo $vetor['nserie']; ?></td>
                                                  <td><?php echo $vetor['tamanho']; ?></td>
                                                  <td><a class="fancybox fancybox.ajax"
                                                         href="alterarhd.php?id=<?php echo $vetor['id_hd']; ?>"
                                                         target="_blank">
                                                          <button type="button" class="btn btn-success mesmo-tamanho"
                                                                 ...
                                                                 href="confexcluirhd.php?id=<?php echo $vetor['id_hd']; ?>">
