            ...
            <div class="page-breadcrumb">
                <div class="row">
                    <div class="col-5 align-self-center">
                        <h4 class="page-title">Interatividades</h4>
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title">Arquivos de Convite</h4>

                                <?php if($vetor_permissao['cadastro'] == 1) { } else { ?><a href="cadastroarquivoconvite.php"><button type="button" class="btn waves-effect waves-light btn-warning">Novo Arquivo de Convite</button></a>
                                ...
                                <div class="table-responsive">
                                    <table id="lang_opt" class="table table-striped table-bordered display" style="width:100%">
                                        ...
                                        <tbody>
                                            ...
                                            $sql_atual = mysqli_query($con, "select * from arquivosdeconvites where id_turma = '$id'");
                                            ...
                                            $sql_categoria = mysqli_query($con, "select * from categoriaevento a, eventos_turma_lista b where a.id_categoria = b.id_evento and b.id_evento_turma = '$vetor[evento]'");
                                            $vetor_categoria = mysqli_fetch_array($sql_categoria);

                                            ?>
                                            <tr>
                                                <td><?php if($vetor['tipo'] == 1) { echo "Layout Artes"; } if($vetor['tipo'] == 2) { echo "Layout Convite"; } if($vetor['tipo'] == 3) { echo "Fotos"; } if($vetor['tipo'] == 4) { echo "Dados Convite"; } if($vetor['tipo'] == 5) { echo "Fotos Recortadas"; } ?></td> 
                                                <td><a href="arquivos/<?php echo $vetor['arquivo']; ?>" target="_blank"><button type="button" class="btn btn-success mesmo-tamanho" title="Imprimir Cadastro"><i class="mdi mdi-cloud-download"></i></button></a></td>
                                                <td> <?php if($vetor_permissao['exclusao'] == 1) { } else { ?><a class="fancybox fancybox.ajax" href="excluirarquivoconvite.php?id=<?php echo $vetor['id_arquivo']; ?>"><button type="button" class="btn btn-danger mesmo-tamanho" title="Excluir Cadastro"><i class="mdi mdi-window-close"></i></button></a><?php } ?></td>
                                            </tr>
                                            <?php } ?>
                                        </tbody>
                                    </table>
