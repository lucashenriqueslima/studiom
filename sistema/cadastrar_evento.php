        ...
        <script type="text/javascript">
            ...
            $(document).ready(function () {
                $('#turmas').change(function () {
                   ...
                   // $('#categoriasevento').load('listaContrato.php?turmas=' + $('#turmas').val());
                    $('#categoriasevento').load('listaContrato.php?id_turma=' + $('#turmas').val());
                });
            });
        </script>
...
<!--                                <h4 class="card-title">Cadastro de Evento</h4>-->
                                ...
                                <form action="recebe_evento.php" method="post" name="cliente"
                                    ...
                                    <div class="row">
                                       <div class="col-lg-6">
                                            <fieldset class="form-group">
                                                ...
                                                <select name="categoriasevento" id="categoriasevento"
                                    ...
                                    <h3>Dados do Local do Evento</h3>

                                    <div class="row">

                                        <div class="col-lg-12">
                                            <fieldset class="form-group">
                                                <label class="form-label semibold" for="exampleInput">Nome do Local</label>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-6">
                                            <fieldset class="form-group">
                                                ...
                                                <input type="text" name="estado" value="<?php echo $vetor['estado']; ?>"
