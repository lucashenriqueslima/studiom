...
<!--                                  <h4 class="card-title">Tabela</h4>-->
																...
																}else { ?><a href="cadastrotabelatribconvite.php">
                                  ...
                                  <div class="table-responsive">
                                      <table id="lang_opt" class="table table-striped table-bordered display"
                                          ...
                                          <tbody>
																					<?php
																					$sql_atual = mysqli_query($con, "select * from tabela_tributos order by id_tributo DESC");
																					while ($vetor = mysqli_fetch_array($sql_atual)) {
																						?>
                                              <tr>
                                                  <td><?php echo $vetor['id_tributo']; ?></td>
                                                  ...
                                                  <td><a class="fancybox fancybox.ajax"
                                                         href="alterartabelatribconvite.php?id=<?php echo $vetor['id_tributo']; ?>"
                                                         target="_blank">
                                                          <button type="button" class="btn btn-success mesmo-tamanho"
                                                                 ...
                                                                 href="confexcluirtabelatribconvite.php?id=<?php echo $vetor['id_tributo']; ?>">
