                          ...
                          <div class="card">
                              <div class="card-body">
                                  <h4 class="card-title">Gestão de Convites</h4>
																...
																$sql_produtos_turma = mysqli_query($con, "select * from produtos_turma where id_turma = '$id_turma' and id_produto = '$produto'");
                                          ...
                                          <td width="16%" valign="middle">
                                              <table width="100%">
                                                  <tr>
                                                      ...
                                                      <td width="30%"><a
                                                                  href="imprimirrelvenda.php?id_turma=<?php echo $id_turma; ?>"
                                                                  target="_blank">
                                                              <button type="button"
                                                  ...
                                                  <tr>
                                                      ...
                                                      <td width="30%"><a
                                                                  href="imprimirrelvendaboleto.php?id_turma=<?php echo $id_turma; ?>"
                                                                  target="_blank">
                                                              <button type="button"
                                                                      class="btn btn-primary mesmo-tamanho"
                                                                      title="Imprimir Cadastros"><i
                                                  ...
                                                  <tr>
                                                      ...
                                                      <td width="30%"><a
                                                                  href="imprimirrelprotocolo.php?id_turma=<?php echo $id_turma; ?>"
                                                                  target="_blank">
                                                              <button type="button"
                                                                      class="btn btn-primary mesmo-tamanho"
                                                                      title="Imprimir Cadastros"><i
                                  ...
                                  <table class="table table-bordered table-striped">
                                      ...
                                      <tr>
                                          <th width="15%"></th>
																				<?php
																				$sql_soma_qtd2 = mysqli_query($con, "SELECT SUM(valorvenda) as total FROM vendas where produto = '$produto' and status != '4' and iniciada = '2'");
																				$vetor_soma_qtd2 = mysqli_fetch_array($sql_soma_qtd2);
																				$sql_soma_avista = mysqli_query($con, "SELECT SUM(valorvenda) as total FROM vendas where produto = '$produto' and formapag = '4' and status != '4' and iniciada = '2'");
																				...
																				while ($vetor_itens2 = mysqli_fetch_array($sql_itens2)) {
																					$sql_soma_qtd1 = mysqli_query($con, "SELECT SUM(b.qtd) as total FROM vendas a, itens_venda_individual b where a.id_venda = b.id_venda and b.id_item = '$vetor_itens2[id_item]' and a.produto = '$produto' and a.status != '4' and a.iniciada = '2'");
                                          ...
                                          <th></th>
                                          <th>
                                              R$ <?php echo $num = number_format($vetor_soma_qtd2['total'], 2, ',', '.'); ?></th>
                                      ...
                                      <tbody>
																			...
																			while ($vetor_atual = mysqli_fetch_array($sql_atual)) {
																				...
																				$sql_venda = mysqli_query($con, "select * from vendas where id_formando = '$vetor_atual[id_formando]' and produto = '$produto' and iniciada = '2' order by id_venda DESC limit 0,1");
                                          ...
                                          <tr>
                                              <td><?php echo $vetor_turma['ncontrato']; ?>
                                                  ...
                                                  - <?php echo $vetor_atual['nome']; ?></td>
																						...
																						while ($vetor_itens1 = mysqli_fetch_array($sql_itens1)) {
																							$sql_soma_qtd = mysqli_query($con, "SELECT SUM(b.qtd) as total FROM vendas a, itens_venda_individual b where a.id_venda = b.id_venda and a.id_formando = '$vetor_atual[id_formando]' and b.id_item = '$vetor_itens1[id_item]' and a.produto = '$produto' and a.iniciada = '2'");
																							$vetor_soma_qtd = mysqli_fetch_array($sql_soma_qtd);
																							?>
                                                <td><?php echo $vetor_soma_qtd['total']; ?></td>
																							<?php
																						}
																						$sql_soma_valor = mysqli_query($con, "SELECT SUM(b.valor*b.qtd) as total FROM vendas a, itens_venda_individual b where a.id_venda = b.id_venda and a.id_formando = '$vetor_atual[id_formando]' and a.produto = '$produto' and a.iniciada = '2'");
                                              ...
                                              <td>
                                                  R$ <?php echo $num = number_format($vetor_venda['valorvenda'], 2, ',', '.'); ?></td>
                                              <td><?php if ($vetor_venda['duplicata'] == 1) { ?><a
                                                      href="confirmarcompra.php?id=<?php echo $vetor_venda['id_venda']; ?>">
