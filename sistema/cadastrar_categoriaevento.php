                        ...
                        <div class="d-flex align-items-center">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active" aria-current="page">Cadastrar Categoria de Evento</li>
                                </ol>
                            </nav>
                        </div>
                    </div>
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
<!--                                <h4 class="card-title">Cadastro de Categoria de Evento</h4>-->

                                <form action="recebe_categoriaevento.php" method="post" name="cliente"
                                        ...
                                        <div class="col-lg-4">
                                            <fieldset class="form-group">
                                                ...
                                                <select name="tipo" class="form-control" required="">
                                                    ...
                                                    <option value="2">Evento oficial antes da formatura</option>
                                                    <option value="3">Evento Oficial</option>
                                                </select>
                                            </fieldset>
                                        </div>
