<?php
    ...
    $id = $_GET['id'];
    $sql = mysqli_query($con, "select * from perfil where id_perfil = '$id'");
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title">Ver ou Alterar Cadastro de Perfil</h4>

                                <form action="recebe_alterarperfil.php?id=<?php echo $id; ?>" method="post" name="cliente" enctype="multipart/form-data" onSubmit="return verificarCPF()" id="formID">
                                <div class="row">
                                    <div class="col-lg-12">
                                        <fieldset class="form-group">
                                            <label class="form-label semibold" for="exampleInput">Perfil</label>
                                            <input type="text" name="nome" value="<?php echo $vetor['nome']; ?>" class="form-control" id="exampleInput" placeholder="Digite o perfil" required>
                                        </fieldset>
                                    </div>
                                </div><!--.row-->
