...
if ($_SESSION['id'] == null) {
	...
	$id = $_GET['id'];
	$sql = mysqli_query($con, "select * from produtos_exclusive where id_produtoexclusive = '$id'");
                        ...
                        <div class="d-flex align-items-center">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active" aria-current="page">Alterar Produto Exclusive
                                        Turma
                                    </li>
                                </ol>
                            </nav>
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <form action="recebe_alterarprodutoexclusive.php?id=<?php echo $id; ?>" method="post"
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <br>
																							<?php echo $vetor_contrato['ncontrato']; ?>
                                ...
                                <div class="table-responsive">
                                    <table id="lang_opt" class="table table-striped table-bordered display"
                                        ...
                                        <tr>
                                            <th>
                                                <div class="a"><h5><strong>Imagem</strong></h5></div>
                                            </th>
                                            <th>
                                                <div class="a"><h5><strong>Alterar Imagem</strong></h5></div>
                                            </th>
                                            <th>
                                                <div class="a"><h5><strong>N° Pagina</strong></h5></div>
                                            </th>
                                            <th>
                                                <div class="a"><h5><strong>Qtd Fotos</strong></h5></div>
                                            </th>
                                            <th><h5><strong>Bloqueio?</strong></h5></th>
                                            <th>
                                                <div class="a"><h5><strong>Ação</strong></h5></div>
                                            </th>
                                        </tr>
                                        </thead>
                                        <tbody>
																				...
																				<?php
																				$sql_imagens = mysqli_query($con, "select * from produtos_exclusive_itens where id_produtoexclusive = '$id' order by npagina ASC");
																				$i = 0;
																				while ($vetor_imagens = mysqli_fetch_array($sql_imagens)) {
																					?>

                                            <form action="recebe_alterarfotoprodutoexclusive.php?id=<?php echo $id; ?>"
                                                ...
                                                <tr>
                                                    <td style="vertical-align: middle"><img
                                                                src="arquivos/<?php echo $vetor_imagens['imagem']; ?>"
                                                                width="420px"></td>
                                                    <td align="center" style="vertical-align: middle">
                                                        <button type='button'
                                                                style="display:block;width:120px; height:30px;"
                                                                class="btn btn-outline-dark"
                                                                onclick="document.getElementById('getFile<?php echo $vetor_imagens['id_item']; ?>').click()">
                                                            Nova
                                                            Imagem
                                                        </button>
                                                        <input type="file"
                                                               id="getFile<?php echo $vetor_imagens['id_item']; ?>"
                                                               style="display:none" name="imagem">
                                                    </td>
                                                    <td style="vertical-align: middle"><input type="number"
                                                                                              name="npagina1"
                                                                                              value="<?php echo $vetor_imagens['npagina']; ?>">
                                                    </td>
                                                    <td style="vertical-align: middle"><input type="number"
                                                                                              name="qtdfotos"
                                                                                              value="<?php echo $vetor_imagens['qtdfotos']; ?>">
                                                    </td>
                                                    <td style="vertical-align: middle"><select name="bloqueio"
                                                                                               class="form-control">
                                                            <option value="1"
                                                    ...
                                                    <td style="vertical-align: middle">
                                                        <button type="submit" class="btn btn-info mesmo-tamanho"
                                                                title="Salvar"><i class="fa fa-save"></i></button>
                                                        <a href="excluirimagemprodutoexclusive.php?id=<?php echo $vetor_imagens['id_item']; ?>&id1=<?php echo $id; ?>">
                                                            <button type="button" class="btn btn-danger mesmo-tamanho"
                                                                    title="Excluir"><i class="mdi mdi-window-close"></i>
                                                            </button>
                                                        </a>
                                                    </td>
                                                </tr>
