...
if ($_SESSION['id'] == NULL) {
    ...
    $sql = mysqli_query($con, "select * from pacotes_itens_album where id_item = '$id'");
    $vetor = mysqli_fetch_array($sql);

    $sql_pacote = mysqli_query($con, "select * from pacotes where id_pacote = '$vetor[id_pacote]'");
    $vetor_pacote = mysqli_fetch_array($sql_pacote);

    $sql_eventos = mysqli_query($con, "select * from categoriaevento a, eventos_turma_lista b where a.id_categoria = b.id_evento and b.id_turma = '$vetor_pacote[id_turma]'");
                        ...
                        <div class="d-flex align-items-center">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item">Alterar Pacote</a></li>
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                <form action="recebe_eventopacote.php?id=<?php echo $id; ?>&id1=<?php echo $id1; ?>" method="post"
