            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title">Exclusão de Qtd Formando</h4>
                                ...
                                <tr style="    background: #FF6600; color: #fff;">
                                  ...
                                  <th width="15%">Ação</th> 
                                         ...
                                         <tr>
                                              <td><?php echo $vetor_contrato['ncontrato']; ?> - <?php echo $vetor_curso_inicio['nome']; ?> <?php echo $vetor_contrato['ano']; ?> <?php echo $vetor_instituicao_inicio['nome']; ?> - <?php echo $vetor_evento['nome']; ?></td>
                                              <td><a href="excluirescolhadefotosturma.php?id=<?php echo $id; ?>"><button type="button" class="btn btn-inline btn-danger">Sim</button></a> <a href="afFotografia_topfotos.php"><button type="button" class="btn btn-inline btn-success">Não</button></a></td>
                                          </tr>
