                        ...
                        <div class="d-flex align-items-center">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active" aria-current="page">HDs</li>
                                </ol>
                            </nav>
                        </div>
                    </div>
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <form action="recebe_alterarhd.php?id=<?php echo $id; ?>" method="post" name="cliente" enctype="multipart/form-data" onSubmit="return verificarCPF()" id="formID">
                    
                                    <div class="row">
                                                <div class="col-lg-6">
                                      <fieldset class="form-group">
                                        <label class="form-label semibold" for="exampleInput">Contrato</label>
                                        <select name="ncontrato" class="form-control">
                                              ...
                                              ?>
                                              <option value="<?php echo $vetor_curso['id_turma']; ?>" <?php if (strcasecmp($vetor['ncontrato'], $vetor_curso['id_turma']) == 0) : ?>selected="selected"<?php endif; ?>><?php echo $vetor_curso['ncontrato'] ?> - <?php echo $vetor_curso['nome'] ?> <?php echo $vetor_curso['ano']; ?> <?php echo $vetor_instituicao_inicio['sigla']; ?></option>
                                              <?php } ?>
                                            </select>
                                      </fieldset>
                                    </div>
                                      ...
                                      <div class="col-lg-6">
                                                    <fieldset class="form-group">
                                                        <label class="form-label semibold" for="exampleInput">N° HD</label>
                                                        <input type="number" name="nhd" value="<?php echo $vetor['nhd']; ?>" class="form-control" id="exampleInput" placeholder="Digite o N°" required>
                                                    </fieldset>
                                                </div>
                                            </div><!--.row-->
                                    ...
                                    <div class="row">
                                      ...
                                      <fieldset class="form-group">
                                        ...
                                        <input type="text" name="marca" value="<?php echo $vetor['marca']; ?>" class="form-control" id="exampleInput" placeholder="Digite a Marca" required>
                                      </fieldset>
                                    </div>
                                      ...
                                      <div class="col-lg-4">
                                        <fieldset class="form-group">
                                          ...
                                          <input type="text" name="nserie" value="<?php echo $vetor['nserie']; ?>" class="form-control" id="exampleInput" placeholder="Digite o N°" required>
                                        </fieldset>
                                      </div>
                                      ...
                                      <div class="col-lg-4">
                                        <fieldset class="form-group">
                                          ...
                                          <input type="text" name="tamanho" value="<?php echo $vetor['tamanho']; ?>" class="form-control" id="exampleInput" placeholder="Digite o Tamanho" required>
                                        </fieldset>
                                      </div>
