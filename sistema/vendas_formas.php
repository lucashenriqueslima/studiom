...
<!--                                  <h4 class="card-title">Formas de Pagamento</h4>-->
																...
																}else { ?><a href="cadastroformapag.php">
                                    <button type="button" class="btn waves-effect waves-light btn-warning">Nova Forma de
                                        Pagamento
                                    </button>
                                </a>
                                  ...
                                  <div class="table-responsive">
                                      <table id="lang_opt" class="table table-striped table-bordered display"
                                          ...
                                          <tbody>
																					<?php
																					$sql_atual = mysqli_query($con, "select * from formaspag where status='1' order by nome ASC");
																					while ($vetor = mysqli_fetch_array($sql_atual)) {
																						?>
                                              <tr>
                                                  <td><?php echo $vetor['id_forma']; ?></td>
                                                  <td><?php echo $vetor['nome']; ?></td>
                                                  <td><a class="fancybox fancybox.ajax"
                                                         href="alterarformapag.php?id=<?php echo $vetor['id_forma']; ?>"
                                                         target="_blank">
                                                          <button type="button" class="btn btn-success mesmo-tamanho"
                                                                 ...
                                                                 href="confexcluirformapag.php?id=<?php echo $vetor['id_forma']; ?>">
