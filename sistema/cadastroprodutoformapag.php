                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <form action="recebe_produtoformapag.php?id=<?php echo $id; ?>" method="post" name="cliente" enctype="multipart/form-data" onSubmit="return verificarCPF()" id="formID">
                                        ...
                                        <div class="row">
                                          ...
                                          <div class="col-lg-3">
                                            <fieldset class="form-group">
                                              ...
                                              <input type="text" name="qtdparcelas[]" class="form-control" value="" required >
                                            </fieldset>
                                          </div>

                                            <div class="col-lg-3" >
                                                <fieldset class="form-group" style="color: red;">
                                                  <label class="form-label semibold" for="exampleInput">Vencimento Fixo?</label>
                                            ...
                                            <div class="col-lg-3">
                                                <fieldset class="form-group" style="color: red;">
                                                  <label class="form-label semibold" for="exampleInput">Data Vencimento</label>
                                                  <input type="date" name="datavencimento[]" value="" class="form-control" style="color: red;">
                                                </fieldset>
                                            </div>
