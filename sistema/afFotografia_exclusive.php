...
<!--                                  <h4 class="card-title">Exclusive</h4>-->
                                  ...
                                  <ul class="nav nav-tabs" role="tablist">
                                      ...
                                      <li class="nav-item"><a class="nav-link active" data-toggle="tab"
                                                          ...
                                                          class="ti-email"></i></span> <span class="hidden-xs-down">Exclusive Formando</span></a>
                                      </li>
                                      <li class="nav-item"><a class="nav-link" data-toggle="tab"
                                                              href="#exclusiveformando"
                                                              role="tab"><span class="hidden-sm-up"><i
                                                          class="ti-email"></i></span> <span class="hidden-xs-down">Exclusive Turma</span></a>
                                      </li>

                                  </ul>
                                  <div class="tab-content tabcontent-border">
                                      <div class="tab-pane active" id="exclusiveturma" role="tabpanel">
                                          <br>
																				
																				<?php if ($vetor_permissao['cadastro'] == 1) {
																				}else { ?><a href="cadastrar_exclusive.php">
                                          ...
                                          <div class="table-responsive">
                                              <table id="lang_opt" class="table table-striped table-bordered display"
                                                  ...
                                                  <tbody>
																									<?php
																									$sql_atual = mysqli_query($con, "select * from convite_exclusive order by id_exclusive DESC");
                                                          ...
                                                          <td><a class="fancybox fancybox.ajax"
                                                                 ...
                                                                 target="_blank">
                                                                  <button type="button"
                                                                         ...
                                                                         href="confexcluirexclusive.php?id=<?php echo $vetor['id_exclusive']; ?>">
                                                                      <button type="button"
                                      ...
                                      <div class="tab-pane" id="exclusiveformando" role="tabpanel">
                                          <br>
																				<?php if ($vetor_permissao['cadastro'] == 1) {
																				}else { ?><a href="cadastrar_produtoexclusive.php">
                                            <button type="button" class="btn waves-effect waves-light btn-warning">Novo
                                                Produto
                                            </button>
                                        </a>
                                          ...
                                          <div class="table-responsive">
                                              <table id="lang_opt2" class="table table-striped table-bordered display"
                                                  ...
                                                  <tr>
                                                      ...
                                                      <th>Produto</th>
                                                      <th>Data (inserção no sistema)</th>
                                                      <th>Data Final Aprovação</th>
                                                      <th width="10%">Ação</th>
                                                  </tr>
                                                  </thead>
                                                  <tbody>
																									<?php
																									$sql_atual = mysqli_query($con, "select * from produtos_exclusive order by id_produtoexclusive DESC");
																									while ($vetor = mysqli_fetch_array($sql_atual)) {
                                                      ...
                                                      <tr>
                                                          ...
                                                          <td><?php echo date('d/m/Y', strtotime($vetor['datafinal'])); ?></td>
                                                          <td><a class="fancybox fancybox.ajax"
                                                                 href="alterarprodutoexclusive.php?id=<?php echo $vetor['id_produtoexclusive']; ?>"
                                                                 target="_blank">
                                                                  <button type="button"
                                                                          class="btn btn-success mesmo-tamanho"
                                                                          title="Ver ou Alterar Cadastro"><i
                                                                         ...
                                                                         href="confexcluirprodutoexclusive.php?id=<?php echo $vetor['id_produtoexclusive']; ?>">
                                                                      <button type="button"
                                                                              class="btn btn-danger mesmo-tamanho"
                                                                              title="Excluir Cadastro"><i
                                                                                  class="mdi mdi-window-close"></i>
      ...
      <script type="text/javascript">
          ...
          var init_data_Table2 = function () {
              var tabelaNcms = null;
              if ($.fn.dataTable.isDataTable2('#lang_opt2')) {
