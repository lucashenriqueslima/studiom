...
if ($_SESSION['id'] == null) {
	...
	if ($vetor_permissao['listar'] == 2) {
		...
		$sql = mysqli_query($con, "SELECT * FROM escolha_fotos_tratamento WHERE id_formando = '$id_formando' and id_evento = '$id_evento'");
		?>
      <!DOCTYPE html>
                          ...
                          <div class="d-flex align-items-center">
                              <nav aria-label="breadcrumb">
                                  <ol class="breadcrumb">
                                      ...
                                      <li class="breadcrumb-item">Fotos Escolhidas</a></li>
                                      <li class="breadcrumb-item active" aria-current="page">Alterar Fotos Escolhidas
                                      </li>
                                  </ol>
                              </nav>
                          </div>
              ...
              <div class="container-fluid">
                  ...
                  <div class="row">
                      <div class="col-12">
                          <div class="card">
                              <div class="card-body">
                                  <!--                                  <h4 class="card-title">Escolha de Fotos - Top Fotos</h4>-->

                                  <div class="row">
																		
																		<?php
																		while ($vetor = mysqli_fetch_array($sql)) {
																			$imagem = explode("/", $vetor['foto']);
																			?>
                                        ...
                                        <div class="col-md-2">
                                            ...
                                            <div class="thumbnails grid">
                                                ...
                                                <a class="image-popup-vertical-fit"
                                                   href="<?php echo $vetor['foto']; ?>"><img
                                                            src="<?php echo $vetor['foto']; ?>" alt=""></a>
                                            ...
                                            <div>
																							...
																							<?php
																							echo $imagem[count($imagem)-1];
																							?>

                                                <br>

                                                Observações: <?php echo $vetor['observacoes']; ?>
