...
if ($_SESSION['id'] == null) {
	...
	$id = $_GET['id'];
	$sql = mysqli_query($con, "select * from meu_convite_turma where id_meuconvite = '$id'");
                        ...
                        <div class="d-flex align-items-center">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item">Convites Contratos</a></li>
                                    <li class="breadcrumb-item active" aria-current="page">Alterar Contrato de Convite</li>
                                </ol>
                            </nav>
                        </div>
                    </div>
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
<!--                                <h4 class="card-title">Cadastro de Convites Contrato</h4>-->

                                <form action="recebe_alterarconvitecontrato.php?id=<?php echo $id; ?>" method="post"
                                ...
                                <table width="100%" class="table table-bordered table-striped">
                                    ...
                                    <tbody>
																		...
																		<?php
																		$sql_imagens = mysqli_query($con, "select * from meu_convite_paginas_turma where id_meuconvite = '$id' order by npagina ASC");
																		$i = 0;
																		while ($vetor_imagens = mysqli_fetch_array($sql_imagens)) {
																			?>

                                        <form action="recebe_alterarfotoconvitecontrato.php?id=<?php echo $id; ?>"
                                            ...
                                            <tr>
                                                ...
                                                <td><input type="number" name="npagina1"
                                                           value="<?php echo $vetor_imagens['npagina']; ?>" required="">
                                                </td>
                                                <td><?php echo $vetor_imagens['descricao']; ?></td>
                                                <td><?php echo $vetor_imagens['legenda']; ?></td>
                                                <td><?php switch($vetor_imagens['status']){
                                                        case '1':
                                                            echo "Em Aberto";
                                                            break;
                                                        case '2':
                                                ...
                                                <td>
                                                    <button type="submit" class="btn btn-info"
                                                            title="Ver ou Alterar Cadastro"><i class="fa fa-edit"></i></button>
                                        </form> <a
                                                href="excluirimagemconvitecontrato.php?id=<?php echo $vetor_imagens['id_pagina']; ?>&id1=<?php echo $id; ?>">
