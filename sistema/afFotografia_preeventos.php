...
<!--                                  <h4 class="card-title">Pré-Eventos</h4>-->
																...
																}else { ?><a href="cadastrar_preevento.php">
                                  ...
                                  <div class="table-responsive">
                                      <table id="lang_opt" class="table table-striped table-bordered display"
                                          ...
                                          <tbody>
																					<?php
																					$sql_atual = mysqli_query($con, "select * from preeventos order by id_pre ASC");
																					while ($vetor = mysqli_fetch_array($sql_atual)) {
																						...
																						?>
                                              <tr>
                                                  <td><?php echo $vetor['id_pre']; ?></td>
                                                  <td><?php echo $vetor_contrato['ncontrato'] ?>
                                                      - <?php echo $vetor_contrato['nome'] ?> <?php echo $vetor_contrato['ano']; ?> <?php echo $vetor_instituicao_inicio['sigla']; ?></td>
                                                  <td><?php echo $vetor['titulo']; ?></td>
                                                  <td><a class="fancybox fancybox.ajax"
                                                         href="alterarpreevento.php?id=<?php echo $vetor['id_pre']; ?>"
                                                         target="_blank">
                                                          <button type="button" class="btn btn-success mesmo-tamanho"
                                                                 ...
                                                                 href="confexcluirpreevento.php?id=<?php echo $vetor['id_pre']; ?>">
