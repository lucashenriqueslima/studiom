<?php
    ...
    $sql = mysqli_query($con, "select * from dadosconvite where id_dados = '$id'");
    $vetor = mysqli_fetch_array($sql);

    $sql_itens = mysqli_query($con, "select * from tipos_arquivos_turma where id_tipo = '$vetor[id_tipo]'");
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title">Exclusão de Personal</h4>
                                ...
                                <tr style="    background: #FF6600; color: #fff;">
                                  ...
                                  <th width="15%">Ação</th> 
                                         ...
                                         <tr>
                                              ...
                                              <td><a href="excluirverarquivoconviteformando.php?id=<?php echo $id; ?>&id1=<?php echo $id1; ?>"><button type="button" class="btn btn-inline btn-danger">Sim</button></a> <a href="verarquivoconvite.php?id=<?php echo $id1; ?>"><button type="button" class="btn btn-inline btn-success">Não</button></a></td>   
                                          </tr>
