                          ...
                          <div class="card">
                              <div class="card-body">
                                  <!--                                  <h4 class="card-title">Álbum</h4>-->
																...
																}else { ?><a href="cadastrar_escolhafoto.php">
                                  ...
                                  <div class="table-responsive">
                                      <table id="lang_opt" class="table table-striped table-bordered display"
                                          ...
                                          <tbody>
																					<?php
																					$sql_atual = mysqli_query($con, "select * from escolha_fotos order by id_escolha DESC");
                                                  ...
                                                  <td><a class="fancybox fancybox.ajax"
                                                         ...
                                                         target="_blank">
                                                          <button type="button" class="btn btn-success mesmo-tamanho"
                                                                 ...
                                                                 href="confexcluirescolhafoto.php?id=<?php echo $vetor['id_escolha']; ?>">
