...
$sql_exclui1 = mysqli_query($con, "delete FROM orcamento_itens where id_item = '$id2'");
...
$vetor_orcamento = mysqli_fetch_array($sql_orcamento);
	...
	if($vetor_tributos1['tipo'] == 1) {
	 ...
	 echo "<script> window.location.href='alterarproducoorcconvite.php?id=$id&id1=$id1'</script>";
