                      ...
                      <div class="col-12">
                          <div class="card">
                              <div class="card-body">
																...
																}else { ?><a href="cadastrar_instituicao.php">
                                  ...
                                  <div class="table-responsive">
                                      <table id="lang_opt" class="table table-striped table-bordered display"
                                          ...
                                          <tbody>
																					<?php
																					$sql_atual = mysqli_query($con, "select * from instituicoes order by nome ASC");
                                              ...
                                              <tr>
                                                  ...
                                                  <td><a class="fancybox fancybox.ajax"
                                                         href="alterarinstituicao.php?id=<?php echo $vetor['id_instituicao']; ?>"
                                                         target="_blank">
                                                          <button type="button" class="btn btn-success mesmo-tamanho"
                                                                 ...
                                                                 href="confexcluirinstituicao.php?id=<?php echo $vetor['id_instituicao']; ?>">
