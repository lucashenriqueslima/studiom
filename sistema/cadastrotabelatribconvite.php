                        ...
                        <div class="d-flex align-items-center">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item">Tributos</a></li>
                                    <li class="breadcrumb-item active" aria-current="page">Cadastrar Tabela</li>
                                </ol>
                            </nav>
                        </div>
                    </div>
...
<!--                                <h4 class="card-title">Cadastro de Tabela</h4>-->
                                ...
                                <form action="recebe_tabelatribconvite.php" method="post" name="cliente"
