...
<!--                                  <h4 class="card-title">Vendas Avulsas</h4>-->
																...
																}else { ?><a href="cadastrovendaavulsa.php">
                                    <button type="button" class="btn waves-effect waves-light btn-warning">Novo Venda
                                        Avulsa
                                    </button>
                                </a>
                                      ...
                                      <table id="lang_opt" class="table table-striped table-bordered display"
                                          ...
                                          <tbody>
                                              ...
                                              <tr>
                                                  ...
                                                  <td><?php $valorapagar = $vetor['valor'] - $vetor['valorentrada'];
																										echo $num = number_format($valorapagar, 2, ',', '.'); ?></td>
                                                  ...
                                                  <td><?php if ($vetor['status'] == 1) { ?><a
                                                          class="fancybox fancybox.ajax"
                                                          href="alterarvendaavulsa.php?id=<?php echo $vetor['id_avulsa']; ?>"
                                                          target="_blank">
                                                              <button type="button"
                                                                   ...
                                                                   href="confexcluirvendaavulsa.php?id=<?php echo $vetor['id_avulsa']; ?>">
                                                                  <button type="button"
