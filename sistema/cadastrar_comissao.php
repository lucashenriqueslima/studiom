            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                <form action="recebe_comissao.php" method="post" name="cliente"
                                    ...
                                    <div class="row">
                                        <div class="col-lg-6">
                                            <fieldset class="form-group">
                                                <label class="form-label semibold" for="exampleInput">Base de Cálculo</label>
                                                <select name="base" class="form-control" required>
                                                    ...
                                                    <option value="percentual">Percentual do Valor Cobrado</option>
                                                </select>
                                            </fieldset>
                                        </div>
                                    </div>
