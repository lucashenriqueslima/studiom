<?php
  ...
  $id = $_GET['id'];
  $id1 = $_GET['id1'];
  $sql = mysqli_query($con, "select * from jobs_departamentos WHERE id_job_dep = '$id' AND id_job = '$id1'");
    ...
    <section class="content">
      <div class="row">
        <div class="col-xs-12">
          <div class="box">
            <div class="box-header">
              <h3 class="box-title">Cadastro de Tipo de JOB</h3>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
            
            <form action="recebe_alterartipojobitem.php?id=<?php echo $id; ?>&id1=<?php echo $id1; ?>" method="post" name="cliente" enctype="multipart/form-data" onSubmit="return verificarCPF()" id="formID">
        ...
        <div class="row">
          ...
          <div class="col-lg-4">
            <fieldset class="form-group">
              ...
              <select name="id_departamento" class="form-control">
                   ...
                   $sql_departamentos = mysqli_query($con, "select * from departamentos where pcp = '2' order by nome ASC");

                    while ($vetor_departamentos=mysqli_fetch_array($sql_departamentos)) { 

                    ?>
                    <option value="<?php echo $vetor_departamentos['id_departamento']; ?>" <?php if (strcasecmp($vetor['id_departamento'], $vetor_departamentos['id_departamento']) == 0) : ?>selected="selected"<?php endif; ?>><?php echo $vetor_departamentos['nome'] ?></option>
                    <?php } ?>
                  </select>
            </fieldset>
          </div>
          ...
          <div class="col-lg-4">
            <fieldset class="form-group">
              <label class="form-label semibold" for="exampleInput">Dias Úteis</label>
              <input type="number" name="qtddia" value="<?php echo $vetor['qtddia']; ?>" class="form-control">
            </fieldset>
          </div>

          <div class="col-lg-4">
            <fieldset class="form-group">
              <label class="form-label semibold" for="exampleInput">Posição no PCP</label>
              <input type="number" name="posicao" value="<?php echo $vetor['posicao']; ?>" class="form-control" required="">
            </fieldset>
          </div>
