<?php
    ...
    $sql_tabela = mysqli_query($con, "select * from tabela_fotografia where id_tabela = '$vetor[id_funcao]'");
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title">Exclusão de Escala de Profissional</h4>
                                ...
                                <tr style="    background: #FF6600; color: #fff;">
                                  ...
                                  <th width="15%">Ação</th> 
                                         ...
                                         <tr>
                                              ...
                                              <td><a href="excluirescalaprofissional.php?id=<?php echo $id; ?>&id1=<?php echo $id1; ?>"><button type="button" class="btn btn-inline btn-danger">Sim</button></a> <a href="alterarplanejamentoevento.php?id=<?php echo $id1; ?>"><button type="button" class="btn btn-inline btn-success">Não</button></a></td>   
                                          </tr>
