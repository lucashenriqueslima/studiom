            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title">Exclusão de Perfil</h4>
                                ...
                                <tr style="    background: #FF6600; color: #fff;">
                                  ...
                                  <th width="15%">Ação</th> 
                                         ...
                                         <tr>
                                              ...
                                              <td><a href="excluirperfil.php?id=<?php echo $id; ?>"><button type="button" class="btn btn-inline btn-danger">Sim</button></a> <a href="listarperfil.php"><button type="button" class="btn btn-inline btn-success">Não</button></a></td>   
                                          </tr>
