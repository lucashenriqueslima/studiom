<?php
    ...
    $sql = mysqli_query($con, "select * from departamentos where id_departamento = '$id'");
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title">Ver ou Alterar Cadastro de Departamentos</h4>

                                <form action="recebe_alterardepartamento.php?id=<?php echo $id; ?>" method="post" name="cliente" enctype="multipart/form-data" onSubmit="return verificarCPF()" id="formID">
                                ...
                                <div class="row">
                                  ...
                                  <div class="col-md-4">
                                      <div class="form-group">
                                        ...
                                        <input type="color" name="corcalendario" value="<?php echo $vetor['corcalendario']; ?>" required="">
                                      </div>
                                  </div>
                                  <div class="col-md-4">
                                      <div class="form-group">
                                ...
                                <div class="row">
                                    ...
                                    <div class="form-group">
                                    <label>Tem PCP?</label>
                                    <select name="pcp" id="tipobusca" class="form-control">
                                    
                                    <option value="1" <?php if (strcasecmp($vetor['pcp'], '1') == 0) : ?>selected="selected"<?php endif; ?>>Não</option>
                                    <option value="2" <?php if (strcasecmp($vetor['pcp'], '2') == 0) : ?>selected="selected"<?php endif; ?>>Sim</option>
                                  ...
                                  <div class="col-md-6">
                                      <div class="form-group">
                                        <label>Posição</label>
                                        <input type="number" name="posicao" value="<?php echo $vetor['posicao']; ?>" class="form-control">
                                      </div>
                                  </div>
