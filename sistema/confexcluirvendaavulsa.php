            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title">Exclusão de Venda Avulsa</h4>
                                ...
                                <tr style="    background: #FF6600; color: #fff;">
                                  ...
                                  <th width="15%">Ação</th> 
                                         ...
                                         <tr>
                                              ...
                                              <td><a href="excluirvendaavulsa.php?id=<?php echo $id; ?>&id_formando=<?php echo $vetor[id_formando]; ?>"><button type="button" class="btn btn-inline btn-danger">Sim</button></a> <a href="vendas_avulsas.php?id_formando=<?php echo $vetor[id_formando]; ?>"><button type="button" class="btn btn-inline btn-success">Não</button></a></td>
                                          </tr>
