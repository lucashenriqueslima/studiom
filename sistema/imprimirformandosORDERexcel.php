                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <form action="imprimirformandosexcel.php?id=<?php echo $id; ?>" method="POST" target="_blank">
                                ...
                                <table class="table table-bordered">
                                    ...
                                    <tr style="    background: #FF6600; color: #fff;">
                                      ...
                                      <th width="15%">Ação</th> 
                                             ...
                                             <tr>
                                                  <td><select name="order" class="form-control">
                                                    <option value="order by nome ASC">Nome Crescente</option>
                                                    <option value="order by nome DESC">Nome Decrescente</option>
                                                    <option value="order by id_cadastro ASC">Código Crescente</option>
                                                    <option value="order by id_cadastro DESC">Código Decrescente</option>
                                                  </select></td>
                                                  <td><button type="submit" class="btn btn-inline btn-danger">Imprimir</button></form> <a href="alterarturma.php?id=<?php echo $id; ?>"><button type="button" class="btn btn-inline btn-success">Voltar</button></a></td>  
                                              </tr>
