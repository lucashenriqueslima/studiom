<?php
    ...
    $sql = mysqli_query($con, "select * from pacotes_itens_produtos where id_produto_item = '$id'");
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title">Cadastro de Produto Pacote</h4>

                                <form action="recebe_alterarprodutopacotealbum.php?id=<?php echo $id; ?>&id1=<?php echo $id1; ?>" method="post" name="cliente" enctype="multipart/form-data" onSubmit="return verificarCPF()" id="formID">

                                <div class="row">

                                  <div class="col-lg-4">
                                    <fieldset class="form-group">
                                      <label class="form-label semibold" for="exampleInput">Produtos</label>
                                      <select name="id_produto" class="form-control">
                                            ...
                                            ?>
                                            <option value="<?php echo $vetor_produto['id_tipo']; ?>" <?php if (strcasecmp($vetor['id_produto'], $vetor_produto['id_tipo']) == 0) : ?>selected="selected"<?php endif; ?>><?php echo $vetor_produto['nome'] ?></option>
                                            <?php } ?>
                                          </select>
                                    </fieldset>
                                  </div>
                                  ...
                                  <div class="col-lg-4">
                                    <fieldset class="form-group">
                                      ...
                                      <input type="text" name="valor" class="form-control" value="<?php echo $num = number_format($vetor['valor'],2,',','.'); ?>" id="exampleInput" placeholder="Valor Pagamento" onKeyPress="mascara(this,mvalor)" required>
                                    </fieldset>
                                  </div>

                                  <div class="col-lg-4">
                                    <fieldset class="form-group">
                                      <label class="form-label semibold" for="exampleInput">Quantidade de Paginas</label>
                                      <input type="number" name="qtdpaginas" class="form-control" value="<?php echo $vetor['qtdpaginas']; ?>" id="exampleInput" placeholder="Quantidade de Paginas">
                                    </fieldset>
                                  </div>
