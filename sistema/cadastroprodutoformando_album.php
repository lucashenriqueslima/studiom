                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <form action="recebe_produtoformando.php" method="post" name="cliente" enctype="multipart/form-data" onSubmit="return verificarCPF()" id="formID">

                                    <input type="hidden" name="id_turma" value="<?php echo $id_turma; ?>">
                                    <input type="hidden" name="id_formando" value="<?php echo $id_formando; ?>">
                                    ...
                                    <div class="row">
                                      ...
                                      <div class="col-lg-6">
                                        <fieldset class="form-group">
                                          ...
                                          <input type="number" name="qtd" class="form-control" placeholder="Qtd de Páginas do Álbum" required="">
                                        </fieldset>
                                      </div>
