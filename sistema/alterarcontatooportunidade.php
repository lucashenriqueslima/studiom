<?php
    ...
    $sql = mysqli_query($con, "select * from contatos_oportunidade where id_contato = '$id'");
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title">Cadastro de Contato Oportunidade</h4>

                                <form action="recebe_alterarcontatooportunidade.php?id=<?php echo $id; ?>&id1=<?php echo $id1; ?>" method="post" name="cliente" enctype="multipart/form-data" onSubmit="return verificarCPF()" id="formID">
