<?php
    ...
    $id = $_GET['id'];
    $sql = mysqli_query($con, "select * from sub_categorias where id_sub = '$id'");
                        ...
                        <div class="d-flex align-items-center">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active" aria-current="page">Status Categorias CRM</li>
                                </ol>
                            </nav>
                        </div>
                    </div>
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title">Cadastro de Status Categoria CRM</h4>

                                <form action="recebe_alterarstatus.php?id=<?php echo $id; ?>" method="post" name="cliente" enctype="multipart/form-data" onSubmit="return verificarCPF()" id="formID">
                                <div class="row">
                                    <div class="col-lg-4">
                                        <fieldset class="form-group">
                                            <label class="form-label semibold" for="exampleInput">Categoria</label>
                                            <select name="id_categoria" id="exampleSelect" class="form-control" required>
                                              <?php while ($vetor_categoria=mysqli_fetch_array($sql_categorias)) { ?>
                                              <option label="<?php echo $vetor_categoria['nome']; ?>" value="<?php echo $vetor_categoria['id_categoria']; ?>" <?php if (strcasecmp($vetor['id_categoria'], $vetor_categoria['id_categoria']) == 0) : ?>selected="selected"<?php endif; ?>><?php echo $vetor_categoria['nome']; ?></option>
                                              <?php } ?>
                                            </select>
                                        </fieldset>
                                </div>
                                  ...
                                  <div class="col-lg-4">
                                    <fieldset class="form-group">
                                      ...
                                      <input type="text" name="nome" value="<?php echo $vetor['nome']; ?>" class="form-control">
                                    </fieldset>
                                  </div>

                                  <div class="col-lg-4">
                                    <fieldset class="form-group">
                                      <label class="form-label semibold" for="exampleInput">Posição</label>
                                      <input type="number" name="posicao" value="<?php echo $vetor['posicao']; ?>" class="form-control">
                                    </fieldset>
                                  </div>
                                        </div><!--.row-->

                                <?php if($vetor_permissao['alteracao'] == 1) { } else { ?><button type="submit" class="btn btn-primary"  style="    float: left;">Alterar</button><?php } ?>
