        ...
        <header class="topbar">
            <nav class="navbar top-navbar navbar-expand-md navbar-dark">
                <div class="navbar-header">
                    ...
                    <!-- Logo -->
                    <!-- ============================================================== -->
                    <a class="navbar-brand" href="../arearestrita/dashboard.php">
                        <b class="logo-icon">
                    ...
                    <ul class="navbar-nav float-right">
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <div class="dropdown-menu dropdown-menu-right user-dd animated flipInY">
                                ...
                                <a class="dropdown-item" href="../arearestrita/sair.php"><i class="fa fa-power-off m-r-5 m-l-5"></i> Sair</a>
                            </div>
                        </li>
                        <!-- ============================================================== -->
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                <form action="../arearestrita/recebe_chamado.php" method="post" name="cliente" enctype="multipart/form-data" id="formID">
                                            ...
                                            <div class="col-lg-12">
                                                <fieldset class="form-group">
                                                    ...
                                                    <select name="departamento" class="form-control" required="">
                                                        ...
                                                        $sql_departamentos = mysqli_query($con, "select * from departamentos order by nome ASC");

                                                        while($vetor_departamentos = mysqli_fetch_array($sql_departamentos)) {

                                                        ?>
                                                        <option value="<?php echo $vetor_departamentos['id_departamento']; ?>"><?php echo $vetor_departamentos['nome']; ?></option>
                                                        <?php } ?>
                                                    </select>
                                                </fieldset>
                                            </div>
                                            ...
                                            <div class="col-lg-12">
                                                <fieldset class="form-group">
                                                    ...
                                                    <select name="servico" class="form-control" required="">
                                                        ...
                                                        <option value="Convite" selected="">Convite</option>
                                                    </select>
                                                </fieldset>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row">
                                            <div class="col-lg-12">
                                                <fieldset class="form-group">
                                                    ...
                                                    <input type="text" name="titulo" class="form-control" id="exampleInput" placeholder="Digite o Assunto" required="">
                                                </fieldset>
                                            </div>
                                        </div>
