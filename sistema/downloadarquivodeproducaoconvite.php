...
$res = mysqli_query($con, "SELECT * FROM eventos_arquivos_fotos_convite WHERE id_evento = $id");
$vetor = mysqli_fetch_array($res);

$caminho = "/home/studioms/public_html/sistema/arquivos/fotografia/arquivosdeproducaoconvites/$vetor[pasta]/";
