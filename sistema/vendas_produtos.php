                          ...
                          <div class="card">
                              <div class="card-body">
                                  <!--                                  <h4 class="card-title">Produtos</h4>-->
																...
																}else { ?><a href="vendas_cadastroproduto.php">
                                  ...
                                  <div class="table-responsive">
                                      <table id="lang_opt" class="table table-striped table-bordered display"
                                          ...
                                          <tbody>
																					<?php
																					$sql_atual = mysqli_query($con, "select * from produtos_turma order by id_produto DESC");
                                              ...
                                              <tr>
                                                  ...
                                                  <td><a class="fancybox fancybox.ajax"
                                                         href="alterarproduto.php?id=<?php echo $vetor['id_produto']; ?>"
                                                         target="_blank">
                                                          <button type="button" class="btn btn-success mesmo-tamanho"
                                                                 ...
                                                                 href="confexcluirproduto.php?id=<?php echo $vetor['id_produto']; ?>">
