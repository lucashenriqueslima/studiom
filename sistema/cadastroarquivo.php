            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title">Cadastro de Arquivo para o
                                    Formando: <?php echo $vetor['nome']; ?></h4>

                                <form action="recebe_arquivo.php?id=<?php echo $id; ?>" enctype="multipart/form-data"
                                      method="post">
                                    ...
                                    <div class="row">
                                        <div class="col-lg-6">
                                            <fieldset class="form-group">
                                                <label class="form-label semibold" for="exampleInput">Testemunha 01</label>
                                                <input type="email" name="testemunha01" class="form-control" id="exampleInput" placeholder="E-mail">
                                            </fieldset>
                                        </div>

                                        <div class="col-lg-6">
                                            <fieldset class="form-group">
                                                <label class="form-label semibold" for="exampleInput">E-mail Testemunha 02</label>
                                                <input type="email" name="testemunha02" class="form-control" id="exampleInput" placeholder="E-mail">
                                            </fieldset>
                                        </div>
                                    </div>
                                    -->
