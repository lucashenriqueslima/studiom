...
if($nomeimagem1 == NULL) {
	...
	$sql_update = mysqli_query($con, "update meu_album_paginas SET npagina = '$npagina1', bloqueio='$bloqueio' where id_pagina = '$id_pagina'");

} else {

	$sql_update = mysqli_query($con, "update meu_album_paginas SET npagina = '$npagina1', bloqueio='$bloqueio', imagem = '$imagem1' where id_pagina = '$id_pagina'");
