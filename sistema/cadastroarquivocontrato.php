                        ...
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title">Cadastro de Arquivo para o
                                    Contrato: <?php echo $vetor['ncontrato']; ?></h4>

                                <form action="recebe_arquivocontrato.php?id=<?php echo $id; ?>"
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-12">
                                            <fieldset class="form-group">
                                                <label class="form-label semibold" for="exampleInput">Anexar no E-mail
                                                    de Compra?</label>
                                                <select name="emailcompra" class="form-control">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-12">
                                            <fieldset class="form-group">
                                                <label class="form-label semibold" for="exampleInput">Mostrar para
                                                    comissão?</label>
