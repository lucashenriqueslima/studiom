              ...
              <div class="container-fluid">
                  ...
                  <div class="row">
                      <div class="col-12">
                          <div class="card">
                              <div class="card-body">
<!--                                  <h4 class="card-title">Status Categorias CRM</h4>-->
																
																<?php if ($vetor_permissao['cadastro'] == 1) {
																}else { ?><a href="cadastrar_status.php">
                                    <button type="button" class="btn waves-effect waves-light btn-warning">Novo Status
                                    </button>
                                </a>
                                  ...
                                  <div class="table-responsive">
                                      <table id="lang_opt" class="table table-striped table-bordered display"
                                          ...
                                          <tbody>
																					<?php
																					$sql_atual = mysqli_query($con, "select * from sub_categorias order by id_sub DESC");
																					while ($vetor = mysqli_fetch_array($sql_atual)) {
																						$sql_categoria = mysqli_query($con, "select * from categorias where id_categoria = '$vetor[id_categoria]'");
																						$vetor_categoria = mysqli_fetch_array($sql_categoria);
																						?>
                                              <tr>
                                                  <td><?php echo $vetor['nome']; ?></td>
                                                  <td><?php echo $vetor_categoria['nome']; ?></td>
                                                  <td><?php echo $vetor['posicao']; ?></td>
                                                  <td><a class="fancybox fancybox.ajax"
                                                         href="alterarstatus.php?id=<?php echo $vetor['id_sub']; ?>"
                                                         target="_blank">
                                                          <button type="button" class="btn btn-success mesmo-tamanho"
                                                                 ...
                                                                 href="confexcluirstatus.php?id=<?php echo $vetor['id_sub']; ?>">
