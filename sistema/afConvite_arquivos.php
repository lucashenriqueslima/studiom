              ...
              <div class="container-fluid">
                  ...
                  <div class="row">
                      <div class="col-12">
                          <div class="card">
                              <div class="card-body">
<!--                                  <h4 class="card-title">Arquivo de Convite</h4>-->
                                  ...
                                  <div class="table-responsive">
                                      <table id="lang_opt" class="table table-striped table-bordered display"
                                          ...
                                          <tbody>
																					<?php
																					$sql_atual = mysqli_query($con, "select DISTINCT id_formando from dadosconvite order by id_dados DESC");
																					while ($vetor = mysqli_fetch_array($sql_atual)) {
																						...
																						$sql_dados_convite = mysqli_query($con, "select * from dadosconvite where id_formando = '$vetor_formando[id_formando]' AND id_turma = '$vetor_formando[turma]'");
																						$vetor_dados_convite = mysqli_fetch_array($sql_dados_convite);
																						$sqlstatus = mysqli_query($con, "select * from vendas
                                                        where id_formando = '$vetor[id_formando]' 
                                                        and tipo = '1' 
                                                        and iniciada = '2' 
                                                        and aceite = '2'
                                                        ");
																						$vetor_status_formando = mysqli_fetch_array($sqlstatus);
																						?>
                                              <tr>
                                                  ...
                                                  <td><?= $vetor_formando["id_formando"]." - ".$vetor_formando["nome"] ?></td>
                                                  <td><?php if (isset($vetor_status_formando["id_formando"])) {
																											echo "Sim";
																										}else {
																											echo "Não";
																										} ?></td>
                                                  <td><a class="fancybox fancybox.ajax"
                                                         href="verarquivoconvite.php?id=<?php echo $vetor['id_formando']; ?>"
                                                         target="_blank">
                                                          <button type="button" class="btn btn-success mesmo-tamanho"
                                                                 ...
                                                                 href="confexcluirarquivoconvite.php?id=<?php echo $vetor['id_formando']; ?>">
