<?php
    ...
    $sql_produto = mysqli_query($con, "select * from produtos_formando where id_turma = '$id_turma' and id_formando = '$id_formando'");
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title">Remessa Vendedor: <?php echo $vetor_vendedor['nome']; ?></h4>

                                <?php if($vetor_permissao['cadastro'] == 1) { } else { ?><a href="cadastroprodutoformando.php"><button type="button" class="btn waves-effect waves-light btn-warning">Novo Produto</button></a>
                                    ...
                                    <table id="lang_opt" class="table table-striped table-bordered display" style="width:100%">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td><?php if($vetor['status'] == 1) { ?><a class="fancybox fancybox.ajax" href="alterarprodutoop.php?id=<?php echo $vetor['id_produto']; ?>" target="_blank"><button type="button" class="btn btn-success mesmo-tamanho" title="Ver ou Alterar Cadastro"><i class="mdi mdi-tooltip-edit"></i></button></a> <?php } if($vetor_permissao['exclusao'] == 1) { } else { if($vetor['totalreal'] == NULL) { ?><a class="fancybox fancybox.ajax" href="confexcluirprodutoop.php?id=<?php echo $vetor['id_produto']; ?>"><button type="button" class="btn btn-danger mesmo-tamanho" title="Excluir Cadastro"><i class="mdi mdi-window-close"></i></button></a><?php } } ?></td>
                                            </tr>
                                            <?php } ?>
                                        </tbody>
                                    </table>
