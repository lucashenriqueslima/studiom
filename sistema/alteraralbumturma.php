...
if ($_SESSION['id'] == null) {
	...
	$id = $_GET['id'];
	$sql = mysqli_query($con, "select * from meu_album_turma where id_meualbum = '$id'");
                        ...
                        <div class="d-flex align-items-center">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item">Produtos Turma</a></li>
                                    <li class="breadcrumb-item active" aria-current="page">Alterar Produto da Turma</li>
                                </ol>
                            </nav>
                        </div>
                    </div>
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
<!--                                <h4 class="card-title">Cadastro de Produtos Turma</h4>-->

                                <form action="recebe_alteraralbumturma.php?id=<?php echo $id; ?>" method="post"
                                ...
                                <table width="100%" class="table table-bordered table-striped">
                                    ...
                                    <tbody>
																		...
																		<?php
																		$sql_imagens = mysqli_query($con, "select * from meu_album_paginas_turma where id_meualbum = '$id' order by npagina ASC");
																		$i = 0;
																		while ($vetor_imagens = mysqli_fetch_array($sql_imagens)) {
																			?>

                                        <form action="recebe_alterarfotoalbumturma.php?id=<?php echo $id; ?>"
                                            ...
                                            <tr>
                                                <td><img src="arquivos/turmas/<?php echo $vetor_imagens['imagem']; ?>"
                                                         width="420px"></td>
                                                <td>
                                                    ...
                                                    <input type="file" id="getFile_<?php echo $i; ?>"
                                                           style="display:none" name="imagem" required></td>
                                                ...
                                                href="excluirimagemalbumturma.php?id=<?php echo $vetor_imagens['id_pagina']; ?>&id1=<?php echo $id; ?>">
                                            <button type="button" class="btn btn-danger mesmo-tamanho"
                                                    title="Excluir Cadastro"><i class="fa fa-close"></i></button>
                                        </a></td>
                                        </tr>
