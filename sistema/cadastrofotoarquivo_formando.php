<?php
    ...
    $vetor_formando = mysqli_fetch_array($sql);
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title">Cadastro de Tipo de Arquivo</h4>

                                <form action="recebe_fotoarquivoformando.php?id=<?php echo $id; ?>" method="post" name="cliente" enctype="multipart/form-data" onSubmit="return verificarCPF()" id="formID">
                                ...
                                <div class="row">
                                  ...
                                  <div class="col-lg-12">
                                    <fieldset class="form-group">
                                      <label class="form-label semibold" for="exampleInput">Tipo de Arquivo</label>
                                      <select name="id_tipo[]" class="form-control">
                                            <option value="" selected="selected">Selecione...</option>
                                            <?php 

                                            $sql_tipo = mysqli_query($con, "select * from tipos_arquivos a, tipos_arquivos_turma b where a.id_tipo = b.id_tipo and b.id_turma = '$vetor[turma]' order by a.nome ASC");

                                            while ($vetor_tipo=mysqli_fetch_array($sql_tipo)) { 

                                            ?>
                                            <option value="<?php echo $vetor_tipo['id_tipo']; ?>" <?php if (strcasecmp($vetor['id_tipo'], $vetor_tipo['id_tipo']) == 0) : ?>selected="selected"<?php endif; ?>><?php echo $vetor_tipo['nome'] ?></option>
                                            <?php } ?>
                                          </select>
                                    </fieldset>
                                  </div>
                                ...
                                <br>
                                <input type="button" value="Adicionar Tipo" onclick="duplicarCampos();" class="btn btn-warning">
                                <input type="button" value="Excluir Tipo" onclick="removerCampos(this);" class="btn btn-danger">
