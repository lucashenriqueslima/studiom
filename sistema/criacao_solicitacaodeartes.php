...
<!--                          <h4 class="page-title">Criação</h4>-->
                          <div class="d-flex align-items-center">
                              <nav aria-label="breadcrumb">
                                  <ol class="breadcrumb">
                                      <li class="breadcrumb-item">Criação</a></li>
                                      <li class="breadcrumb-item active" aria-current="page">Solicitação de Artes</li>
                                  </ol>
                              </nav>
                          </div>
                      </div>
              ...
              <div class="container-fluid">
                  ...
                  <div class="row">
                      <div class="col-12">
                          <div class="card">
                              <div class="card-body">
<!--                                  <h4 class="card-title">Solicitação de Artes</h4>-->
                                  ...
                                  <div class="table-responsive">
                                      <table id="lang_opt" class="table table-striped table-bordered display"
                                          ...
                                          <tbody>
																					<?php
																					$sql_atual = mysqli_query($con, "select * from artes order by id_arte DESC");
                                              ...
                                              <tr>
                                                  ...
                                                  <td><?php if ($vetor['tipo'] == 1) {
																										...
																										if ($vetor['tipo'] == 6) {
																											echo "Identidade Visual para Evento";
																										} ?></td>
