                          ...
                          <div class="d-flex align-items-center">
                              <nav aria-label="breadcrumb">
                                  <ol class="breadcrumb">
                                      ...
                                      <li class="breadcrumb-item active" aria-current="page">Excluir Vendas</li>
                                  </ol>
                              </nav>
                          </div>
                      </div>
              ...
              <div class="container-fluid">
                  ...
                  <div class="row">
                      <div class="col-12">
                          <div class="card">
                              <div class="card-body">
<!--                                  <h4 class="card-title">Exclusão de Vendas</h4>-->
                                  ...
                                  <div class="table-responsive">
                                      <table id="lang_opt" class="table table-striped table-bordered display"
                                          ...
                                          <tbody>
																					<?php
																					$sql_atual = mysqli_query($con, "select * from vendas where iniciada = '2'");
                                              ...
                                              <tr>
                                                  ...
                                                  <td><?php echo $num = number_format($vetor['valorvenda'], 2, ',', '.'); ?></td>
                                                  <td><a class="fancybox fancybox.ajax"
                                                         href="confexcluirvenda.php?id=<?php echo $vetor['id_venda']; ?>">
