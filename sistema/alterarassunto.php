<?php
    ...
    $id = $_GET['id'];
    $sql = mysqli_query($con, "select * from assuntos where id_assunto = '$id'");
                        ...
                        <div class="d-flex align-items-center">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active" aria-current="page">Assuntos Interação</li>
                                </ol>
                            </nav>
                        </div>
                    </div>
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title">Cadastro de Assunto de Interação</h4>

                                <form action="recebe_alterarassunto.php?id=<?php echo $id; ?>" method="post" name="cliente" enctype="multipart/form-data" onSubmit="return verificarCPF()" id="formID">
                               
                                <div class="row">
                                    <div class="col-lg-12">
                                        <fieldset class="form-group">
                                            <label class="form-label semibold" for="exampleInput">Assunto</label>
                                            <input type="text" name="nome" class="form-control" value="<?php echo $vetor['nome']; ?>" id="exampleInput" placeholder="Digite o nome" required>
                                        </fieldset>
                                    </div>
                                </div><!--.row-->
