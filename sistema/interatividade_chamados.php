                                    ...
                                    <table id="lang_opt" class="table table-striped table-bordered display"
                                        ...
                                        <tbody>
																				...
																				while ($vetor = mysqli_fetch_array($sql_chamados)) {
																					...
																					?>
                                            <tr>
                                                <td><?php if ($vetor['status'] == 1) { ?><span
                                                            class="label label-danger">Em Aberto</span> <?php }
																									if ($vetor['status'] == 2) { ?><span class="label label-warning">Em Atendimento</span> <?php }
																									if ($vetor['status'] == 3) { ?> <span class="label label-success">Finalizado</span><?php } ?>
                                                </td>
                                                ...
                                                <td><a class="fancybox fancybox.ajax"
                                                       href="verchamado.php?id=<?php echo $vetor['id_chamado']; ?>">
                                                        <button type="button" class="btn btn-success mesmo-tamanho"
                                                                title="Ver Chamado"><i class="mdi mdi-tooltip-edit"></i>
                                                        </button>
                                                    </a></td>
                                            </tr>
																				<?php } ?>
