                        ...
                        <div class="d-flex align-items-center">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active" aria-current="page">Convites Contrato</li>
                                </ol>
                            </nav>
                        </div>
                    </div>
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <form action="recebe_convitecontrato.php" method="post" name="cliente" enctype="multipart/form-data" onSubmit="return verificarCPF()" id="formID">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select name="id_item" id="turmas" class="form-control" required="">
                                                    ...
                                                    while ($vetor_produto=mysqli_fetch_array($sql_produtos)) {
                                                        ...
                                                        ?>
                                                        <option value="<?php echo $vetor_produto['id_tipo']; ?>" <?php if (strcasecmp($vetor['id_item'], $vetor_produto['id_tipo']) == 0) : ?>selected="selected"<?php endif; ?>><?php echo $vetor_produto['nome'] ?></option>
                                                    <?php } ?>
                                                </select>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-lg-4">
                                                <fieldset class="form-group">
                                                    ...
                                                    <input type="number" name="npagina[]" class="form-control" value="<?php echo $vetor['npagina']; ?>" required >
                                                </fieldset>
                                            </div>

                                            <div class="col-lg-4">
                                                <fieldset class="form-group">
                                                    <label class="form-label semibold" for="exampleInput">Legenda</label>
                                                    <input type="text" name="legenda[]" class="form-control" value="<?php echo $vetor['legenda']; ?>">
                                                </fieldset>
                                            </div>
                                    ...
                                    <br>
                                    <input type="button" value="Adicionar Pagina" onclick="duplicarCampos();" class="btn btn-warning">
                                    <input type="button" value="Excluir Pagina" onclick="removerCampos(this);" class="btn btn-danger">
