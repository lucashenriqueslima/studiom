<?php
  ...
  $sql = mysqli_query($con, "select * from produtos_opcionais where id_item = '$id'");
...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="index.php" class="logo">
      ...
      <span class="logo-mini"><img src="imgs/LOGOS-LOGIN-1.png" width="100px"></span>
      ...
      <div class="row">
        <div class="col-xs-12">
          <div class="box">
            ...
            <form action="recebe_alterarprodutoopvenda.php?id=<?php echo $id; ?>&id1=<?php echo $id1; ?>" method="post" name="cliente" enctype="multipart/form-data" onSubmit="return verificarCPF()" id="formID">
        ...
        <div class="row">
          ...
          <div class="col-lg-6">
            <fieldset class="form-group">
              <label class="form-label semibold" for="exampleInput">Tipo do Produto</label>
          ...
          <div class="col-lg-6">
            <fieldset class="form-group">
              <label class="form-label semibold" for="exampleInput">Valor Un.</label>
              <input type="text" name="valor" value="<?php echo $num = number_format($vetor['valor'],2,',','.'); ?>" class="form-control" id="exampleInput" placeholder="Valor Pagamento" onKeyPress="mascara(this,mvalor)" required>
            </fieldset>
          </div>
