...
if ($_SESSION['id'] == null) {
	...
	$sql_funcionario = mysqli_query($con, "select * from usuarios order by nome ASC");
	$id_pagina = 21;
                          ...
                          <div class="d-flex align-items-center">
                              <nav aria-label="breadcrumb">
                                  <ol class="breadcrumb">
                                      ...
                                      <li class="breadcrumb-item active" aria-current="page">Dashboard CRM</li>
                                  </ol>
                              </nav>
                          </div>
                      </div>
              ...
              <div class="container-fluid">
                  ...
                  <div class="row">
                      <div class="col-12">
                          <div class="card">
                              <div class="card-body">
<!--                                  <h4 class="card-title">PIPE</h4>-->

                                  <form action="recebe_dashboard.php" method="post" name="cliente"
                                          ...
                                          <div class="col-lg-12">
                                              <fieldset class="form-group">
                                                  ...
                                                  <select name="tipo" class="form-control" required="">
                                                      ...
                                                      <option value="1">Data Provável para Fechamento</option>
                                                      <option value="2">Negociação Sucesso</option>
                                                      <option value="3">Negociação Cancelada</option>
                                                  </select>
                                              </fieldset>
                                          </div>
                                      </div><!--.row-->
                                      ...
                                      <button type="submit" class="btn btn-primary" style="    float: left;">Buscar
                                      </button>
