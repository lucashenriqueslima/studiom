...
<!--                                  <h4 class="card-title">Colaboradores</h4>-->
																...
																}else { ?><a href="cadastrar_colaborador.php">
                                  ...
                                  <ul class="nav nav-tabs" role="tablist">
                                      ...
                                      <li class="nav-item"><a class="nav-link active" data-toggle="tab" href="#ativos"
                                                              role="tab"><span class="hidden-sm-up"><i
                                                          class="ti-email"></i></span> <span class="hidden-xs-down">Ativos</span></a>
                                      </li>
                                      <li class="nav-item"><a class="nav-link" data-toggle="tab" href="#inativos"
                                                              role="tab"><span class="hidden-sm-up"><i
                                                          class="ti-email"></i></span> <span class="hidden-xs-down">Inativos</span></a>
                                      </li>
                                  ...
                                  <div class="tab-content tabcontent-border">
                                      ...
                                      <div class="tab-pane active" id="ativos" role="tabpanel">
                                                  ...
                                                  <tbody>
                                                      ...
                                                      <tr>
                                                          ...
                                                          <td><a class="fancybox fancybox.ajax"
                                                                 href="alterarcolaborador.php?id=<?php echo $vetor['id_cadastro']; ?>"
                                                                 target="_blank">
                                                                  <button type="button"
                                                              ...
                                                              <a href="imprimircolaborador.php?id=<?php echo $vetor['id_cadastro']; ?>"
                                                                 target="_blank">
                                                                  <button type="button"
                                                                          class="btn btn-success mesmo-tamanho"
                                                                         ...
                                                                         href="confexcluircolaborador.php?id=<?php echo $vetor['id_cadastro']; ?>">
                                                                      <button type="button"
                                      ...
                                      <div class="tab-pane" id="inativos" role="tabpanel">
                                          ...
                                          <div class="table-responsive">
                                              <table id="lang_opt1" class="table table-striped table-bordered display"
                                                  ...
                                                  <tbody>
																									<?php
																									$sql_atual = mysqli_query($con, "select * from colaboradores where status = '2' order by nome ASC");
																									while ($vetor = mysqli_fetch_array($sql_atual)) {
																										?>
                                                      <tr>
                                                          <td><?php echo $vetor['id_cadastro']; ?></td>
