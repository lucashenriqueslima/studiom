<?php
    ...
    $sql = mysqli_query($con, "select * from tabela_basico_valores where id_valor = '$id'");
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <form action="recebe_alterarvalordadosbasico.php?id=<?php echo $id; ?>&id1=<?php echo $id1; ?>" method="post" name="cliente" enctype="multipart/form-data" onSubmit="return verificarCPF()" id="formID">
                                ...
                                <div class="row">
                                  ...
                                  <div class="col-lg-4">
                                    <fieldset class="form-group">
                                      ...
                                      <input type="number" name="qtdfinal" value="<?php echo $vetor['qtdfinal']; ?>" class="form-control" required="">
                                    </fieldset>
                                  </div>
