...
if ($_SESSION['id'] == null) {
	...
	$id = $_GET['alterar'];
	$vetor = mysqli_fetch_array(mysqli_query($con,"select * from categorias_contas where id_catconta ='{$id}'"));
	?>
	<!DOCTYPE html>
						...
						<div class="d-flex align-items-center">
							<nav aria-label="breadcrumb">
								<ol class="breadcrumb">
									...
									<li class="breadcrumb-item active" aria-current="page">Alterar Categoria de Conta</li>
								</ol>
							</nav>
						</div>
					</div>
			...
			<div class="container-fluid">
				...
				<div class="row">
					<div class="col-12">
						<div class="card">
							<div class="card-body">
								<form action="recebe_catconta.php?alterar=<?php echo $vetor['id_catconta']; ?>" method="post" name="cliente"
										...
										<div class="col-lg-4">
											<fieldset class="form-group">
												...
												<input type="text" name="titulo" class="form-control" id="exampleInput"
												       placeholder="Digite o titulo" value="<?php echo $vetor['titulo']; ?>" required>
											</fieldset>
										</div>
									</div><!--.row-->
