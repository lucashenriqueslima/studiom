<?php
    ...
    $id = $_GET['id'];
    $id1 = $_GET['id1'];
    $sql = mysqli_query($con, "select * from escala_eventos_itens where id_escala_item = '$id'");
    ...
    $nomeevento = explode("/", $vetor_evento['nome']);
    ...
    <div id="main-wrapper">
        ...
        <div class="page-wrapper">
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <form action="recebe_alterareventoescala.php?id=<?php echo $id; ?>&id1=<?php echo $id1; ?>" method="post" name="cliente" enctype="multipart/form-data" onSubmit="return verificarCPF()" id="formID">



            <h3>Evento <?php echo $nomeevento[2]; ?></h3>

            <div class="row">
              <div class="col-md-12">
                <div class="form-group">
                  <label>Orientações para cobertura Fotográfica</label>
                  <textarea name="orientacoes" class="ckeditor" id="editor1">

                    <?php if($vetor['orientacoes'] != NULL) { echo $vetor['orientacoes']; } else { ?>
            ...
            <div class="row">
              <div class="col-md-12">
                <div class="form-group">
                  <label>Relatório do Evento / Observações</label>
                  <textarea name="relatorioevento" class="ckeditor" id="editor1"><?php echo $vetor['relatorioevento']; ?></textarea>
                </div>
              </div>
            </div>
