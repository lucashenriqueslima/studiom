<?php
    ...
    $sql = mysqli_query($con, "select * from formaspag_produto where id_item = '$id'");
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title">Cadastro de Forma de Pagamento</h4>

                                <form action="recebe_alterarprodutoformapag.php?id=<?php echo $id; ?>&id1=<?php echo $id1; ?>" method="post" name="cliente" enctype="multipart/form-data" onSubmit="return verificarCPF()" id="formID">
                                ...
                                <div class="row">
                                  ...
                                  <div class="col-lg-3">
                                    <fieldset class="form-group">
                                      ...
                                      <select name="id_forma" class="form-control"
                                            data-toggle="tooltip"  title='Quando a forma de pagamento for "Cartão de Crédito", indicar a quantidade de parcelas a ser faturada, pois esta modalidade não está vinculada a data limite de parcelamento.'>
                                  ...
                                  <div class="col-lg-3">
                                    <fieldset class="form-group">
                                      ...
                                      <input type="text" name="qtdparcelas" class="form-control" value="<?php echo $vetor['qtdparcelas']; ?>" required>
                                    </fieldset>
                                  </div>

                                  <div class="col-lg-3">
                                        <fieldset class="form-group">
                                          <label class="form-label semibold" for="exampleInput" style="color: red;">Vencimento Fixo?</label>
                                          <select name="datafixa" class="form-control" style="color: red;">
                                            <option value="" selected="">Selecione....</option>
                                            <option value="1" <?php if (strcasecmp($vetor['datafixa'], '1') == 0) : ?>selected="selected"<?php endif; ?>>Não</option>
                                            <option value="2" <?php if (strcasecmp($vetor['datafixa'], '2') == 0) : ?>selected="selected"<?php endif; ?>>Sim</option>
                                          </select>
                                        </fieldset>
                                      </div>
                                      ...
                                      <div class="col-lg-3">
                                        <fieldset class="form-group">
                                          <label class="form-label semibold" for="exampleInput" style="color: red;">Data Vencimento</label>
                                          <input type="date" name="datavencimento" value="<?php echo $vetor['datavencimento']; ?>" class="form-control" style="color: red;">
                                        </fieldset>
                                      </div>
