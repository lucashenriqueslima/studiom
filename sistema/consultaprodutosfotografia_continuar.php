                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="alert alert-success" role="alert">
                                    <?php echo $_SESSION['nome']; ?>, parabéns pela aprovação do seu <?php echo $vetor_produto_item_final['nome']; ?>. Logo entraremos em contato informando sobre o envio do (s) produto (s).
                                </div>

                                <?php } else { ?>

                                <div class="alert alert-danger" role="alert">
                                    <?php echo $_SESSION['nome']; ?>, ainda restam produtos a serem aprovados. Por favor finalize a aprovação destes produtos. Deseja finalizar a aprovação para os demais produtos agora?.
                                </div>
                                    ...
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-footer">
                                                <a href="dashboard.php"><button type="button" class="btn btn-danger"  style="    float: left;">Sair das Aprovações</button></a>
                                                <a href="consultaprodutosfotografia_continuar.php?id=<?php echo $id; ?>"><button type="button" class="btn btn-info waves-effect" data-dismiss="modal">Continuar nas Aprovações</button></a>
                                            </div>
                                        </div>
                                        <!-- /.modal-content -->
                                    </div>
                                    ...
                                    <table id="lang_opt" class="table table-striped table-bordered display" style="width:100%">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td><?php if($vetor['status'] == 1) { echo "Em Aberto"; } if($vetor['status'] == 2) { echo "Em Preenchimento"; } if($vetor['status'] == 3) { echo "Aprovado com Ressalva"; } if($vetor['status'] == 4) { echo "Aprovado"; } ?></td>
