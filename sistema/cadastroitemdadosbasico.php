...
<script type="text/javascript">
          $(document).ready(function(){
              $('#clientes').change(function(){
                  $('#animais').load('animais.php?id_cliente='+$('#clientes').val() );
        ...
        <div class="col-xs-12">
          <div class="box">
            <div class="box-header">
              <h3 class="box-title">Cadastro de Dados Básicos</h3>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
            
            <form action="recebe_itemdadosbasico.php?id=<?php echo $id; ?>&id1=<?php echo $id1; ?>" method="post" name="cliente" enctype="multipart/form-data" onSubmit="return verificarCPF()" id="formID">
            ...
            <div class="row">
              ...
              <div class="col-lg-3">
                <fieldset class="form-group">
                  ...
                  <select name="id_item[]" id="categorias" class="form-control">
                        ...
                        $sql_embalagem = mysqli_query($con, "select * from tabela_tipos where tipo = '$id1' order by titulo ASC");
              ...
              <div class="col-lg-3">
                <fieldset class="form-group">
                  ...
                  <input type="number" name="qtdfinal[]" class="form-control" required="">
                </fieldset>
              </div>
              ...
              <div class="col-lg-3">
                <fieldset class="form-group">
                  ...
                  <input type="text" name="valor[]" class="form-control" onKeyPress="mascara(this,mvalor)" required="">
                </fieldset>
              </div>
