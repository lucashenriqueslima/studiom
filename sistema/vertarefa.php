...
if ($_SESSION['id'] == NULL) {
    ...
    $sql_update = mysqli_query($con, "update responsaveis_calendario SET lido = '2' where id_calendario = '$id' and id_usuario = '$_SESSION[id]'");
    $responsavel = mysqli_fetch_array(mysqli_query($con, "select * from usuarios where id_usuario = '$vetor[id_colaborador]'"))
    ?>
    <!DOCTYPE html>
                    ...
                    <div class="col-5 align-self-center">
                        <div class="d-flex align-items-center">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    <li class="breadcrumb-item">Tarefas</a></li>
                                    <li class="breadcrumb-item active" aria-current="page">Ver Tarefa</li>
                                </ol>
                            </nav>
                        </div>
                    </div>
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                <form action="recebe_concluirtarefa.php?id=<?php echo $id."&departamento=".$vetor['departamento'].(isset($_GET['calendario'])?'&calendario=sim':''); ?>"
                                        ...
                                        <div class="col-lg-12">
                                            <fieldset class="form-group">
                                                ...
                                                <select name="categoria" id="categorias" class="form-control"
                                                        disabled="">
                                                    <option value="" selected="selected">Selecione o Departamento
                                                    </option>
                                                    <?php
                                                    ...
                                                    while ($vetor_categoria = mysqli_fetch_array($sql_categorias)) {
                                                        ...
                                                        ?>
                                                        <option value="<?php echo $vetor_categoria['id_departamento']; ?>"
                                                                <?php if (strcasecmp($vetor['departamento'], $vetor_categoria['id_departamento']) == 0) : ?>selected="selected"<?php endif; ?>><?php echo $vetor_categoria['nome'] ?></option>
                                                    <?php } ?>
                                                </select>
                                            </fieldset>
                                        </div>
                                        ...
                                        <div class="col-lg-12">
                                            <fieldset class="form-group">
                                                ...
                                                <input type="text" name="responsavel" class="form-control"
                                                       value="<?php echo $responsavel['nome']; ?>"
                                                       placeholder="Digite o Tiulo" disabled="">
                                            </fieldset>
                                        </div>
                                    </div><!--.row-->
                                        ...
                                        <div class="col-lg-12">
                                            <fieldset class="form-group">
                                                <label class="form-label semibold" for="exampleInput">Hora de
                                                    início</label>
                                                <input type="time" name="hora" value="<?php echo $vetor['hora']; ?>"
                                                       class="form-control" disabled="">
                                            </fieldset>
                                        </div>
                                    </div><!--.row-->
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <select name="status" id="tipobusca"
                                                        onchange="ativarInputDataContrato()" class="form-control">
                                    ...
                                    <div id="palco1">
                                        <div id="2">
                                            ...
                                            <div class="row">
                                                <div class="col-md-12">
                                                    <div class="form-group">
                                                        <label>Quem Concluiu?</label>
                                                        <select name="quemconcluiu" id="quemconcluiu"
                                                                class="form-control">
                                                            <option value="" selected="">Selecione...</option>
                                                            <?php

                                                            $sql_usuario = mysqli_query($con, "select * from usuarios order by nome ASC");

                                                            while ($vetor_usuario = mysqli_fetch_array($sql_usuario)) {

                                                                ?>
                                                                <option value="<?php echo $vetor_usuario['id_usuario']; ?>"><?php echo $vetor_usuario['nome']; ?></option>
                                                            <?php } ?>
                                                        </select>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="row">
                                                <div class="col-md-12">
                                                    <div class="form-group">
                                                        ...
                                                        <textarea name="relatorio" id="relatorio" class="form-control"></textarea>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
