                        ...
                        <div class="d-flex align-items-center">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item">Status Categorias CRM</a></li>
                                    <li class="breadcrumb-item active" aria-current="page">Cadastrar novo Status de Categoria CRM</li>
                                </ol>
                            </nav>
                        </div>
                    </div>
...
<!--                                <h4 class="card-title">Cadastro de Status Categoria CRM</h4>-->
                                ...
                                <form action="recebe_status.php" method="post" name="cliente"
                                      enctype="multipart/form-data"  id="formID">
                                    <div class="row">
                                        <div class="col-lg-4">
                                            <fieldset class="form-group">
                                                <label class="form-label semibold" for="exampleInput">Categoria</label>
                                                <select name="id_categoria" id="exampleSelect" class="form-control"
                                                        required>
