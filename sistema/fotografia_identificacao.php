          ...
          <script type="text/javascript">
              $(document).ready(function () {
                  $('#turmas').change(function () {
                      $('#eventos').load('eventos_planejamento1.php?id_turma=' + $('#turmas').val());
                          ...
                          <div class="d-flex align-items-center">
                              <nav aria-label="breadcrumb">
                                  <ol class="breadcrumb">
                                      ...
                                      <li class="breadcrumb-item active" aria-current="page">Identificação por Evento</li>
                                  </ol>
                              </nav>
                          </div>
                      </div>
...
<!--                                  <h4 class="card-title">Indentificação de Formandos</h4>-->
                                  ...
                                  <form action="recebe_identificacaoformando.php" method="post" name="cliente"
