...
<!--                                  <h4 class="card-title">Personal</h4>-->
																...
																}else { ?><a href="cadastrar_personal.php">
                                  ...
                                  <div class="table-responsive">
                                      <table id="lang_opt" class="table table-striped table-bordered display"
                                          ...
                                          <tbody>
																					<?php
																					$sql_atual = mysqli_query($con, "select * from convite_personal order by id_convite DESC");
                                              ...
                                              <tr>
                                                  ...
                                                  <td><?php if ($vetor['datafinalizacao'] != null) {
																											echo date('d/m/Y', strtotime($vetor['datafinalizacao']));
																										} ?></td>
                                                  ...
                                                  <td><a class="fancybox fancybox.ajax"
                                                         href="alterar_personal.php?id=<?php echo $vetor['id_convite']; ?>"
                                                         target="_blank">
                                                          <button type="button" class="btn btn-success mesmo-tamanho"
                                                                 ...
                                                                 href="confexcluirpersonal.php?id=<?php echo $vetor['id_convite']; ?>">
