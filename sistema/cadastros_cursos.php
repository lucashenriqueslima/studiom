                      ...
                      <div class="col-12">
                          <div class="card">
                              <div class="card-body">
																...
																}else { ?><a href="cadastrar_curso.php">
                                    <button type="button" class="btn waves-effect waves-light btn-warning">Novo Curso
                                    </button>
                                </a>
                                  ...
                                  <div class="table-responsive">
                                      <table id="lang_opt" class="table table-striped table-bordered display"
                                          ...
                                          <tbody>
																					<?php
																					$sql_atual = mysqli_query($con, "select * from cursos order by nome ASC");
                                              ...
                                              <tr>
                                                  ...
                                                  <td><?php echo $vetor_instituicao['nome']; ?></td>
                                                  <td><?php echo $vetor_instituicao['sigla']; ?></td>
                                                  <td><?php echo $vetor['vagas1']; ?></td>
                                                  <td><a class="fancybox fancybox.ajax"
                                                         href="alterarcurso.php?id=<?php echo $vetor['id_curso']; ?>"
                                                         target="_blank">
                                                          <button type="button" class="btn btn-success mesmo-tamanho"
                                                                 ...
                                                                 href="confexcluircurso.php?id=<?php echo $vetor['id_curso']; ?>">
