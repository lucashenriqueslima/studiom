                        ...
                        <div class="d-flex align-items-center">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item">Convites</a></li>
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <form action="recebe_produto.php" method="post" name="cliente"
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-3">
                                            <fieldset class="form-group">
                                                <label class="form-label semibold" for="exampleInput">Data de Abertura
                                                    da Venda</label>
                                        ...
                                        <div class="col-lg-3">
                                            <fieldset class="form-group">
                                                ...
                                                <input type="date" name="termino"
                                                       value="<?php echo $vetor['termino']; ?>" class="form-control"
                                        ...
                                        <div class="col-lg-3">
                                            <fieldset class="form-group">
                                                ...
                                                <input type="date" name="dataentrega"
                                                       value="<?php echo $vetor['dataentrega']; ?>" class="form-control"
                                                       required="">
                                            </fieldset>
                                        </div>
                                        ...
                                        <div class="col-lg-12">
                                            <fieldset class="form-group">
                                                ...
                                                <input type="text" name="desconto"
                                                       value="<?php echo $vetor['desconto']; ?>" class="form-control"
                                                       id="exampleInput" placeholder="Valor Desconto" required="">
                                            </fieldset>
                                        </div>
