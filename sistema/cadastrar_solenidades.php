                        ...
                        <div class="d-flex align-items-center">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item">Solenidades</a></li>
                                    <li class="breadcrumb-item">Cadastrar</a></li>
                                    <li class="breadcrumb-item active" aria-current="page">Cadastrar Solenidades</li>
                                </ol>
                            </nav>
                        </div>
                    </div>
...
<!--                                <h4 class="card-title">Cadastro de Evento</h4>-->
                                ...
                                <form action="recebe_qrcode.php" method="post" name="cliente"
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-12">
                                            ...
                                            <div name="hide" style="display:none;" class="form-group">
                                                
                                                <textarea   name="lista_nometurma" id="lista_nometurma" class="form-control" required></textarea>
                                    ...
                                    <div class="row">
                                        <div class="col-lg-12" name="hide" style="display:none;">
                                            <fieldset class="form-group">
                                                ...
                                                <textarea  name="patrono" id="patrono" class="form-control"></textarea>
                                            </fieldset>
                                        </div>
                                    </div><!--.row-->
                                    ...
                                    <div class="row">
                                        <div class="col-lg-12" name="hide" style="display:none;">
                                            <fieldset class="form-group">
                                                ...
                                                <textarea   name="parainfo" id="parainfo" class="form-control"></textarea>
                                            </fieldset>
                                        </div>
                                    </div><!--.row-->
                                    ...
                                    <div class="row">
                                        <div class="col-lg-12" name="hide" style="display:none;">
                                            <fieldset class="form-group">
                                                <textarea  name="professores" id="professores" class="form-control"></textarea>
                                            </fieldset>
                                        </div>
                                    </div><!--.row-->
                                    ...
                                    <div class="row">
                                        <div class="col-lg-6">
                                            <fieldset class="form-group">
                                                <label class="form-label semibold" for="exampleInput">Imagem Brasão</label>
                                                <button id="inserirImagemBrasao"
                                                      type="button" class="btn btn-success"
                                                      title="Inserir Arquivo" data-toggle="modal" data-target="#modalInserirImagemBrasao">
                                        ...
                                        <div class="col-lg-6">
                                            <fieldset class="form-group">
                                                <label class="form-label" for="exampleInputEmail1">Imagem Turma</label>
                                                <button id="inserirImagemTurma"
                                                      type="button" class="btn btn-success"
                                                      title="Inserir Arquivo" data-toggle="modal" data-target="#modalInserirImagemTurma">
                                                  <span><i class="fas fa-cloud-upload-alt fa-md"></i></span>
                                                </button>
                                            </fieldset>
                                        </div>
                                    ...
                                    <input class="form-control" type="hidden" id="longitudeJantar" name="longitudeJantar">
                                    <input class="form-control" type="hidden" id="latitudeJantar" name="latitudeJantar">

                                    <input class="form-control" type="hidden" id="longitudeCulto" name="longitudeCulto">
                                    <input class="form-control" type="hidden" id="latitudeCulto" name="latitudeCulto">

                                    <input class="form-control" type="hidden" id="longitudeColacao" name="longitudeColacao">
                                    <input class="form-control" type="hidden" id="latitudeColacao" name="latitudeColacao">

                                    <input class="form-control" type="hidden" id="longitudeBaile" name="longitudeBaile">
                                    <input class="form-control" type="hidden" id="latitudeBaile" name="latitudeBaile">
                                    ...
                                    <!-- Modal -->
                                    <div class="modal fade" id="modalInserirImagemBrasao" tabindex="-1" role="dialog" aria-labelledby="modalInserirImagemBrasao" aria-hidden="true">
                                                        ...
                                                        <div class="modal-body">
                                                            <div>
                                                                ...
                                                                <label class="custom-file-label" id="labelarquivo"
                                                                        for="arquivo">Escolha uma imagem sem fundo</label>
                                                            </div>
                                                        </div>
                                    ...
                                    <div class="modal fade" id="modalInserirImagemTurma" tabindex="-1" role="dialog" aria-labelledby="modalInserirImagemTurma" aria-hidden="true">
                                        <div class="modal-dialog modal-dialog-centered" role="document">
                                            <div class="modal-content">
                                                <div class="modal-content">
                                                        <div class="modal-header">
                                                        ...
                                                        <div class="modal-body">
                                                            <div>
                                                                <input class="custom-file-input" type="file" name="images[]"
                                                                        id="arquivoTurma">
                                                                <label class="custom-file-label" id="labelarquivo"
                                                                        for="arquivo">Escolha uma imagem de proporção 3:1</label>
                                                            </div>
                                                        </div>
                                                        <div class="modal-footer">
                                                          <button type="button" id=""
    ...
    <script>
        ...
        $(document).ready(function(){
            //$("select[name='id_turma']").blur(function(){   
            $("#id_turma").blur(function(){                
                var id_turma = $("#id_turma option:selected").val();
                //console.log(id_nometurma);
                var $lista_nometurma = $("textarea[name='lista_nometurma']");
                var $patrono = $("textarea[name='patrono']");
                var $parainfo = $("textarea[name='parainfo']");
                var $professores = $("textarea[name='professores']");  
                 
                var $jantardospais = $("textarea[name='jantardospais']"); 
                var $cultoecumenico = $("textarea[name='cultoecumenico']"); 
                var $colacaograu = $("textarea[name='colacaograu']"); 
                var $bailedeformatura = $("textarea[name='bailedeformatura']"); 
                                                   
                $.getJSON('listar_solenidades.php',{
                    id_turma: $ (this).val()
                        
                },function(json){
                    $lista_nometurma.val(json.lista_nometurma);         
                    $patrono.val(json.patrono);
                    $parainfo.val(json.parainfo);
                    $professores.val(json.professores);
                   
                    $jantardospais.val(json.jantardospais);
                    $cultoecumenico.val(json.cultoecumenico);
                    $colacaograu.val(json.colacaograu);
                    $bailedeformatura.val(json.bailedeformatura);
