<?php
  ...
  $id = $_GET['id'];
  $sql = mysqli_query($con, "select * from turmas_mkt where id_turma = '$id'");
...
<div class="wrapper">
      ...
      <div class="row">
        <div class="col-xs-12">
          <div class="box">
            ...
            <form action="recebe_alterarturmamkt.php?id=<?php echo $id; ?>" method="post" name="cliente" enctype="multipart/form-data" onSubmit="return verificarCPF()" id="formID">
        ...
        <div class="row">
          ...
          <div class="col-lg-12">
            <fieldset class="form-group">
              ...
              <select name="id_curso" id="categorias" class="form-control">
                    ...
                    ?>
                    <option value="<?php echo $vetor_curso['id_curso']; ?>" <?php if (strcasecmp($vetor['id_curso'], $vetor_curso['id_curso']) == 0) : ?>selected="selected"<?php endif; ?>><?php echo $vetor_curso['nome'] ?> / <?php echo $vetor_instituicao_curso['sigla'] ?></option>
                    <?php } ?>
                  </select>
            </fieldset>
          </div>
        ...
        <div class="row">
          ...
          <div class="col-lg-12">
            <fieldset class="form-group">
              ...
              <input type="text" name="conclusao" class="form-control" id="exampleInput" value="<?php echo $vetor['conclusao']; ?>" placeholder="Digite a Conclusão" required>
            </fieldset>
          </div> 
        ...
        <div class="row">
          ...
          <div class="col-lg-6">
            <fieldset class="form-group">
              <label class="form-label semibold" for="exampleInput">Rede Social</label>
              <select name="tipo[]" class="form-control">
                    <option value="" selected="selected">Selecione...</option>

                    <option value="Facebook" <?php if (strcasecmp($vetor_rede['tipo'], 'Facebook') == 0) : ?>selected="selected"<?php endif; ?>>Facebook</option>
                    <option value="Instagram" <?php if (strcasecmp($vetor_rede['tipo'], 'Instagram') == 0) : ?>selected="selected"<?php endif; ?>>Instagram</option>
                    <option value="Twitter" <?php if (strcasecmp($vetor_rede['tipo'], 'Twitter') == 0) : ?>selected="selected"<?php endif; ?>>Twitter</option>
          ...
          <div class="col-lg-6">
            <fieldset class="form-group">
              ...
              <input type="text" name="link[]" class="form-control" value="<?php echo $vetor_rede['link']; ?>" >
            </fieldset>
          </div>
        ...
        <br>
        <input type="button" value="Adicionar Rede Social" onclick="duplicarCampos();" class="btn btn-warning">
        <input type="button" value="Excluir Rede Social" onclick="removerCampos(this);" class="btn btn-danger">
        ...
        <h3>Redes Sociais Cadastradas</h3>
        ...
        <table id="example2" class="table table-bordered table-striped">
                ...
                $sql_rede = mysqli_query($con, "select * from redessociais_turmas WHERE id_turma = '$id' order by tipo ASC");
        
                while ($vetor_rede=mysqli_fetch_array($sql_rede)) {
        
                ?>
                <tr>
                  <td><?php echo $vetor_rede['tipo']; ?></td>
                  <td><a href="<?php echo $vetor_rede['link']; ?>" target="_blank"><button type="button" class="btn btn-info mesmo-tamanho" title="Acessar"><i class="fa fa-external-link-square"></i></button></a> <?php if($vetor_permissao['exclusao'] == 1) { } else { ?><a href="confexcluirredesocial.php?id=<?php echo $vetor_rede['id_redes']; ?>&id1=<?php echo $id; ?>" ><button type="button" class="btn btn-danger mesmo-tamanho" title="Excluir Cadastro"><i class="fa fa-close"></i></button></a><?php } ?></td> 
                </tr>
                <?php } ?>
                </tbody>
                <tfoot>
  ...
  <footer class="main-footer">
    <div class="pull-right hidden-xs">
      <b>Versão</b> 1.0    </div>
    <strong>Todos direitos reservados StudioM.
  </footer>
</div>
<!-- ./wrapper -->
