            ...
            <div class="page-breadcrumb">
                <div class="row">
                    <div class="col-5 align-self-center">
                        <h4 class="page-title">Meu Financeiro</h4>
                        <div class="d-flex align-items-center">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    <li class="breadcrumb-item">Home</a></li>
                                    <li class="breadcrumb-item active" aria-current="page">Meu Financeiro</li>
                                </ol>
                            </nav>
                        </div>
                    </div>
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title">Meu Financeiro</h4>

                                <ul class="nav nav-tabs" role="tablist">

                                    <li class="nav-item"><a class="nav-link active" data-toggle="tab" href="#convite"
                                                            role="tab"><span class="hidden-sm-up"><i
                                                        class="ti-layers-alt"></i></span> <span class="hidden-xs-down">Convite</span></a>
                                    </li>
                                    <li class="nav-item"><a class="nav-link" data-toggle="tab" href="#fotografia"
                                                            role="tab"><span class="hidden-sm-up"><i
                                                        class="ti-camera"></i></span> <span class="hidden-xs-down">Fotografia</span></a>
                                    </li>
                                    ...
                                    <div class="tab-pane active" id="convite" role="tabpanel">
                                        ...
                                        <div class="table-responsive">
                                            <table id="lang_opt" class="table table-striped table-bordered display"
                                                ...
                                                <tbody>
																								<?php
																								$sql_atual = mysqli_query($con, "SELECT a.pagamento,a.id_item,a.arquivo, a.id_duplicata, a.posicao, a.data, a.valor, a.status, a.boleto, a.link, a.formapag, b.id_duplicata, b.id_formando, b.id_venda, c.id_venda, c.iniciada FROM duplicatas_faturas a, duplicatas b, vendas c WHERE a.id_duplicata = b.id_duplicata and b.id_formando = '$_SESSION[id_formando]' and b.id_venda = c.id_venda AND c.iniciada = '2' AND c.tipo = '1' order by a.posicao ASC");
																								while ($vetor_atual = mysqli_fetch_array($sql_atual)) {
																									...
																									$sql_venda = mysqli_query($con, "select * from vendas where id_venda = '$vetor_atual[id_venda]'");
																									$vetor_venda = mysqli_fetch_array($sql_venda);
																									?>
                                                    <tr>
                                                        <td><?php echo $vetor_forma['nome']; ?></td>
                                                        <td><?php echo $vetor_atual['posicao']; ?>
                                                            /<?php echo $vetor_venda['qtdparcelas']; ?></td>
                                                        <td><?php echo date('d/m/Y', strtotime($vetor_atual['data'])); ?></td>
                                                        <td><?php echo $num1 = number_format($vetor_atual['valor'], 2, ',', '.'); ?></td>
                                                        <td><?php if ((int)$vetor_atual['status'] == 1 || ((int)$vetor_atual['status'] == 2 && (int)$vetor_atual['pagamento'] != 1)) {
                                                                echo "Em Aberto";
                                                            }
                                                            if ((int)$vetor_atual['status'] == 2 && (int)$vetor_atual['pagamento'] == 1) {
                                                                echo "Recebido";
                                                            }
                                                            if ((int)$vetor_atual['status'] == 3) {
                                                                echo "Cancelado";
                                                            }
                                                            if ((int)$vetor_atual['status'] == 4) {
                                                                echo "Negado";
                                                            } ?>
                                                        </td>
                                                        <td>
																													<?php if ($vetor_atual['arquivo'] != null) {
																														?>

                                                              <a
                                                                      href="../sistema/arquivos/<?php echo $vetor_atual['arquivo']; ?>"
                                                                      target="_blank">
                                                                  <button type="button"
                                                                          class="btn btn-default mesmo-tamanho"
                                                                          title="Abrir Boleto"><i
                                                                              class="mdi mdi-cloud-print"></i>
                                                                  </button>
                                                              </a>
																													
																													<?php }elseif ($vetor_atual['link'] != null) { ?>
                                                              <a
                                                                      href="<?php echo $urlbase; ?><?php echo $vetor_atual['link']; ?>"
                                                                      target="_blank">
                                                                  <button type="button"
                                                                          class="btn btn-default mesmo-tamanho"
                                                                          title="Abrir Boleto"><i
                                    ...
                                    <div class="tab-pane" id="fotografia" role="tabpanel">
                                        ...
                                        <div class="table-responsive">
                                            <table id="lang_opt2" class="table table-striped table-bordered display"
                                                ...
                                                <tbody>
																								<?php
																								$sql_atual = mysqli_query($con, "SELECT a.pagamento,a.id_item, a.id_duplicata,a.arquivo, a.posicao, a.data, a.valor, a.status, a.boleto, a.link, a.formapag, b.id_duplicata, b.id_formando, b.id_venda, c.id_venda, c.iniciada, c.tipopagamento FROM duplicatas_faturas a, duplicatas b, vendas c WHERE a.id_duplicata = b.id_duplicata and b.id_formando = '$_SESSION[id_formando]' and b.id_venda = c.id_venda AND c.iniciada = '2' AND (c.tipo = '2' or tipo = '3' or tipo = '4') order by a.posicao ASC");
																								while ($vetor_atual = mysqli_fetch_array($sql_atual)) {
																									$sql_forma = mysqli_query($con, "select * from formaspag where id_forma = '$vetor_atual[formapag]'");
																									$vetor_forma = mysqli_fetch_array($sql_forma);
																									$sql_venda = mysqli_query($con, "select * from vendas where id_venda = '$vetor_atual[id_venda]'");
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td><?php
																													if ($vetor_atual['status'] != 2 || $vetor_atual['status'] != 3 || $vetor_atual['status'] != 4) {
																														if ($vetor_atual['arquivo'] != null) {
																															?>
