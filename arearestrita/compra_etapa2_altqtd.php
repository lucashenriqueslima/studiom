...
$sql_cadastro = "select * from formandos where id_formando = '$_SESSION[id_formando]'";
   ...
   $sql_exclui = mysqli_query($con, "delete FROM itens_venda_individual where id_venda = '$id'");
  ...
  $sql_deleta = mysqli_query($con, "delete FROM itens_venda_individual where id_venda = '$id' and id_item = '$id_item'");
  ...
  $i++;
   ...
   $sql_atualiza = mysqli_query($con, "update vendas SET valorvenda = '$totalizador[total]', status='2' where id_venda = '$id'");
