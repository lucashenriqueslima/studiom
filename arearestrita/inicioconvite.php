                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="alert alert-info" role="alert">
                                  ...
                                  <br>
                                  <br>
                                  <a href="aprovarconvite.php?id=<?php echo $id; ?>&produto=<?= $produto; ?>"><button type="button" class="btn btn-success"  style="    float: left;">Visualizar escolhas</button></a>
                                  <br>
                                  <br>
                                </div>
                                ...
                                <?php echo $vetor_aprovacao['descricao']; ?>

                                <br>
                                <br>

                                <a href="aprovarconvite.php?id=<?php echo $id; ?>"><button type="button" class="btn btn-success"  style="    float: left;">Iniciar</button></a>
