            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title">Cadastro de Pacote</h4>
                                ...
                                <div class="tab-content tabcontent-border">
                                    ...
                                    <div class="tab-pane" id="eventos" role="tabpanel">
                                        ...
                                        <a href="cadastroeventopacote.php?id=<?php echo $id; ?>">
                                            <button class="btn btn-primary" style="    float: left;">Cadastrar Novo
                                                Evento
                                            </button>
                                        </a>
                                        <br>
                                    ...
                                    <div class="tab-pane" id="produtos" role="tabpanel">
                                        ...
                                        <a href="cadastroprodutopacotealbum.php?id=<?php echo $id; ?>">
                                            <button class="btn btn-primary" style="    float: left;">Cadastrar Novo
                                                Produto
                                            </button>
                                        </a>
                                    ...
                                    <div class="tab-pane" id="formaspagamento" role="tabpanel">
                                        ...
                                        <a href="cadastropacoteformapag.php?id=<?php echo $id; ?>">
                                            <button class="btn btn-primary" style="    float: left;">Cadastrar Nova
                                                Forma de Pagamento
                                            </button>
                                        </a>
                                        <br>
