...
location.href=\"index.php\";
    ...
    if (in_array((int)$vetor_cadastro['turma'], [183, 55, 25, 80, 113, 47, 22, 1, 26, 102, 8, 6])) {
        $auxTurma = mysqli_fetch_array(mysqli_query($con, "SELECT * FROM eventosformando WHERE id_evento_turma_lista in (75,893,894,890,917,918,928,929,935,930,931,952) and id_formando = '{$_SESSION['id_formando']}'"));
        $caminho2 = "../sistema/arquivos/formandos/$auxTurma[pasta]/";
        $img2 = glob($caminho2 . "*.{JPG,jpg,png,gif}", GLOB_BRACE);
        $extra = 1;
    }
    ?>
    <!DOCTYPE html>
    ...
    <div id="main-wrapper">
                                ...
                                <div class="card-body">
                                    ...
                                    if ($vetor_qtd['qtd'] == $totalescolhas) {
                                        ...
                                        <div class="alert alert-info" role="alert">
                                            Olá, <?php echo $vetor_cadastro['nome']; ?>, suas fotos escolhidas já foram
                                            enviadas para o tratamento. Para ter acesso às imagens tratadas, você deverá
                                            acessar o menu "Top Fotos".
                                        </div>
                                    ...
                                    <?php } else { ?>
                                        ...
                                        <div class="alert alert-danger" role="alert">
                                            Para este evento
                                            você <?php $totaldefotos = $vetor_qtd['qtd'] - $totalescolhas;
                                            if ($totalescolhas > 0) { ?> ainda <?php } ?> poderá escolher
                                            “<?php echo $totaldefotos; ?>” fotografias para receber um tratamento top.
                                        </div>
                                                ...
                                                if (mysqli_num_rows($sql_valida) == 0) {
                                                    ...
                                                    <div class="col-md-3">
                                                        ...
                                                        <div class="thumbnails grid">
                                                            ...
                                                            <a class="image-popup-vertical-fit"
                                                               href="<?php echo $img; ?>"><img src="<?php echo $img; ?>"
                                                                                               alt="">
                                                            </a>

                                                        </div>

                                                        <form action="recebe_enviarescolhafotoseventos.php?id=<?php echo $id; ?>"
                                                              name="form1" method="post" enctype="multipart/form-data">
                                                            <div align="center"><h4 class="mb-0"><input type="radio"
                                                                                                        id="imagem"
                                                                                                        name="bn"
                                                                                                        value="<?php echo $img; ?>">
                                                                    Selecionar esta imagem.</h4>
                                                            </div>
                                                                                ...
                                                                                <div class="col-lg-12">
                                                                                    <fieldset class="form-group">
                                                                                        <label class="form-label semibold"
                                                                                            ...
                                                                                            Esteja à
                                                                                            vontade
                                                                                            para nos dizer como deseja o
                                                                                            tratamento
                                                                                            desta fotografia.</label>
        ...
        <img src="http://3.bp.blogspot.com/-Bo2GNAVNb90/URkAlN-0V_I/AAAAAAAACfs/VHFT6oP1ZTk/s1600/Loading+-+Carregando+%252826%2529.gif"
             alt="" id="loading" class="content"/>
