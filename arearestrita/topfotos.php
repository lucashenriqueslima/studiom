            ...
            <div class="page-breadcrumb">
                <div class="row">
                    <div class="col-5 align-self-center">
                        <h4 class="page-title">Top Fotos</h4>
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <br>
															...
															<?php if (mysqli_num_rows($sql_vendas_formando) > 0) { ?>

                                <div class="row">
																	
																	<?php
																	$caminho = "../sistema/arquivos/topfotos/$vetor_cadastro[topfotos]/";
																	$img = glob($caminho."*.{JPG,jpg,jpeg,png,gif}", GLOB_BRACE);
																	$contador = count($img);
																	$i = 0;
																	foreach ($img as $img) {
																		$imagem = explode("/", $img);
                            ...
                            <a href="downloadfotostop.php?id=<?php echo $id; ?>" target="_blank">
                                <button type="button" class="btn btn-default" style="    float: left;"><i
                                            class="fa fa-download nav_icon"></i> Baixar Todas Fotos
                                </button>
                            </a>
