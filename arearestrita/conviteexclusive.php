            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                <?php if ($vetor_escolha['datafinal'] < $dataatual) {
                                    ?>

                                    <div class="alert alert-info" role="alert">
                                        Olá, <?php echo $vetor_cadastro['nome']; ?>. A data limite para a escolha das
                                        suas fotos expirou.
                                    </div>
                                                    ...
                                                    <table width="100%">
                                                        <tr>
                                                            <td valign="top">
                                                                ...
                                                                <br>
                                                                <img src="../sistema/arquivos/<?php echo $vetor_item['imagem']; ?>"
                                                                     height="450px">
                                                                <br>
                                                                <br>
                                                                <?php
                                                                if ($vetor_item['bloqueio'] != '2') {
                                                                    if ($vetor_item['status'] == 1) {
                                                                        ...
                                                                        <div id="minhaDivcad<?php echo $vetor_item['id_item']; ?>"
                                                                            ...
                                                                            <form action="recebe_escolhadefotoconviteexclusive.php?id=<?php echo $vetor_item['id_item']; ?>&id_convite=<?php echo $id; ?>"
                                                                                  method="POST" enctype="multipart/form-data"
                                                                                  name="form<?php echo $vetor_item['id_item']; ?>">
                                                                                <br>
                                                                                <?php if ($vetor_item['tipo'] == 2) { ?>
                                                                                    <div class="container-fluid">
                                                                                        ...
                                                                                        <div class="alert alert-danger"
                                                                                             role="alert">
                                                                                            <div align="justify">Através do
                                                                                                sistema
                                                                                                disponibilizamos duas formas de
                                                                                                escolher
                                                                                                suas fotos de família. Caso tenha
                                                                                                participado do Ensaio Foto de
                                                                                                Família
                                                                                                realizado pela Studio M e queira
                                                                                                escolher apenas estas fotos, basta
                                                                                                apenas indicar as fotografias a
                                                                                                serem
                                                                                                escolhidas conforme a quantidade
                                                                                                estabelecida para o convite de
                                                                                                formatura. Se não tiver
                                                                                                participado do
                                                                                                Ensaio Foto de Família conosco ou
                                                                                                quiser
                                                                                                apenas escolher suas fotos
                                                                                                pessoais,
                                                                                                basta apenas optar por selecionar
                                                                                                seus
                                                                                                arquivos em "arquivos pessoais".
                                                                                                Agora
                                                                                                se tiver participado do Ensaio
                                                                                                foto de
                                                                                                Convite e mesmo assim quiser
                                                                                                também
                                                                                                utilizar fotos do seu arquivo
                                                                                                pessoal,
                                                                                                você precisará fazer o upload
                                                                                                destes
                                                                                                arquivos, apenas através de
                                                                                                "arquivo
                                                                                                pessoal". Como fazer: Você deverá
                                                                                                fazer
                                                                                                o download destas fotos para seu
                                                                                                computador através do botão de
                                                                                                download
                                                                                                ou clicar com o botão direito
                                                                                                sobre a
                                                                                                fotografia e "salvar como". A
                                                                                                partir do
                                                                                                momento em que estas fotografias
                                                                                                estiverem em seu computador, você
                                                                                                deverá
                                                                                                juntá-las às suas fotos do arquivo
                                                                                                pessoal e a partir deste momento,
                                                                                                selecionar "arquivo pessoal" e
                                                                                                fazer o
                                                                                                upload de todas as fotos juntas
                                                                                                para o
                                                                                                sistema em "fotos de família".
                                                                                                Este
                                                                                                procedimento deverá ser realizado,
                                                                                                pois
                                                                                                o sistema não permite com que
                                                                                                façamos a
                                                                                                seleção destes arquivos de locais
                                                                                                distintos para upload.
                                                                                            </div>
                                                                                        </div>
                                                                                                    ...
                                                                                                    <div class="col-md-4">
                                                                                                        <div class="form-group">
                                                                                                            <label>Tipo da
                                                                                                                Foto</label>
                                                                                                            <select name="upload"
                                                                                                                    id="tipobusca<?php echo $vetor_item['id_item']; ?>"
                                                                                                                    class="form-control">
                                                                                                                ...
                                                                                                                <option value="2_<?php echo $vetor_item['id_item']; ?>">
                                                                                                                    Arquivo
                                                                                                                    pessoal
                                                                                                                </option>
                                                                                                                <option value="1_<?php echo $vetor_item['id_item']; ?>">
                                                                                                                    Arquivo Studio
                                                                                                                    M
                                                                                                                </option>
                                                                                                            ...
                                                                                                            <div class="col-lg-3">
                                                                                                                <fieldset
                                                                                                                    ...
                                                                                                                    <select name="preeventos"
                                                                                                                        ...
                                                                                                                        <?php
                                                                                                                        $sql_vendas = mysqli_query($con, "SELECT * FROM vendas WHERE id_formando = '$vetor_cadastro[id_formando]' and tipo='2' and iniciada='2' and pagamento='1'");
                                                                                                                        $sql_vendas_fc = mysqli_query($con, "SELECT * FROM vendas WHERE id_formando = '$vetor_cadastro[id_formando]' and tipo='4' and iniciada='2' and pagamento='1'");
                                                                                                                        if (mysqli_num_rows($sql_vendas) > 0) {
                                                                                                                            $sql_eventos = mysqli_query($con, "SELECT ef.* FROM eventosformando ef
                                                                                                                                                                                                                                                        left join eventos_turma_lista etl on etl.id_evento_turma = ef.id_evento_turma_lista
                                                                                                                                                                                                                                                        left join categoriaevento ce on ce.id_categoria = etl.id_evento
                                                                                                                                                                                                                                                        WHERE ef.id_formando = '$vetor_cadastro[id_formando]' and (ce.sigla ='FC' or ce.sigla = 'SM') order by ef.id_evento DESC");
                                                                                                                        }elseif (mysqli_num_rows($sql_vendas_fc) > 0) {
                                                                                                                            $sql_eventos = mysqli_query($con, "SELECT ef.* FROM eventosformando ef
                                                                                                                                                                                                                                                        left join eventos_turma_lista etl on etl.id_evento_turma = ef.id_evento_turma_lista
                                                                                                                                                                                                                                                        left join categoriaevento ce on ce.id_categoria = etl.id_evento
                                                                                                                                                                                                                                                        WHERE ef.id_formando = '$vetor_cadastro[id_formando]' and ce.sigla ='FC' order by ef.id_evento DESC");
                                                                                                                        }
                                                                        ...
                                                                        <div id="minhaDivfotos<?php echo $vetor_item['id_item']; ?>"
                                                                            ...
                                                                            <div class="table-responsive">
                                                                                                ...
                                                                                                <?php if ($vetor_fotos_cadastradas['tipo'] == 2) { ?>
                                                                                                    <div class="thumbnail">
                                                                                                        <a class="image-popup-vertical-fit"
                                                                                                           href="../sistema/arquivos/<?php echo $vetor_fotos_cadastradas['foto']; ?>"><img
                                                                                                                    alt=""
                                                                                                                    src="../sistema/arquivos/<?php echo $vetor_fotos_cadastradas['foto']; ?>"/></a>
                                                                                                    </div>
                                                                                                <?php }else { ?>
                                                                                                    <div class="thumbnail">
                                                                                                        <a class="image-popup-vertical-fit"
                                                                                ...
                                                                                <table class="table">
                                                                                    <tr>
                                                                                        <td>
                                                                                            Observações: <?php echo $vetor_item['observacoes']; ?>
                                                                                        </td>
                                                                                    </tr>
                                                                                </table>
                                                                                <br>
                                                                                <?php if ($vetor_escolha['status'] != 4) { ?>
                                                                                    <a href="excluirescolhasconviteexclusive.php?id=<?php echo $vetor_item['id_item']; ?>&id_convite=<?php echo $id; ?>">
                                                                                        <button type="button"
                                                                                                class="btn btn-danger"
                                                                                                style="    float: left;">Excluir
                                                                                            Escolha(s)
                                                                                        </button>
                                                                                    </a>
                                                                                <?php } ?>
                                        ...
                                        <div style="background: #ffffff">
                                            ...
                                            if (mysqli_num_rows($sql_itens_finaliza) == mysqli_num_rows($sql_itens2) && $vetor_escolha['status'] != 4) {
                                                ...
                                                <table width="100%">
                                                    <tr>
                                                        <td>
                                                            <div class="alert alert-danger" role="alert">
                                                                Caro(a) Formando(a), antes de finalizar a (s) escolha (s)
                                                                favor confirme se foram realizadas em todas lâminas.
                                                            </div>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <a href="finalizarescolhasconviteexclusive.php?id_escolha=<?php echo $vetor_escolha['id_exclusive']; ?>">
