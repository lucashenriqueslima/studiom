...
$sql_grava = mysqli_query($con, "insert into vendas (id_formando, produto, tipo, data, status, aceite, iniciada) VALUES ('$vetor_cadastro[id_formando]', '$produto', '$tipo', '$data', '1', '1', '1')");

$id_cadastro = $con->insert_id;

$sql_venda = mysqli_query($con, "select * from vendas where id_venda = '$id_cadastro'");
                    ...
                    <div class="col-12">
                        <div class="card">
                            ...
                            <div class="alert alert-warning" role="alert">
                              Caro(a), <?php echo $vetor_cadastro['nome']; ?>, precisa ser adquirida a quantidade mínima determinada em contrato.
                            </div>
                            <br>

                            <form action="compra_etapa2.php?id=<?php echo $id_cadastro; ?>" method="post" enctype="multipart/form-data">
                         ...
                         ?>
                                ...
                                <tr id="line<?php echo $count; ?>">
                                    ...
                                    <td width="2%"></td>
                                    <td class="class_quant"><strong>Quantidade:</strong> <input type="number" name="qtd[]" min="<?php echo $vetor_itens['qtdminima']; ?>" id="<?php if($count == 1) { ?>qnt01<?php } else { ?>qnt02<?php } ?>" class="form-control" <?php if($vetor_itens['qtdminima'] > 0) { ?>required <?php } ?> /></td>
                                    <td width="2%"></td>
                                    <td class="class_total"><strong>Sub-Total: </strong>R$<input type="text" name="<?php if($count == 1) { ?>total01<?php } else { ?>total02<?php } ?>" id="<?php if($count == 1) { ?>total01<?php } else { ?>total02<?php } ?>" class="form-control" disabled="" /></td>
                                </tr>
                                <?php 
                            ...
                            <form action="compra_etapa2_pacote.php?id=<?php echo $id_cadastro; ?>" method="post" enctype="multipart/form-data">
