...
$sql_aprovacao = mysqli_query($con, "select * from meu_album where id_formando = '$_SESSION[id_formando]'");
                        ...
                        <div class="d-flex align-items-center">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active" aria-current="page">Produtos Fotografia</li>
                                </ol>
                            </nav>
                        </div>
                    </div>
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title">Escolha de Fotos - Produtos Fotografia</h4>

                                <?php 

                                $sql_album_ap = mysqli_query($con, "select * from escolha_fotos where id_formando = '$vetor_cadastro[id_formando]' and id_item = '$id'");
                                $vetor_album_ap = mysqli_fetch_array($sql_album_ap);

                                if(mysqli_num_rows($sql_album_ap) > 0) { 
                                ...
                                <div class="table-responsive">
                                    <table id="lang_opt" class="table table-striped table-bordered display" style="width:100%">
                                        ...
                                        <tbody>
                                            ...
                                            $sql_atual = mysqli_query($con, "select * from escolha_fotos where id_formando = '$_SESSION[id_formando]' and id_item = '$id' order by id_escolha DESC");
                                            ...
                                            <tr>
                                                ...
                                                <td><?php if($vetor['dataaprovacao'] != NULL) { echo date('d/m/Y', strtotime($vetor['dataaprovacao'])); } ?></td>
                                                <td><?php if($vetor['status'] == 1) { echo "Em Aberto"; } if($vetor['status'] == 2) { echo "Em Preenchimento"; } if($vetor['status'] == 3) { echo "Escolha Finalizada"; } if($vetor['status'] == 4) { echo "Escolha Finalizada"; } ?></td>
                                                <td><a href="inicioescolhafotos.php?id=<?php echo $vetor['id_escolha']; ?>"><button type="button" class="btn btn-default mesmo-tamanho" title="Ver ou Alterar Cadastro"><i class="fa fa-edit"></i></button></a></td>
                                            </tr>
                                            <?php } ?>
                                        </tbody>
                                    </table>
