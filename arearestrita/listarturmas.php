      ...
      <div class="row">
        <div class="col-xs-12">
          <div class="box">
            ...
            <?php if($vetor_permissao['cadastro'] == 1) { } else { ?><a href="cadastroturma.php"><button class="btn btn-primary"  style="    float: left;">Cadastrar Novo Contrato</button></a>
            <br>
            <br>
           	<br><?php } ?>
              <table id="example1" class="table table-bordered table-striped table-responsive" style="width:100%">
                ...
                <?php 
				        ...
				        $sql_atual = mysqli_query($con, "select * from turmas order by id_turma DESC");
          ...
          <div class="col-lg-3">
            <fieldset class="form-group">
              ...
              <select name="id_instituicao" id="categorias" class="form-control">
                    ...
                    <option value="<?php echo $vetor_instituicao['id_instituicao']; ?>" <?php if (strcasecmp($vetor['id_instituicao'], $vetor_instituicao['id_instituicao']) == 0) : ?>selected="selected"<?php endif; ?>><?php echo $vetor_instituicao['nome'] ?></option>
                    <?php } ?>
                  </select>
            </fieldset>
          </div>
