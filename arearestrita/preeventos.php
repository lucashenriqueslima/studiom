                        ...
                        <div class="d-flex align-items-center">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active" aria-current="page">Pré-Eventos</li>
                                </ol>
                            </nav>
                        </div>
                    </div>
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <table id="example1" class="table table-bordered table-striped">
                                    ...
                                    $sql_atual = mysqli_query($con, "select * from eventosformando where tipo = '1' AND id_formando = '$vetor_cadastro[id_formando]' order by id_evento DESC");
                                    ...
                                    if($cont > 0) {
                                      ...
                                      <td><a href="verfotos.php?id=<?php echo $vetor_atual['id_evento']; ?>" ><button type="button" class="btn btn-default mesmo-tamanho" title="Visualizar Fotos"><i class="fa fa-eye"></i></button></a></td> 
                                    </tr>
                                    <?php } } ?>
                                    </tbody>
                                  </table>
                                ...
                                $vetor_vendas_formando = mysqli_fetch_array($sql_vendas_formando);

                                if(mysqli_num_rows($sql_vendas_formando) > 0) { 

                                if($vetor_vendas_formando['tipo'] == 3) {

                                $sql_eventos_venda = mysqli_query($con, "select * from eventos_venda_avulsa where id_avulsa = '$vetor_vendas_formando[produto]'");
                                $vetor_eventos_venda = mysqli_fetch_array($sql_eventos_venda);

                                if(mysqli_num_rows($sql_eventos_venda) == 1) { 

                                    if($vetor_eventos_venda['id_evento'] == 17 || $vetor_eventos_venda['id_evento'] == 18) {

                                ?>

                                <div class="alert alert-info" role="alert">
                                      Caro(a), <?php echo $vetor_cadastro['nome']; ?>. Ainda não há pré-evento(s) cadastrado(s).
                                </div> 
