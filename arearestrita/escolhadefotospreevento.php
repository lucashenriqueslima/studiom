                        ...
                        <div class="d-flex align-items-center">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active" aria-current="page">Pré-Evento</li>
                                </ol>
                            </nav>
                        </div>
                    </div>
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title">Pré-Evento</h4>

                                <?php 

                                $sql_vendas_formando = mysqli_query($con, "select * from vendas where tipo IN ('2', '3') and iniciada = '2' and pagamento = '1' AND id_formando = '$vetor_cadastro[id_formando]' order by id_venda DESC");

                                //$sql_formando = mysqli_query($con, "select * from formandos where id_formando = '$vetor_cadastro[id_formando]' and album = '1'");
                                $sql_formando = mysqli_query($con, "select * from formandos where id_formando = '$vetor_cadastro[id_formando]'");
                                ...
                                <table id="example1" class="table table-bordered table-striped">
                                    ...
                                    $sql_atual = mysqli_query($con, "select * from eventosformando a, turmas_escolha b where a.tipo = '1' AND a.id_formando = '$vetor_cadastro[id_formando]' AND a.id_evento_turma = b.id_evento order by a.id_evento DESC");
                            
                                    while ($vetor_atual=mysqli_fetch_array($sql_atual)) {

                                    $sql_compara = mysqli_query($con, "select * from turmas_escolha_formandos where id_evento = '$vetor_atual[id_evento_turma]' and id_formando = '$_SESSION[id_formando]'");

                                    if(mysqli_num_rows($sql_compara) > 0) {
                                    ...
                                    if($cont > 0) {
                                        ...
                                        $sql_evento_turma = mysqli_fetch_array(mysqli_query($con, "select * from eventos_turma where id_evento = '{$vetor_atual['id_evento_turma']}' "));
                                        ?>
                                        <tr>
                                          <td><?php echo $vetor_atual['titulo']." (".$sql_evento_turma['titulo'].")"; ?></td>
                                      <td><a href="escolhadefotos_formando.php?id=<?php echo $vetor_atual['id_evento']; ?>" ><button type="button" class="btn btn-default mesmo-tamanho" title="Visualizar Fotos"><i class="fa fa-eye"></i></button></a></td> 
                                    </tr>
                                    <?php } } } ?>
                                    </tbody>
                                  </table>
                                ...
                                <div class="alert alert-info" role="alert">
                                  Olá, <?php echo $vetor_cadastro['nome']; ?>. Serviço disponível mediante contratação do serviço de fotografia/álbum fotográfico. Para contratar, <a href="minhascompras.php">clique aqui</a>.
                                </div> 
