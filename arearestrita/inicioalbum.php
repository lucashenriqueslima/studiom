...
$sql_aprovacao = mysqli_query($con, "select * from meu_album where id_meualbum = '$id' AND id_formando = '$_SESSION[id_formando]'");
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                ...
                                $sql_album_ap = mysqli_query($con, "select * from meu_album where id_formando = '$vetor_cadastro[id_formando]'");
                               ...
                               <a href="aprovaralbum.php?id=<?php echo $id; ?>"><button type="button" class="btn btn-success"  style="    float: left;">Iniciar</button></a> 
