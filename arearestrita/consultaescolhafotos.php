...
$sql_escolha_finalizada = mysqli_query($con, "select * from escolha_fotos where id_formando = '$_SESSION[id_formando]' and status = '4'");
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title">Escolha de Fotos</h4>

                                <?php if($total == $total_finalizada) { ?>

                                <div class="alert alert-success" role="alert">
                                    <?php echo $vetor_cadastro['nome']; ?>, parabéns pela escolha das suas fotografias. Logo entraremos em contato para que possa aprovar o (s)  produto (s) para o (s) qual (is) as fotos foram escolhidas.
                                </div>

                                <?php } else { ?>

                                <div class="alert alert-danger" role="alert">
                                    <?php echo $vetor_cadastro['nome']; ?>, ainda restam produtos as quais as fotografias ainda precisam ser escolhidas. Por favor finalize a escolha das fotos para estes produtos. Deseja finalizar a escolha das fotos para os demais produtos agora?
                                </div>
                                    ...
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                <h4 class="modal-title" id="myModalLabel">Escolha de Fotos</h4>
                                            ...
                                            <div class="modal-footer">
                                                <a href="inicio.php"><button type="button" class="btn btn-danger"  style="    float: left;">Sair das Escolhas</button></a>
                                                <a href="consultaescolhafotos_continuar.php?id=<?php echo $id; ?>"><button type="button" class="btn btn-info waves-effect">Continuar nas Escolhas</button></a>
                                            </div>
                                        </div>
                                        <!-- /.modal-content -->
                                    </div>
                                ...
                                <div id="escondido">                                    
                                    ...
                                    <table class="table table-striped table-bordered display" style="width:100%">
                                        ...
                                        $sql_atual = mysqli_query($con, "select * from escolha_fotos where id_formando = '$_SESSION[id_formando]' and status <> '4' order by id_escolha DESC");

                                        while($vetor_atual = mysqli_fetch_array($sql_atual)) { 

                                        $sql_categoria = mysqli_query($con, "select * from tipo_opcionais where id_tipo = '$vetor_atual[id_item]'");
                                        $vetor_categoria = mysqli_fetch_array($sql_categoria);

                                        ?>
                                        <tr>
                                            <td><?php echo $vetor_categoria['nome']; ?></td>
                                            <td><a href="escolhafotos.php?id=<?php echo $vetor_atual['id_escolha']; ?>"><button type="button" class="btn btn-default mesmo-tamanho" title="Ver ou Alterar Cadastro"><i class="fa fa-edit"></i></button></a></td>
                                        </tr>
                                        <?php } ?>
                                    </table>                                    
