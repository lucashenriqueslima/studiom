                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <a href="../sistema/cadastrochamado.php"><button type="button" class="btn waves-effect waves-light btn-warning">Novo Chamado</button></a>
                                ...
                                <li class="nav-item"> <a class="nav-link" data-toggle="tab" href="#ematendimento" role="tab"><span class="hidden-sm-up"><i class="ti-check-box"></i></span> <span class="hidden-xs-down">Em Atendimento</span></a> </li>
                                ...
                                <div class="table-responsive">
                                    <table id="lang_opt" class="table table-striped table-bordered display" style="width:100%">
                                        ...
                                        <tbody>
                                            ...
                                            $sql_chamados = mysqli_query($con, "select * from chamados where id_formando = '$_SESSION[id_formando]' and status = '1' order by id_chamado DESC");

                                            while($vetor = mysqli_fetch_array($sql_chamados)) {

                                            $sql_departamento = mysqli_query($con, "select * from departamentos where id_departamento = '$vetor[departamento]'");
                                            $vetor_departamento = mysqli_fetch_array($sql_departamento);

                                            ?>
                                            <tr>
                                                <td><?php if($vetor['status'] == 1) { ?><span class="label label-danger">Em Aberto</span> <?php } if($vetor['status'] == 2) { ?><span class="label label-warning">Em Atendimento</span> <?php } if($vetor['status'] == 3) { ?> <span class="label label-success">Finalizado</span><?php } ?></td>
                                                <td><?php echo $vetor_departamento['nome']; ?></td>
                                                <td><?php echo $vetor['servico']; ?></td>
                                                <td><?php echo date('d/m/Y', strtotime($vetor['data'])); ?></td>
                                                <td><?php echo $vetor['hora']; ?></td>
                                                <td><?php echo $vetor['titulo']; ?></td>
                                                <td><a class="fancybox fancybox.ajax" href="verchamado.php?id=<?php echo $vetor['id_chamado']; ?>"><button type="button" class="btn btn-success mesmo-tamanho" title="Ver Chamado"><i class="mdi mdi-tooltip-edit"></i></button></a></td>
                                            </tr>
                                            <?php } ?>
                                        </tbody>
                                    </table>
                                ...
                                <div class="tab-pane" id="ematendimento" role="tabpanel">
                                ...
                                <div class="table-responsive">
                                    <table id="lang_opt2" class="table table-striped table-bordered display" style="width:100%">
                                        ...
                                        <tbody>
                                            ...
                                            $sql_chamados = mysqli_query($con, "select * from chamados where id_formando = '$_SESSION[id_formando]' and status = '2' order by id_chamado DESC");
                                ...
                                <div class="table-responsive">
                                    <table id="lang_opt1" class="table table-striped table-bordered display" style="width:100%">
                                        ...
                                        <tbody>
                                            ...
                                            $sql_chamados = mysqli_query($con, "select * from chamados where id_formando = '$_SESSION[id_formando]' and status = '3' order by id_chamado DESC");
