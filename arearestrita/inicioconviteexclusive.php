...
$sql_aprovacao = mysqli_query($con, "select * from convite_exclusive where id_exclusive = '$id' AND id_formando = '$_SESSION[id_formando]'");
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="alert alert-info" role="alert">
                                  ...
                                  <br>
                                  <br>
                                  <a href="conviteexclusive.php?id=<?php echo $id; ?>"><button type="button" class="btn btn-success"  style="    float: left;">Visualizar escolhas</button></a>
                                  <br>
                                  <br>
                                </div>
                               ...
                               <?php echo $vetor_aprovacao['texto']; ?>

                               <br>
                               <br>

                               <a href="conviteexclusive.php?id=<?php echo $id; ?>"><button type="button" class="btn btn-success"  style="    float: left;">Iniciar</button></a> 
