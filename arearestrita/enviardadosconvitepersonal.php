...
location.href=\"index.php\";
    ...
    $sql_tipo = mysqli_query($con, "select * from tipos_arquivos where id_tipo = '$vetor_item[id_tipo]'");
    $sql_venda = mysqli_query($con, "select * from vendas where id_formando = '$_SESSION[id_formando]' and tipo <> '1'");
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <form action="recebe_enviardadosconvitepersonal.php?id=<?php echo $id; ?>&id1=<?php echo $id1; ?>"
                                      name="form1" method="post" enctype="multipart/form-data">

                                    <?php if ($vetor_tipo['id_tipo'] == 1) { ?>

                                        <h3>Preencher <?php echo $vetor_tipo['nome']; ?></h3>

                                    <?php } ?>

                                    <?php if ($vetor_tipo['id_tipo'] == 2) { ?>
                                    ...
                                    <section class="content">
                                        ...
                                        <div class="content-main">
                                            ...
                                            <?php }
                                            if ($vetor_tipo['id_tipo'] == 3) { ?>

                                                <h3>Selecione suas <?php echo $vetor_tipo['nome']; ?>.</h3>
                                                <h4>Você pode selecionar <?php echo $vetor_item['qtd']; ?>
                                                    Fotos.</h4>
                                            ...
                                            if ($vetor_tipo['id_tipo'] == 4) { ?>
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            <select name="upload" id="tipobusca" class="form-control">
                                                                ...
                                                                <?php if (mysqli_num_rows($sql_venda) > 0) { ?>
                                                ...
                                                <div id="palco1">
                                                    ...
                                                    <div id="1">
                                                        ...
                                                        <?php
                                                        $sql_arquivo_formando = mysqli_query($con, "select * from eventosformando where titulo = 'Ensaio - Fotos de Família' and id_formando = '$vetor_cadastro[id_formando]'");
                                                        $vetor_arquivo_formando = mysqli_fetch_array($sql_arquivo_formando);
                                                        $caminho = "../sistema/arquivos/formandos/$vetor_arquivo_formando[pasta]/";
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            foreach ($img as $img) {
                                                                ...
                                                                <div class="col-md-2">
                                                                    ...
                                                                    <script type="text/javascript">
                                                                        var CheckMaximo = <?php echo $vetor_item['qtd']; ?>;
                                            ...
                                            if ($vetor_tipo['id_tipo'] == 5) {
                                                $sql_item = mysqli_query($con, "select * from convite_personal_itens where id_item = '$id'");
                                                $vetor_item = mysqli_fetch_array($sql_item);
                                                $sql_arquivo_formando = mysqli_query($con, "select * from tipos_arquivos_formando where id_tipo = '$vetor_item[id_tipo]' and id_formando = '$vetor_cadastro[id_formando]'");
                                                $vetor_arquivo_formando = mysqli_fetch_array($sql_arquivo_formando);
                                                ...
                                                <h3>Selecione suas <?php echo $vetor_tipo['nome']; ?>.</h3>
                                                <h3>Você pode selecionar <?php echo $vetor_item['qtd']; ?>
                                                    Fotos.</h3>
                                                <div class="row">
