...
$sql_escolha = mysqli_query($con, "select * from meu_convite where id_meuconvite = '$id' AND id_formando = '$_SESSION[id_formando]'");
...
$sql_itens_finalizado = mysqli_query($con, "select * from meu_convite_paginas where id_meuconvite = '$id' and status = '1' and bloqueio <> '2'");
                        ...
                        <div class="d-flex align-items-center">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active" aria-current="page">Produtos Convite</li>
                                </ol>
                            </nav>
                        </div>
                    </div>
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                ...
                                if($vetor_escolha['datafinal'] < $dataatual) {

                                ?>

                                <div class="alert alert-info" role="alert">
                                  Olá, <?php echo $vetor_cadastro['nome']; ?>. A data limite para aprovação de seu convite expirou.
                                </div>
                                ...
                                <table width="100%">
                                    <tr>
                                        <td valign="top">
                                            ...
                                            <form action="recebe_escolhadefotomeuconvite.php?id=<?php echo $vetor_item[id_pagina
                                            ]; ?>&id_escolha=<?php echo $id; ?>" method="POST">
                                            ...
                                            <select name="status" id="produto_<?php echo $vetor_item['id_pagina']; ?>" class="form-control" required="">
                                                ...
                                                <option value="1_<?php echo $vetor_item['id_pagina']; ?>" <?php if (strcasecmp($vetor_item['status'], '2') == 0) : ?>selected="selected"<?php endif; ?>>Sim</option>
                                                <option value="2_<?php echo $vetor_item['id_pagina']; ?>" <?php if (strcasecmp($vetor_item['status'], '3') == 0) : ?>selected="selected"<?php endif; ?>>Com Resssalva</option>
                                            </select>
                                            </div>
                                            </div>
                                            ...
                                            <button type="button" class="btn btn-success" onclick="Mudarestado('minhaDivfotos_escolhidas<?php echo $vetor_item[id_item]; ?>')">Mostrar Foto(s) Cadastradas</button>
                                            <br>
                                            <br>
                                            <div id="minhaDivfotos_escolhidas<?php echo $vetor_item[id_item]; ?>"  style="display:none; overflow-y: scroll; background-color: #E8E8E8;">
                                                ...
                                                $sql_fotos_cadastradas = mysqli_query($con, "select * from meuconvite_fotos_escolhidas where id_meuconvite = '$vetor_item[id_pagina]'");
                                                ...
                                                <?php if($dataatual <= $vetor_escolha['datafinal']) { ?>

                                                <a href="excluirescolhasmeuconvite.php?id=<?php echo $vetor_item[id_pagina]; ?>&id_escolha=<?php echo $id; ?>"><button type="button" class="btn btn-danger"  style="    float: left;">Excluir Escolha(s)</button></a>
                                            ...
                                            <div id="2_<?php echo $vetor_item['id_pagina']; ?>"  style="display:none; background-color: #E8E8E8;">
                                                ...
                                                <table width="100%">
                                                            ...
                                                            <td>
                                                                ...
                                                                <div class="col-md-12">
                                                                  <div class="form-group">
                                                                        ...
                                                                        <textarea name="observacoes" class="form-control"><?php echo $vetor_item['descricao']; ?></textarea>
                                                                  </div>
                                                                  </div>
                                                                </div>
                                                    ...
                                                    if($dataatual <= $vetor_escolha['datafinal'] && $vetor_item['bloqueio'] != '2') {
                                ...
                                <?php if($dataatual <= $vetor_escolha['datafinal']) { if(mysqli_num_rows($sql_itens_finalizado) == 0) { ?><a href="recebe_finaliza_meuconvite.php?id=<?php echo $id; ?>"><button type="button" class="btn btn-success" >Finalizar Escolha(s)</button></a><?php } } ?>
