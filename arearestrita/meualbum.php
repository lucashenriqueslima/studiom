                        ...
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title">Aprovações - Produtos Fotografia</h4>
															...
															<?php
															$sql_album_ap = mysqli_query($con, "select * from meu_album where id_formando = '$vetor_cadastro[id_formando]' and id_item = '$id'");
                                  ...
                                  <div class="table-responsive">
                                      <table id="lang_opt" class="table table-striped table-bordered display"
                                          ...
                                          <tbody>
																					<?php
																					$sql_atual = mysqli_query($con, "select * from meu_album where id_formando = '$_SESSION[id_formando]' and id_item = '$id' order by id_meualbum DESC");
																					$i = 1;
                                              ...
                                              <tr>
                                                  ...
                                                  <td><a href="inicioalbum.php?id=<?php echo $vetor['id_meualbum']; ?>">
