       ...
       <div class="content-main">
		...
		<div class="grid-form">
		  ...
		  <div class="grid-form1">
            ...
            $sql_valida = mysqli_query($con, "select * from pacotes a, vendas b where a.termino >= '$dataatual' and a.id_turma = '$vetor_cadastro[turma]' and a.id_pacote = b.produto and b.id_formando = '$_SESSION[id_formando]' and b.tipo = '2' order by a.id_pacote DESC limit 0,1"); 
