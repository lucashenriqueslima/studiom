                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                ...
                                $sql_convite_ap = mysqli_query($con, "select * from meu_convite where id_formando = '$vetor_cadastro[id_formando]'");
                                    ...
                                    <table id="lang_opt" class="table table-striped table-bordered display" style="width:100%">
                                        <thead>
                                            <tr>
                                                ...
                                                <th>Data Final para Aprovação</th>
                                                <th>Status</th>
                                                <th width="6%">Ação</th>
                                            </tr>
                                        </thead>
                                        <tbody>
                                            ...
                                            $sql_atual = mysqli_query($con, "select * from meu_convite where id_formando = '$_SESSION[id_formando]' order by id_meuconvite DESC");
                                            ...
                                            ?>
                                            <tr>
                                                <td><?php echo $vetor_produtos['nome']; ?></td>
                                                <td><?php echo date('d/m/Y', strtotime($vetor['data'])); ?></td>
                                                <td><?php if($vetor['dataaprovacao'] == NULL) { } else { echo date('d/m/Y', strtotime($vetor['dataaprovacao'])); } ?></td>
                                                <td><?php echo date('d/m/Y', strtotime($vetor['datafinal'])); ?></td>
                                                ...
                                                <td><a href="inicioconvite.php?id=<?php echo $vetor['id_meuconvite']; ?>&produto=<?= $vetor_produtos['nome']; ?>"><button type="button" class="btn btn-default mesmo-tamanho" title="Ver ou Alterar Cadastro"><i class="fa fa-edit"></i></button></a></td>
                                            </tr>
                                            <?php } ?>
                                        </tbody>
                                    </table>
