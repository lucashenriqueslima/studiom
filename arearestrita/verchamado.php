...
$id = $_GET['id'];
$sql = mysqli_query($con, "select * from chamados where id_chamado = '$id' and id_formando = '$_SESSION[id_formando]'");
$vetor = mysqli_fetch_array($sql);

$sql_interacoes = mysqli_query($con, "select * from chamado_interacoes where id_chamado = '$id' order by id_interacoes DESC");
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title">Chamado</h4> <?php echo $vetor['titulo']; ?>.
                            </div>
                        </div>
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title">Interações do Chamado</h4>
                                <ul class="list-unstyled mt-5">
                                    <?php 

                                    while($vetor_interacoes = mysqli_fetch_array($sql_interacoes)) {

                                    if($vetor_interacoes['tipo'] == 1) {

                                    $sql_tipo = mysqli_query($con, "select * from formandos where id_formando = '$vetor_interacoes[id_cadastro]'");
                                    ...
                                    ?>
                                    <li class="media">
                                        <img class="mr-3" src="../sistema/arquivos/<?php echo $vetor_tipo['imagem']; ?>" width="60" alt="<?php echo $vetor_tipo['nome']; ?>">
                                        <div class="media-body">
                                            <h5 class="mt-0 mb-1"><?php echo $vetor_tipo['nome']; ?> - Data: <?php echo date('d/m/Y', strtotime($vetor_interacoes['data'])); ?> / Hora: <?php echo $vetor_interacoes['hora']; ?></h5> <?php echo $vetor_interacoes['texto']; ?>
                                                
                                                <div class="row">

                                                <?php

                                                $sql_anexos = mysqli_query($con, "select * from chamado_mensagens_anexos where id_mensagem = '$vetor_interacoes[id_interacoes]' order by id_anexo DESC");

                                                while($vetor_anexo = mysqli_fetch_array($sql_anexos)) {

                                                ?>
                                                <div class="col-md-2">
                                                    <a href="../sistema/arquivos/<?php echo $vetor_anexo['anexo']; ?>" target="_blank"><button class="btn btn-light waves-effect waves-light" type="button"><span class="btn-label"><i class="fas fa-file-alt"></i></span> Anexo</button></a>
                                                </div>
                                                <?php } ?>
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <form method="post" action="recebe_respostachamado.php?id=<?php echo $id; ?>" enctype="multipart/form-data">
                                    ...
                                    <div class="row">
                                        ...
                                        <br>
                                        <input type="button" value="Adicionar Anexo" onclick="duplicarCampos();" class="btn btn-warning">
                                        <input type="button" value="Excluir Anexo" onclick="removerCampos(this);" class="btn btn-danger">
                                    ...
                                    <table width="100%">
                                        <tr>
                                            <td width="5%"><button type="submit" class="mt-4 btn waves-effect waves-light btn-success">Enviar</button></form></td>
                                            <td><a href="finalizarchamado.php?id=<?php echo $id; ?>"><button type="button" class="mt-4 btn waves-effect waves-light btn-info">Marcar Chamado com Resolvido</button></a></td>
                                        </tr>
                                    </table>                                    
