                            ...
                            <div class="card-body">
                                <h4 class="card-title">Eventos</h4>
                                  ...
                                  <table id="example1" class="table table-bordered table-striped">
                                      ...
                                      <tbody>
                                              ...
                                              <tr>
                                                  ...
                                                  <td>
                                                      <a href="escolhadefotosevento_formando.php?id=<?php echo $vetor_atual['id_evento_turma']; ?>">
                                  ...
                                  <div class="alert alert-info" role="alert">
                                      Olá, <?php echo $vetor_cadastro['nome']; ?>. Serviço disponível mediante
                                      contratação do serviço de fotografia/álbum fotográfico. Para contratar, <a
                                              href="minhascompras.php">clique aqui</a>.
                                  </div>
