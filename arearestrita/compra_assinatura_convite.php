...
if ($_SESSION['id_formando'] == null || $_SESSION['id_formando'] == '') {
    ...
    if ($formapag == '18') {
        ...
        if ($diferenca_dias <= 30 && $pacote_itens['pacote_especial'] == 2) {
                        ...
                        <div class="card">
                            <div class="card-body">
                                <h4 class="page-title">Assinatura Digital</h4> <br>
                                    ...
                                    <form method="post" action="recebe_finaliza_convite.php?id_p=<?=$id_p?>">
                                        
                                        <input type="text"  id="id_item" value="<?= $id_p?>" hidden> 
                                        ...
                                        <input type="text" id="tipo" value="2" hidden> 
