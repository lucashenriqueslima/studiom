...
$sql_aprovacao = mysqli_query($con, "select * from escolha_fotos where id_escolha = '$id' AND id_formando = '$_SESSION[id_formando]'");
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                               ...
                               <a href="escolhafotos.php?id=<?php echo $id; ?>"><button type="button" class="btn btn-success"  style="    float: left;">Iniciar</button></a> 
