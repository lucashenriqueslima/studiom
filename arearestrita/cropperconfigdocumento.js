        ...
        switch (data.method) {
          ...
          case 'getCroppedCanvas':
            if (result) {
                ...
                $.ajax({
                type: 'POST',
                url: 'atualizar_imagem_documento.php', // linkar para seu script aqui
                data: {
                ...
                beforeSend: function () {
                  ...
                  success: function(output) {
                    ...
                    $('#modalInfom').on('show.bs.modal', function (event) {
                      recipient = "Imagem salva com sucesso!";
                      var modal = $(this);
                    ...
                    //window.location.href =  'recebe_finaliza_fotografia.php?id_item='+id_item+'&formapag='+formapag+'&qtdparcelas='+qtdparcelas+'&diavencimento='+diavencimento
                  }
                });
