...
$sql_data = mysqli_query($con, "select * from dados_convite_data where id_turma = '$vetor_cadastro[turma]'");
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title">Nome dos Pais</h4>

                                            <form action="recebe_nomeconvite.php?pais=sim" method="post">

                                            <?php

                                            $sql_consulta_pais = mysqli_query($con, "select * from dadosconvite_nomes where id_formando = '$_SESSION[id_formando]' and tipo = '2' order by id_nomes ASC");

                                            if(mysqli_num_rows($sql_consulta_pais) == 0) {

                                            if($vetor_data['data'] == NULL || $vetor_data['data'] >= $dataatual) {

                                            ?>

                                            <strong>Se algum dos pais for falecido, indicar entre "parenteses" (in memoriam), ao final do nome.</strong>
                                            ...
                                            <div class="row">
                                              ...
                                              <fieldset class="form-group">
                                                <label class="form-label semibold" for="exampleInput">Digite o Nome</label>
                                                <input type="text" name="nomepai[]" class="form-control" id="exampleInput">
                                              </fieldset>
                                              </div>
                                            </div>
                                            ...
                                            while($vetor_nome_pais = mysqli_fetch_array($sql_consulta_pais)) {
                                            ...
                                            <div class="row">
                                              ...
                                              <fieldset class="form-group">
                                                ...
                                                <input type="text" name="nomepai[]" value="<?php echo $vetor_nome_pais['nome']; ?>" class="form-control" id="exampleInput">
                                              </fieldset>
                                              </div>
                                            </div>
