                                    ...
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-footer">
                                                <a href="escolhafotos.php?id=<?php echo $id; ?>"><button type="button" class="btn btn-danger"  style="    float: left;">Sair das Escolhas</button></a>
                                                <a href="consultaescolhafotos_continuar.php?id=<?php echo $id; ?>"><button type="button" onclick="EscondeElemento1('escondido')" value="Esconde Div" class="btn btn-info waves-effect">Continuar nas Escolhas</button></a>
                                            </div>
                                        </div>
                                        <!-- /.modal-content -->
                                    </div>
