            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                <form action="recebe_chatinicio.php" method="post" name="cliente" enctype="multipart/form-data" id="formID">
                
                                        <div class="row">
                                            <div class="col-lg-12">
                                                <fieldset class="form-group">
                                                    <label class="form-label semibold" for="exampleInput">Departamento que deseja falar</label>
                                        ...
                                        <div class="row">
                                            <div class="col-lg-12">
                                                <fieldset class="form-group">
                                                    <label class="form-label semibold" for="exampleInput">Mensagem</label>
                                                    <input type="text" name="mensagem" class="form-control" id="exampleInput" placeholder="Digite sua Mensagem" required="">
                                                </fieldset>
                                            </div>
                                        </div>
                                                                                
                                        <button type="submit" class="btn btn-primary"  style="    float: left;">Abrir Chat</button>
