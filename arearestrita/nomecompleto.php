            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title">Confirmar Nome Completo</h4>
                                            ...
                                            <form action="recebe_nome.php" method="post">
                                                <div class="row">
                                                  <div class="col-lg-12">
                                                  <fieldset class="form-group">
                                                    <label class="form-label semibold" for="exampleInput">Nome Completo</label>
                                                    <input type="text" name="nomecompleto" value="<?php if(mysqli_num_rows($sql_consulta_nome) == 0) { echo $vetor_cadastro['nome']; } else { echo $vetor_consulta_nome['nome']; } ?>" class="form-control" id="exampleInput" required>
                                                  </fieldset>
                                                  </div>
                                                </div>
                                                ...
                                                if(mysqli_num_rows($sql_consulta_nome) == 0) {

                                                if($vetor_data['data'] == NULL || $vetor_data['data'] >= $dataatual) {

                                                ?>

                                                <button type="submit" class="btn btn-primary"  style="    float: left;">Confirmar</button>
