                        ...
                        <div class="d-flex align-items-center">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active" aria-current="page"><?php if($row_pre['tipo'] == 1) { echo "Pré-Eventos"; } if($row_pre['tipo'] == 2) { echo "Eventos"; } ?></li>
                                </ol>
                            </nav>
                        </div>
                    </div>
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                ...
                                $totalescolhas = mysqli_num_rows($sql_consulta);

                                if($vetor_qtd['qtd'] == $totalescolhas) {
                                ...
                                <div class="alert alert-info" role="alert">
                                  Olá, <?php echo $vetor_cadastro['nome']; ?>, suas fotos escolhidas já foram enviadas para o tratamento. Para ter acesso às imagens tratadas, você deverá acessar o menu "Top Fotos".
                                </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-3">
                                      ...
                                      <a class="image-popup-vertical-fit" href="<?php echo $vetor_escolhidas['foto']; ?>"><img src="<?php echo $vetor_escolhidas['foto']; ?>" alt=""></a>  

                                      <br>

                                      Observações: <?php echo $vetor_escolhidas['observacoes']; ?>                                    
                                ...
                                <div class="alert alert-danger" role="alert">
                                    Para este evento você <?php $totaldefotos = $vetor_qtd['qtd'] - $totalescolhas; if($totalescolhas > 0) { ?> ainda <?php } ?> poderá escolher “<?php echo $totaldefotos; ?>” fotografias para receber um tratamento top.
                                </div>
                                ...
                                <div class="row">
                                    ...
                                    <?php 
                                      ...
                                      foreach($img as $img){ 
                                            ...
                                            $sql_valida = mysqli_query($con, "select * from escolha_fotos_tratamento where id_evento = '$id' and id_formando = '$vetor_cadastro[id_formando]' and foto = '$img'");
                                      ...
                                      <script type="text/javascript">//<![CDATA[
                                        ...
                                        $('#myModal-<?php echo $i; ?>').on('hidden.bs.modal', function () {
                                          location.reload();
                                        });
                                      ...
                                      <a class="image-popup-vertical-fit" href="<?php echo $img; ?>"><img src="<?php echo $img; ?>" alt=""></a>                                      

                                      </div>

                                      <form action="recebe_enviarescolhafotoseventos.php?id=<?php echo $id; ?>" name="form1" method="post" enctype="multipart/form-data">

                                      <p><div align="center"><h4 class="mb-0"><input type="radio" id="imagem" name="bn" value="<?php echo $img; ?>"> Selecionar esta imagem!!!</h4></div></p>
                                                ...
                                                <div class="row">
                                                    <div class="col-lg-12">
                                                        <fieldset class="form-group">
                                                            <label class="form-label semibold" for="exampleInput">Você possui alguma recomendação para o tratamento desta imagem? Cor, Brilho, Enquadramento ou algum ajuste específico? Esteja à vontade para nos dizer como deseja o tratamento desta fotografia.</label>
