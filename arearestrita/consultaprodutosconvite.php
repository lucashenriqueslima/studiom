...
$id = $_GET['id'];
$sql_album = mysqli_query($con, "select * from meu_convite where id_meuconvite = '$id'");
$vetor_album = mysqli_fetch_array($sql_album);

$sql_produto_item_final = mysqli_query($con, "select * from tipos_produtos where id_tipo = '$vetor_album[id_item]'");
$vetor_produto_item_final = mysqli_fetch_array($sql_produto_item_final);

$sql_escolha = mysqli_query($con, "select * from meu_convite where id_formando = '$_SESSION[id_formando]'");
$vetor_escolha = mysqli_fetch_array($sql_escolha);

$total = mysqli_num_rows($sql_escolha);

$sql_escolha_finalizada = mysqli_query($con, "select * from meu_convite where id_formando = '$_SESSION[id_formando]' and status IN ('3', '4')");
                        ...
                        <div class="d-flex align-items-center">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active" aria-current="page">Aprovações - Produtos Convite</li>
                                </ol>
                            </nav>
                        </div>
                    </div>
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title">Aprovações - Produtos Convite</h4>
                                    ...
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                <h4 class="modal-title" id="myModalLabel">Aprovações - Produtos Convite</h4>
                                            ...
                                            <div class="modal-footer">
                                                ...
                                                <a href="consultaprodutosconvite_continuar.php?id=<?php echo $id; ?>"><button type="button" class="btn btn-info" >Continuar nas Aprovações</button></a>
                                            </div>
                                        </div>
                                        <!-- /.modal-content -->
                                    </div>
                                ...
                                <div id="escondido">                                    
                                    ...
                                    <table id="lang_opt" class="table table-striped table-bordered display" style="width:100%">
                                        ...
                                        <tbody>
                                            ...
                                            $sql_atual = mysqli_query($con, "select * from meu_convite where id_formando = '$_SESSION[id_formando]' and status IN ('1', '2') order by id_meuconvite DESC");
                                            ...
                                            <tr>
                                                ...
                                                <td><?php if($vetor['datafinal'] == NULL || $vetor['datafinal'] >= $dataatual) { ?><a href="inicioconvite.php?id=<?php echo $vetor['id_meuconvite']; ?>"><button type="button" class="btn btn-default mesmo-tamanho" title="Ver ou Alterar Cadastro"><i class="fa fa-edit"></i></button></a><?php } else { ?><a href="vermeuconvite.php?id=<?php echo $vetor['id_meuconvite']; ?>"><button type="button" class="btn btn-default mesmo-tamanho" title="Ver ou Alterar Cadastro"><i class="fa fa-eye"></i></button></a><?php } ?></td>
                                            </tr>
                                            <?php } ?>
                                        </tbody>
                                    </table>
