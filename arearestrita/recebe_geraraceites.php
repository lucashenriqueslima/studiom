...
$sql_consulta = mysqli_query($con, "select * from vendas a, turmas b, formandos c where a.id_formando = c.id_formando and b.id_turma = '$id_turma' and c.turma = '$id_turma' and a.produto = '$produto' and a.aceite = '1' and a.status = '3' and a.iniciada = '2'");

while($vetor_consulta = mysqli_fetch_array($sql_consulta)) {
...
echo"<script language=\"JavaScript\">
  location.href=\"listaraceites.php\";
  </script>";
