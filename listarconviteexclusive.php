            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title">Escolha de Fotos - Convite Exclusive</h4>

                                <?php

                                $sql_album_ap = mysqli_query($con, "select * from convite_exclusive where id_formando = '$vetor_cadastro[id_formando]'");
                                ...
                                if (mysqli_num_rows($sql_album_ap) > 0) {
                                    ...
                                    <div class="table-responsive">
                                        <table id="lang_opt" class="table table-striped table-bordered display"
                                            ...
                                            $sql_atual = mysqli_query($con, "select * from convite_exclusive where id_formando = '$_SESSION[id_formando]' order by id_exclusive DESC");
                                            ...
                                            while ($vetor = mysqli_fetch_array($sql_atual)) {
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a href="conviteexclusive.php?id=<?php echo $vetor['id_exclusive']; ?>">
