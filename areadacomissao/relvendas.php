                                ...
                                <div class="grid-form1 table-responsive">
                                  ...
                                  <div class="nav-tabs-custom">
                                    <ul class="nav nav-tabs">
                                      <li class="active ml-3"><a href="#tab1" data-toggle="tab">Fotografia</a></li> 
                                      <li class="active ml-3"><a href="#tab2" data-toggle="tab">Convite</a></li>
                                    </ul>
                                      ...
                                      <table id="example1" class="table table-bordered table-striped">
                                        ...
                                        <tbody>
                                          <?php 
                                            ...
                                            $sql_contratos = mysqli_query($con, "select * from formandos a, vendas b where a.id_formando = b.id_formando and a.turma = '$vetor_cadastro[turma]' and b.iniciada = '2' and b.tipo IN ('2', '3') order by b.id_venda DESC");

                                            while ($vetor_contrato=mysqli_fetch_array($sql_contratos)) {

                                            $sql_pacotes = mysqli_query($con, "select * from pacotes_itens_album where id_item = '$vetor_contrato[id_pacote]' order by id_item ASC");
                                            $vetor_pacotes = mysqli_fetch_array($sql_pacotes);

                                            $sql_forma = mysqli_query($con, "select * from formaspag where id_forma = '$vetor_contrato[formapag]'");
                                          ...
                                          <tr>
                                            ...
                                            <td><?php if($vetor_contrato['tipo'] == 3) { echo "Venda Avulsa"; } else { echo $vetor_pacotes['titulo']; } ?></td>
                                      ...
                                      <table id="example2" class="table table-bordered table-striped">
                                        ...
                                        <tbody>
                                          <?php 
                                            ...
                                            $sql_contratos = mysqli_query($con, "select * from formandos a, vendas b where a.id_formando = b.id_formando and a.turma = '$vetor_cadastro[turma]' and b.iniciada = '2' and b.tipo = '1' order by b.id_venda DESC");
