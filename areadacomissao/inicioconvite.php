<?php
	...
	$id = $_GET['id'];
	$sql_aprovacao = mysqli_query($con, "select * from meu_convite_turma where id_meuconvite = '$id'");
        ...
        <nav class="navbar-default navbar-static-top" role="navigation">
		   ...
		   <!-- Collect the nav links, forms, and other content for toggling -->
		    ...
		    <div class="navbar-default sidebar" role="navigation">
                ...
                <div align="center"><img src="../sistema/arquivos/<?php echo $vetor_turma['logo']; ?>" class="img-circle"  width="100px" height="100px"></div>
