                        ...
                        <div class="d-flex align-items-center">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active" aria-current="page">Doc's Comissão</li>
                                </ol>
                            </nav>
                        </div>
                                            ...
                                            <tbody>
                                                ...
                                                ?>
                                                    <tr>
                                                        ...
                                                        <td><a href="../sistema/arquivos/<?php echo $vetor_arquivo['arquivo']; ?>" target="_blank"><button type="button" class="btn btn-default">Arquivo</button></a> </td>
                                                    </tr>
                                                    <?php } ?>
                                            </tbody>
                                        </table>
