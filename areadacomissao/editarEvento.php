<?php
   ...
   // $vetor_eventos_turma = mysqli_fetch_array($sql_eventos_turma);
    ...
    $vetor_verifica = mysqli_fetch_array($sql_verifica);
   ...
   // echo $id_turma;
    ...
    //if ($tipo_local == 1 ||  $tipo_local == 3 ) {
        ...
        if (mysqli_num_rows($sql_verifica) != 0) {
            $local = $vetor_verifica['nomeLocal'];
            $cep = $vetor_verifica['cep'];
            $endereco = $vetor_verifica['endereco'];
            $complemento = $vetor_verifica['complemento'];
            $bairro = $vetor_verifica['bairro'];
            $cidade = $vetor_verifica['cidade'];
            $estado = $vetor_verifica['estado'];
            $data = $vetor_verifica['dataQrconvite'];
            $horainicio = $vetor_verifica['horainicio'];
            $horafim = $vetor_verifica['horafim'];
            $observacao = $vetor_verifica['observacoes'];
            $latitudeEvento = $vetor_verifica['latitudeEvento'];
            $longitudeEvento = $vetor_verifica['longitudeEvento'];
        }
...
<div class="container-fluid">
                    ...
                    <div class="col-12">
                        <div class="card ">
                            <div class="card-body">
                                    ...
                                    <form action="recebe_localQrconvite.php?evento=<?=$id_categoria?>&acao=1" method="post" name="cliente" enctype="multipart/form-data"
    ...
    function initMap() {
           ...
           if (document.getElementById("latitudeEvento").value == "" || document.getElementById("longitudeEvento").value == "") {
                var latitude = -16.6819782;
                var longitude = -49.2514343;
                var zoom = 5;
           }else{
