                    ...
                    <div class="col-12">
                        <div class="card ">
                            <div class="card-body">
                                    ...
                                    <form action="recebe_evento.php" method="post" name="cliente" enctype="multipart/form-data"
                                            ...
                                            <div class="col-lg-6">
                                                <fieldset class="form-group">
                                                    ...
                                                    <select name="id_categoria" id="categorias" class="form-control select2">
                                                        ...
                                                        <?php
                                                        $sql_categoria = mysqli_query($con, "select * from categoriaevento a, eventos_turma_lista b where a.id_categoria = b.id_evento and b.id_turma = '$vetor_cadastro[turma]'");
                                                        
                                                        while ($vetor_categoria = mysqli_fetch_array($sql_categoria)) { ?>
                                                            <option value="<?php echo $vetor_categoria['id_evento_turma']; ?>"><?php if ($vetor_categoria['nome'] == 'Pré-evento'){ echo $vetor_categoria['nome'].' '.$vetor_categoria['preevento']; }else { echo $vetor_categoria['nome']; }?></option>    
                                                        <?php } ?>
                                                    </select>
                                                </fieldset>
                                            </div>
                                                ...
                                                <fieldset class="form-group">
                                                    ...
                                                    <div class="input-group mb-3">
                                                        <input type="text" name="nome" value=""
                                                            class="form-control" id="exampleInput" placeholder="Digite o nome"
                                                            required>
                                        ...
                                        <input class="form-control" type="hidden" id="longitudeEvento" name="longitudeEvento">
                                        <input class="form-control" type="hidden" id="latitudeEvento" name="latitudeEvento">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-lg-4">
                                                <fieldset class="form-group">
                                                    ...
                                                    <input type="date" name="data" value=""
                                                        min="<?php $data = date('Y-m-d');
                                                        echo date('Y-m-d', strtotime("+45 days", strtotime($data))); ?>"
                                            ...
                                            <div class="col-lg-4">
                                                <fieldset class="form-group">
                                                    ...
                                                    <input type="time" name="horafim" value=""
                                                        class="form-control" id="exampleInput" placeholder="Data">
                                                </fieldset>
                                            </div>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-lg-6">
                                                <fieldset class="form-group">
                                                    <label class="form-label semibold" for="exampleInput">Responsável pelo
                                                        evento (Comissão ou Cerimonial)</label>
                                                    <input type="text" name="responsavel"
                                                        value="" class="form-control"
                                                        id="exampleInput"
                                                        placeholder="Cerimonial ou responsável pelo Evento">
                                                </fieldset>
                                            </div>
                                        ...
                                        <div class="row">
                                            <div class="col-lg-12">
                                                <fieldset class="form-group">
                                                    <label class="form-label semibold" for="exampleInput">Observações
                                                        Adicionais</label>
    ...
    <script>
        window.onload=function(){
            document.getElementById('categorias').addEventListener('change', function () {
                ...
                //gambiarra, deixa ai              
                var verifica = text.includes('Pré-evento');
                var variavel = '1';
                if (verifica == true) {
                    
                    var variavel = '2';
                }
                var style = variavel == '2' ? 'block' : 'none';
