                        ...
                        <div class="d-flex align-items-center">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active" aria-current="page">Interações</li>
                                    <li class="breadcrumb-item active" aria-current="page">Formando</li>
                                </ol>
                            </nav>
                        </div>
                                ...
                                <div class="grid-form table-responsive">
                                    ...
                                    <div class="grid-form1 table-responsive">
                                        ...
                                        <tr>
                                            ...
                                            <th>Tipo</th>
                                            <th>Assunto</th>
                                            <th width="45%">Ocorrência</th>
                                        </tr>
                                        </thead>
                                            <tbody>
                                                <?php 
                                                    
                                                    $sql_interacoes_formando = mysqli_query($con, "select * from interacao a, formandos b where a.id_cliente = b.id_formando and b.turma = '$vetor_cadastro[turma]' order by a.id_interacao DESC");
                                                ...
                                                <tr>
                                                    ...
                                                    <td><?php echo date('d/m/Y', strtotime($vetor_interacao_formando['data'])); ?></td> 
                                                    <td><?php echo $vetor_interacao_formando['hora']; ?></td>
