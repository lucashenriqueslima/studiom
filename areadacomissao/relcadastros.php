                                ...
                                <div class="grid-form table-responsive">
                                    ...
                                    <div class="grid-form1 table-responsive">
                                        ...
                                        <?php 
                                            ...
                                            $telefone = preg_replace("/[^0-9]/", "", $vetor_contrato['telefone']);
                                            
                                            ?>
                                        <tr>
                                            <td><?php echo $vetor_contrato['nome']; ?></td>
                                            <td><?php echo $vetor_contrato['email']; ?></td>
                                            <td><a href="https://api.whatsapp.com/send?phone=55<?php echo $telefone; ?>" target="_blank"><img src="../sistema/imgs/whatsapp.png" width="30px"></a> - <?php echo $vetor_contrato['telefone']; ?></td>
                                            <td><?php echo $vetor_contrato['pai']; ?></td>
                                            <td><?php echo $vetor_contrato['celularpai']; ?></td>
                                        </tr>
                                        <?php } ?>
                                        </tbody>
                                        </table>
