                        ...
                        <div class="d-flex align-items-center">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active" aria-current="page">Aprovações de Convites</li>
                                </ol>
                            </nav>
                        </div>
                                      ...
                                      <table width="100%">
                                        <tr>
                                          ...
                                          <td width="40%" valign="middle">
                                            <table width="100%">
                                              <tr>
                                                <td width="70%">Relatório de Aprovação de Convite: </td>
                                                <td width="30%"><a href="imprimirrelaprovacaoconvites.php" target="_blank"><button type="button" class="btn btn-default">Imprimir</button></a></td>
                                              </tr>
                                              <tr>
                                                <td></td>
