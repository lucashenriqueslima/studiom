<?php
	...
	$sql_contrato = mysqli_query($con, "select * from contratos_convite where id_turma = '$vetor_cadastro[turma]' and status = '1'");
	$vetor_contrato = mysqli_fetch_array($sql_contrato);
	
	$sql_contrato_aprovado = mysqli_query($con, "select * from contratos_aprovacao where id_contrato = '$vetor_contrato[id_contrato]' AND id_formando = '$_SESSION[id_formando]'");
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                <div class="card-body">
                                <h4> Olá, <?php echo $vetor_cadastro['nome']; ?>. Seja Bem Vindo(a) a sua plataforma digital Studio M.</h4>
								<?php

								if(mysqli_num_rows($sql_contrato) > 0) {

								if(mysqli_num_rows($sql_contrato_aprovado) == 0) {

								?>
                                
								<div class="alert alert-warning" role="alert">
									Caro(a), <?php echo $vetor_cadastro['nome']; ?> você possui contrato para ser aprovado. <a href="../aprovarcontrato.php?id=<?php echo $vetor_cadastro['turma']; ?>&id_formando=<?php echo $_SESSION['id_formando']; ?>">Clique aqui para comprar</a>.
								</div>
