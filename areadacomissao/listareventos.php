                        ...
                        <div class="card ">
                            <div class="card-body">
                                    ...
                                    <table id="example1" class="table table-bordered table-striped">
                                        ...
                                        $sql_atual = mysqli_query($con, "select * from eventos_turma where id_turma = '$vetor_cadastro[turma]' order by data ASC");
                                        ...
                                        <td><?php echo $vetor_local['cidade']; ?></td>
                                        <td><?php echo $vetor_local['estado']; ?></td>
                                        </tr>
                                        <?php } ?>
                                        </tbody>
                                    </table>
